...
class Zonehvac_Baseboard_Radiantconvective_Steam(EpBunch):
    ...
    Degree_of_SubCooling: Annotated[float, Field(ge=1.0, default=5.0)]

    Maximum_Steam_Flow_Rate: Annotated[float, Field(default=..., gt=0.0)]
