...
class Zonecrossmixing(EpBunch):
    ...
    Design_Flow_Rate_Calculation_Method: Annotated[Literal['Flow/Zone', 'Flow/Person', 'Flow/Area', 'AirChanges/Hour'], Field(default='Flow/Zone')]
    ...
    Delta_Temperature: Annotated[float, Field(ge=0.0, default=0)]
