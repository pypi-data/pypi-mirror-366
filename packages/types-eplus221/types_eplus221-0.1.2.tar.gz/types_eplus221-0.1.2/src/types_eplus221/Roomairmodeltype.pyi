...
class Roomairmodeltype(EpBunch):
    ...
    RoomAir_Modeling_Type: Annotated[Literal['Mixing', 'UserDefined', 'OneNodeDisplacementVentilation', 'ThreeNodeDisplacementVentilation', 'CrossVentilation', 'UnderFloorAirDistributionInterior', 'UnderFloorAirDistributionExterior', 'AirflowNetwork'], Field(default='Mixing')]
