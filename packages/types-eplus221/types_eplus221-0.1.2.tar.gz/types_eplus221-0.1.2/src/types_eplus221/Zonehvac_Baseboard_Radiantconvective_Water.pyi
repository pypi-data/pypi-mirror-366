...
class Zonehvac_Baseboard_Radiantconvective_Water(EpBunch):
    ...
    Rated_Average_Water_Temperature: Annotated[float, Field(ge=20.0, le=150.0, default=87.78)]
    """Rated average water temperature is the average of the inlet and outlet water temperatures"""

    Rated_Water_Mass_Flow_Rate: Annotated[float, Field(gt=0.0, le=10.0, default=0.063)]
