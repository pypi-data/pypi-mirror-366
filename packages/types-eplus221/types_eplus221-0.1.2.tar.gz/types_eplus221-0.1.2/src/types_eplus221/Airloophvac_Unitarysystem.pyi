...
class Airloophvac_Unitarysystem(EpBunch):
    ...
    Maximum_Outdoor_DryBulb_Temperature_for_Supplemental_Heater_Operation: Annotated[float, Field(default=21.0)]
    ...
    Fraction_of_OnCycle_Power_Use: Annotated[float, Field(ge=0.0, le=0.05, default=0.01)]
    """Used only for water source heat pump."""

    Heat_Pump_Fan_Delay_Time: Annotated[float, Field(ge=0.0, default=60)]
    """Used only for water source heat pump."""

    Ancillary_OnCycle_Electric_Power: Annotated[float, Field(ge=0, default=0)]
    """Enter the value of ancillary electric power for controls or other devices consumed during the on cycle."""

    Ancillary_OffCycle_Electric_Power: Annotated[float, Field(ge=0, default=0)]
