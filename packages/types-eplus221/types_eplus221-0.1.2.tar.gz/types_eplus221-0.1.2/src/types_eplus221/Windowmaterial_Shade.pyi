...
class Windowmaterial_Shade(EpBunch):
    ...
    LeftSide_Opening_Multiplier: Annotated[float, Field(ge=0.0, le=1.0, default=0.5)]

    RightSide_Opening_Multiplier: Annotated[float, Field(ge=0.0, le=1.0, default=0.5)]
