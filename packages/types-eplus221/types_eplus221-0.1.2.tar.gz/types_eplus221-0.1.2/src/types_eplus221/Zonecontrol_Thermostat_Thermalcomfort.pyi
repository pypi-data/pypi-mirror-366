...
class Zonecontrol_Thermostat_Thermalcomfort(EpBunch):
    ...
    Minimum_DryBulb_Temperature_Setpoint: Annotated[float, Field(ge=0, le=50, default=0)]

    Maximum_DryBulb_Temperature_Setpoint: Annotated[float, Field(ge=0, le=50, default=50)]
