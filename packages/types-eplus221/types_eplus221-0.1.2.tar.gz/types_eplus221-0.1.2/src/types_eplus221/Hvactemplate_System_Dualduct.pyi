...
class Hvactemplate_System_Dualduct(EpBunch):
    ...
    Main_Supply_Fan_PartLoad_Power_Coefficients: Annotated[Literal['InletVaneDampers', 'OutletDampers', 'VariableSpeedMotor', 'ASHRAE90.1-2004AppendixG', 'VariableSpeedMotorPressureReset'], Field(default='InletVaneDampers')]
    ...
    Cold_Duct_Supply_Fan_PartLoad_Power_Coefficients: Annotated[Literal['InletVaneDampers', 'OutletDampers', 'VariableSpeedMotor', 'ASHRAE90.1-2004AppendixG', 'VariableSpeedMotorPressureReset'], Field(default='InletVaneDampers')]
    """This field selects a predefined set of fan power coefficients."""
    ...
    Hot_Duct_Supply_Fan_PartLoad_Power_Coefficients: Annotated[Literal['InletVaneDampers', 'OutletDampers', 'VariableSpeedMotor', 'ASHRAE90.1-2004AppendixG', 'VariableSpeedMotorPressureReset'], Field(default='InletVaneDampers')]
    """This field selects a predefined set of fan power coefficients."""
    ...
    Heating_Coil_Setpoint_at_Outdoor_DryBulb_Low: Annotated[str, Field(default='50.0')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Heating_Coil_Reset_Outdoor_DryBulb_Low: Annotated[str, Field(default='7.8')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Heating_Coil_Setpoint_at_Outdoor_DryBulb_High: Annotated[str, Field(default='20.0')]
    """Applicable only for OutdoorAirTemperatureReset control."""
