...
class Shadowcalculation(EpBunch):
    ...
    Disable_SelfShading_Within_Shading_Zone_Groups: Annotated[Literal['Yes', 'No'], Field(default='No')]
    """If Yes, self-shading will be disabled from all exterior surfaces in a given Shading Zone Group to surfaces within"""

    Disable_SelfShading_From_Shading_Zone_Groups_to_Other_Zones: Annotated[Literal['Yes', 'No'], Field(default='No')]
