...
class Windowmaterial_Drape_Equivalentlayer(EpBunch):
    ...
    Drape_BeamBeam_Solar_Transmittance_at_Normal_Incidence: Annotated[float, Field(ge=0.0, le=0.2, default=0.0)]
    """The beam-beam solar transmittance at normal incidence. This value is the"""

    Front_Side_Drape_BeamDiffuse_Solar_Transmittance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The front side beam-diffuse solar transmittance at normal incidence averaged"""

    Back_Side_Drape_BeamDiffuse_Solar_Transmittance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The back side beam-diffuse solar transmittance at normal incidence averaged"""

    Front_Side_Drape_BeamDiffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The front side beam-diffuse solar reflectance at normal incidence averaged"""

    Back_Side_Drape_BeamDiffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The back side beam-diffuse solar reflectance at normal incidence averaged"""

    Drape_BeamBeam_Visible_Transmittance: Annotated[float, Field(ge=0, lt=1)]
    """The beam-beam visible transmittance at normal incidence averaged over the"""

    Drape_BeamDiffuse_Visible_Transmittance: Annotated[float, Field(ge=0, lt=1)]
    """The beam-diffuse visible transmittance at normal incidence averaged over the"""

    Drape_BeamDiffuse_Visible_Reflectance: Annotated[float, Field(ge=0, lt=1)]
