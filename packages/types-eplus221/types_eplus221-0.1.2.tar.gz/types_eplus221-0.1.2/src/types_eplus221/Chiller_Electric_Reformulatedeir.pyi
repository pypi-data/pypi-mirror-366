...
class Chiller_Electric_Reformulatedeir(EpBunch):
    ...
    Reference_Leaving_Condenser_Water_Temperature: Annotated[float, Field(default=35.0)]

    Reference_Chilled_Water_Flow_Rate: Annotated[float, Field(gt=0)]

    Reference_Condenser_Water_Flow_Rate: Annotated[float, Field(gt=0.0)]
    ...
    Electric_Input_to_Cooling_Output_Ratio_Function_of_Part_Load_Ratio_Curve_Type: Annotated[Literal['LeavingCondenserWaterTemperature', 'Lift'], Field(default='LeavingCondenserWaterTemperature')]
    ...
    Chiller_Flow_Mode_Type: Annotated[Literal['ConstantFlow', 'LeavingSetpointModulated', 'NotModulated'], Field(default='NotModulated')]
