...
class Zonehvac_Dehumidifier_Dx(EpBunch):
    ...
    Minimum_DryBulb_Temperature_for_Dehumidifier_Operation: Annotated[float, Field(default=10.0)]
    """Dehumidifier shut off if inlet air (zone) temperature is below this value."""

    Maximum_DryBulb_Temperature_for_Dehumidifier_Operation: Annotated[float, Field(default=35.0)]
    """Dehumidifier shut off if inlet air (zone) temperature is above this value."""

    OffCycle_Parasitic_Electric_Load: Annotated[float, Field(ge=0.0, default=0.0)]
