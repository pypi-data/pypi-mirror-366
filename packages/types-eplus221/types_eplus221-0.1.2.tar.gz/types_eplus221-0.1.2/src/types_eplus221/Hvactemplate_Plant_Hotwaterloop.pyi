...
class Hvactemplate_Plant_Hotwaterloop(EpBunch):
    ...
    Hot_Water_Setpoint_at_Outdoor_DryBulb_Low: Annotated[str, Field(default='82.2')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Hot_Water_Reset_Outdoor_DryBulb_Low: Annotated[str, Field(default='-6.7')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Hot_Water_Setpoint_at_Outdoor_DryBulb_High: Annotated[str, Field(default='65.6')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Hot_Water_Reset_Outdoor_DryBulb_High: Annotated[str, Field(default='10.0')]
    """Applicable only for OutdoorAirTemperatureReset control."""
