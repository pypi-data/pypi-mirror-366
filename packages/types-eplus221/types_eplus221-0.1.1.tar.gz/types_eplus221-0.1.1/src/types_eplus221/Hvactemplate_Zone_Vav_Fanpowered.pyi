...
class Hvactemplate_Zone_Vav_Fanpowered(EpBunch):
    ...
    Template_Vav_System_Name: Annotated[str, Field(default=...)]
    ...
    Primary_Supply_Air_Maximum_Flow_Rate: Annotated[str, Field(default='autosize')]
    ...
    Primary_Supply_Air_Minimum_Flow_Fraction: Annotated[str, Field(default='autosize')]

    Secondary_Supply_Air_Maximum_Flow_Rate: Annotated[str, Field(default='autosize')]
    """This field may be set to "autosize". If a value is entered, it will be"""

    Flow_Type: Annotated[Literal['Series', 'Parallel', 'SeriesFromPlenum', 'ParallelFromPlenum'], Field(default='Parallel')]

    Parallel_Fan_On_Flow_Fraction: Annotated[str, Field(default='autosize')]
    ...
    Reheat_Coil_Type: Annotated[Literal['HotWater', 'Electric', 'Gas'], Field(default='Electric')]

    Reheat_Coil_Availability_Schedule_Name: Annotated[str, Field()]
    """If blank, always on"""

    Fan_Total_Efficiency: Annotated[str, Field(default='0.7')]

    Fan_Delta_Pressure: Annotated[str, Field(default='1000')]

    Fan_Motor_Efficiency: Annotated[str, Field(default='0.9')]
    ...
    Zone_Piu_Fan_Schedule_Name: Annotated[str, Field()]
