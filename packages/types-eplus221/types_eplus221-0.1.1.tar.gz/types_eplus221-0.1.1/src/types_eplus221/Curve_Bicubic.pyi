...
class Curve_Bicubic(EpBunch):
    ...
    Coefficient5_Y__2: Annotated[float, Field(default=...)]

    Coefficient6_X_Y: Annotated[float, Field(default=...)]

    Coefficient7_X__3: Annotated[float, Field(default=...)]

    Coefficient8_Y__3: Annotated[float, Field(default=...)]

    Coefficient9_X__2_Y: Annotated[float, Field(default=...)]

    Coefficient10_X_Y__2: Annotated[float, Field(default=...)]
