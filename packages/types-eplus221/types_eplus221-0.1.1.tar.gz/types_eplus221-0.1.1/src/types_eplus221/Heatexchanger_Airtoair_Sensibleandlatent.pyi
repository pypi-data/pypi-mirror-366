...
class Heatexchanger_Airtoair_Sensibleandlatent(EpBunch):
    ...
    Sensible_Effectiveness_At_100__Heating_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Latent_Effectiveness_At_100__Heating_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Sensible_Effectiveness_At_75__Heating_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Latent_Effectiveness_At_75__Heating_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Sensible_Effectiveness_At_100__Cooling_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Latent_Effectiveness_At_100__Cooling_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Sensible_Effectiveness_At_75__Cooling_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Latent_Effectiveness_At_75__Cooling_Air_Flow: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]
