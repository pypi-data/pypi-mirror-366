...
class Energymanagementsystem_Meteredoutputvariable(EpBunch):
    ...
    End_Use_Category: Annotated[Literal['Heating', 'Cooling', 'InteriorLights', 'ExteriorLights', 'InteriorEquipment', 'ExteriorEquipment', 'Fans', 'Pumps', 'HeatRejection', 'Humidifier', 'HeatRecovery', 'WaterSystems', 'Refrigeration', 'OnSiteGeneration', 'HeatingCoils', 'CoolingCoils', 'Chillers', 'Boilers', 'Baseboard', 'HeatRecoveryForCooling', 'HeatRecoveryForHeating'], Field(default=...)]
    """choose how the metered output should be classified for end-use category"""

    End_Use_Subcategory: Annotated[str, Field()]
