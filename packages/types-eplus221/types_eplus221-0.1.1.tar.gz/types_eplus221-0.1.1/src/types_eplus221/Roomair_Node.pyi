...
class Roomair_Node(EpBunch):
    """Define an air node for some types of nodal room air models"""

    Name: Annotated[str, Field()]

    Node_Type: Annotated[Literal['Inlet', 'Floor', 'Control', 'Ceiling', 'MundtRoom', 'Return'], Field(default=...)]

    Zone_Name: Annotated[str, Field(default=...)]

    Height_Of_Nodal_Control_Volume_Center: Annotated[float, Field(default=...)]
