...
class Refrigeration_Case(EpBunch):
    ...
    Case_Anti_Sweat_Heater_Power_Per_Unit_Length: Annotated[float, Field(ge=0, default=0)]

    Minimum_Anti_Sweat_Heater_Power_Per_Unit_Length: Annotated[float, Field(ge=0, default=0)]
    """This field is only applicable to the Linear, Dewpoint Method, and"""

    Anti_Sweat_Heater_Control_Type: Annotated[Literal['None', 'Constant', 'Linear', 'DewpointMethod', 'HeatBalanceMethod'], Field()]

    Humidity_At_Zero_Anti_Sweat_Heater_Energy: Annotated[float, Field(default=-10.0)]
    ...
    Fraction_Of_Anti_Sweat_Heater_Energy_To_Case: Annotated[float, Field(ge=0.0, le=1.0, default=1.0)]
    ...
    Case_Defrost_Drip_Down_Schedule_Name: Annotated[str, Field()]
