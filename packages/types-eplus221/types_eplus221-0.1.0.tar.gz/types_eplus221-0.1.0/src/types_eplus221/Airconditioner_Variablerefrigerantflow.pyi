...
class Airconditioner_Variablerefrigerantflow(EpBunch):
    ...
    Cooling_Energy_Input_Ratio_Modifier_Function_Of_Low_Part_Load_Ratio_Curve_Name: Annotated[str, Field()]
    """Enter a curve name that represents cooling energy ratio as a function of"""

    Cooling_Energy_Input_Ratio_Modifier_Function_Of_High_Part_Load_Ratio_Curve_Name: Annotated[str, Field()]
    """Enter a curve name that represents cooling energy ratio as a function of"""
    ...
    Cooling_Part_Load_Fraction_Correlation_Curve_Name: Annotated[str, Field()]
    ...
    Heating_Energy_Input_Ratio_Modifier_Function_Of_Low_Part_Load_Ratio_Curve_Name: Annotated[str, Field()]
    """This curve represents the heating energy input ratio for part-load ratios less than 1."""

    Heating_Energy_Input_Ratio_Modifier_Function_Of_High_Part_Load_Ratio_Curve_Name: Annotated[str, Field()]
    ...
    Heating_Part_Load_Fraction_Correlation_Curve_Name: Annotated[str, Field()]
    """This curve defines the cycling losses when the heat pump compressor cycles on and off"""
