...
class Coolingtower_Variablespeed_Merkel(EpBunch):
    ...
    Design_Air_Flow_Rate_U_Factor_Times_Area_Value: Annotated[float, Field()]
    ...
    U_Factor_Times_Area_Modifier_Function_Of_Air_Flow_Ratio_Curve_Name: Annotated[str, Field(default=...)]
    """This curve describes how tower's design UA changes with variable air flow rate"""

    U_Factor_Times_Area_Modifier_Function_Of_Wetbulb_Temperature_Difference_Curve_Name: Annotated[str, Field(default=...)]
    """curve describes how tower UA changes with outdoor air wet-bulb temperature difference from design wet-bulb"""

    U_Factor_Times_Area_Modifier_Function_Of_Water_Flow_Ratio_Curve_Name: Annotated[str, Field(default=...)]
