...
class Windowmaterial_Blind_Equivalentlayer(EpBunch):
    ...
    Front_Side_Slat_Beam_Diffuse_Solar_Transmittance: Annotated[float, Field(ge=0, lt=1, default=0)]
    """The front side beam-diffuse solar transmittance of the slat at normal"""

    Back_Side_Slat_Beam_Diffuse_Solar_Transmittance: Annotated[float, Field(ge=0, lt=1, default=0)]
    """The back side beam-diffuse solar transmittance of the slat at normal"""

    Front_Side_Slat_Beam_Diffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The front side beam-diffuse solar reflectance of the slat at normal"""

    Back_Side_Slat_Beam_Diffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The back side beam-diffuse solar reflectance of the slat at normal"""

    Front_Side_Slat_Beam_Diffuse_Visible_Transmittance: Annotated[float, Field(ge=0, lt=1, default=0)]
    """The front side beam-diffuse visible transmittance of the slat"""

    Back_Side_Slat_Beam_Diffuse_Visible_Transmittance: Annotated[float, Field(ge=0, lt=1, default=0)]
    """The back side beam-diffuse visible transmittance of the slat"""

    Front_Side_Slat_Beam_Diffuse_Visible_Reflectance: Annotated[float, Field(ge=0, lt=1)]
    """The front side beam-diffuse visible reflectance of the slat"""

    Back_Side_Slat_Beam_Diffuse_Visible_Reflectance: Annotated[float, Field(ge=0, lt=1)]
    """The back side beam-diffuse visible reflectance of the slat"""

    Slat_Diffuse_Diffuse_Solar_Transmittance: Annotated[float, Field(ge=0, lt=1, default=0)]
    """The beam-diffuse solar transmittance of the slat averaged"""

    Front_Side_Slat_Diffuse_Diffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The front side beam-diffuse solar reflectance of the slat"""

    Back_Side_Slat_Diffuse_Diffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The back side beam-diffuse solar reflectance of the slat"""

    Slat_Diffuse_Diffuse_Visible_Transmittance: Annotated[float, Field(ge=0, lt=1)]
    """The beam-diffuse visible transmittance of the slat averaged"""

    Front_Side_Slat_Diffuse_Diffuse_Visible_Reflectance: Annotated[float, Field(ge=0, lt=1)]
    """The front side beam-diffuse visible reflectance of the slat"""

    Back_Side_Slat_Diffuse_Diffuse_Visible_Reflectance: Annotated[float, Field(ge=0, lt=1)]
    """The back side beam-diffuse visible reflectance of the slat"""
