...
class Airconditioner_Variablerefrigerantflow_Fluidtemperaturecontrol(EpBunch):
    ...
    Minimum_Outdoor_Air_Temperature_In_Cooling_Mode: Annotated[float, Field(default=-6.0)]
    """Enter the minimum outdoor temperature allowed for cooling operation"""

    Maximum_Outdoor_Air_Temperature_In_Cooling_Mode: Annotated[float, Field(default=43.0)]
    """Enter the maximum outdoor temperature allowed for cooling operation"""

    Minimum_Outdoor_Air_Temperature_In_Heating_Mode: Annotated[float, Field(default=-20.0)]
    """Enter the minimum outdoor temperature allowed for heating operation"""

    Maximum_Outdoor_Air_Temperature_In_Heating_Mode: Annotated[float, Field(default=16.0)]
    """Enter the maximum outdoor temperature allowed for heating operation"""

    Reference_Outdoor_Unit_Superheating: Annotated[float, Field(default=3)]

    Reference_Outdoor_Unit_Subcooling: Annotated[float, Field(default=5)]
    ...
    Diameter_Of_Main_Pipe_Connecting_Outdoor_Unit_To_The_First_Branch_Joint: Annotated[float, Field(ge=0.0, default=0.0762)]
    ...
    Number_Of_Compressor_Loading_Index_Entries: Annotated[int, Field(ge=2, le=9, default=2)]
