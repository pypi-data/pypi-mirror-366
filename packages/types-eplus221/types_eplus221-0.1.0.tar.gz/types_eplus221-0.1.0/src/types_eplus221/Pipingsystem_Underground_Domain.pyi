...
class Pipingsystem_Underground_Domain(EpBunch):
    ...
    X_Direction_Mesh_Density_Parameter: Annotated[int, Field(gt=0, default=4)]
    """If mesh type is symmetric geometric, this should be an even number."""

    X_Direction_Mesh_Type: Annotated[Literal['Uniform', 'SymmetricGeometric'], Field(default=...)]

    X_Direction_Geometric_Coefficient: Annotated[float, Field(ge=1, le=2, default=1.3)]
    """optional"""

    Y_Direction_Mesh_Density_Parameter: Annotated[int, Field(gt=0, default=4)]
    """If mesh type is symmetric geometric, this should be an even number."""

    Y_Direction_Mesh_Type: Annotated[Literal['Uniform', 'SymmetricGeometric'], Field(default=...)]

    Y_Direction_Geometric_Coefficient: Annotated[float, Field(ge=1, le=2, default=1.3)]
    """optional"""

    Z_Direction_Mesh_Density_Parameter: Annotated[int, Field(gt=0, default=4)]
    """If mesh type is symmetric geometric, this should be an even number."""

    Z_Direction_Mesh_Type: Annotated[Literal['Uniform', 'SymmetricGeometric'], Field(default=...)]

    Z_Direction_Geometric_Coefficient: Annotated[float, Field(ge=1, le=2, default=1.3)]
    """optional"""
