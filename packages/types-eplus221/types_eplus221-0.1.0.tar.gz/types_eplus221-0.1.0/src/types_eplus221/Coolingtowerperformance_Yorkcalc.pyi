...
class Coolingtowerperformance_Yorkcalc(EpBunch):
    """This object is used to define coefficients for the approach temperature"""

    Name: Annotated[str, Field(default=...)]

    Minimum_Inlet_Air_Wet_Bulb_Temperature: Annotated[float, Field(default=...)]
    """Minimum valid inlet air wet-bulb temperature for this approach"""

    Maximum_Inlet_Air_Wet_Bulb_Temperature: Annotated[float, Field(default=...)]
    ...
    Maximum_Liquid_To_Gas_Ratio: Annotated[float, Field(default=...)]
