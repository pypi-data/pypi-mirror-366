...
class Hvactemplate_Plant_Chilledwaterloop(EpBunch):
    ...
    Chilled_Water_Setpoint_At_Outdoor_Dry_Bulb_Low: Annotated[str, Field(default='12.2')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Chilled_Water_Reset_Outdoor_Dry_Bulb_Low: Annotated[str, Field(default='15.6')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Chilled_Water_Setpoint_At_Outdoor_Dry_Bulb_High: Annotated[str, Field(default='6.7')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Chilled_Water_Reset_Outdoor_Dry_Bulb_High: Annotated[str, Field(default='26.7')]
    """Applicable only for OutdoorAirTemperatureReset control."""
