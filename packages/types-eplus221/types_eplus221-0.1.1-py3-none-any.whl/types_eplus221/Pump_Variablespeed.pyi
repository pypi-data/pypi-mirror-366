...
class Pump_Variablespeed(EpBunch):
    ...
    Design_Maximum_Flow_Rate: Annotated[str, Field()]
    ...
    Design_Minimum_Flow_Rate: Annotated[str, Field(default='autosize')]
    """When autosized the scaling factor is the input field Design Minimum Flow Rate Fraction"""
    ...
    Vfd_Control_Type: Annotated[Literal['ManualControl', 'PressureSetpointControl'], Field()]

    Pump_Rpm_Schedule_Name: Annotated[str, Field()]
    """Modifies the rpm of the pump on a time basis. Default is"""

    Minimum_Pressure_Schedule: Annotated[str, Field()]

    Maximum_Pressure_Schedule: Annotated[str, Field()]

    Minimum_Rpm_Schedule: Annotated[str, Field()]

    Maximum_Rpm_Schedule: Annotated[str, Field()]
    ...
    Design_Minimum_Flow_Rate_Fraction: Annotated[float, Field(ge=0, le=1.0, default=0.0)]
    """Used to size Design Minimum Flow Rate"""
