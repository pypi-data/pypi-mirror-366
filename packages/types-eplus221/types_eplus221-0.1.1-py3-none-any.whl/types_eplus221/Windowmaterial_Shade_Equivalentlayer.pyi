...
class Windowmaterial_Shade_Equivalentlayer(EpBunch):
    ...
    Shade_Beam_Beam_Solar_Transmittance: Annotated[float, Field(ge=0.0, le=0.8, default=0.0)]
    """The beam-beam solar transmittance at normal incidence. This value is"""

    Front_Side_Shade_Beam_Diffuse_Solar_Transmittance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The front side beam-diffuse solar transmittance at normal incidence averaged"""

    Back_Side_Shade_Beam_Diffuse_Solar_Transmittance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The back side beam-diffuse solar transmittance at normal incidence averaged"""

    Front_Side_Shade_Beam_Diffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The front side beam-diffuse solar reflectance at normal incidence averaged"""

    Back_Side_Shade_Beam_Diffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The back side beam-diffuse solar reflectance at normal incidence averaged"""

    Shade_Beam_Beam_Visible_Transmittance_At_Normal_Incidence: Annotated[float, Field(ge=0, lt=1)]
    """The beam-beam visible transmittance at normal incidence averaged over the"""

    Shade_Beam_Diffuse_Visible_Transmittance_At_Normal_Incidence: Annotated[float, Field(ge=0, lt=1)]
    """The beam-diffuse visible transmittance at normal incidence averaged over the"""

    Shade_Beam_Diffuse_Visible_Reflectance_At_Normal_Incidence: Annotated[float, Field(ge=0, lt=1)]
