...
class Sizingperiod_Designday(EpBunch):
    ...
    Maximum_Dry_Bulb_Temperature: Annotated[float, Field(ge=-90, le=70)]
    """This field is required when field "Dry-Bulb Temperature Range Modifier Type""""

    Daily_Dry_Bulb_Temperature_Range: Annotated[float, Field(ge=0, default=0)]
    """Must still produce appropriate maximum dry-bulb (within range)"""

    Dry_Bulb_Temperature_Range_Modifier_Type: Annotated[Literal['MultiplierSchedule', 'DifferenceSchedule', 'TemperatureProfileSchedule', 'DefaultMultipliers'], Field(default='DefaultMultipliers')]
    """Type of modifier to the dry-bulb temperature calculated for the timestep"""

    Dry_Bulb_Temperature_Range_Modifier_Day_Schedule_Name: Annotated[str, Field()]
    ...
    Wetbulb_Or_Dewpoint_At_Maximum_Dry_Bulb: Annotated[float, Field()]
    ...
    Humidity_Ratio_At_Maximum_Dry_Bulb: Annotated[float, Field()]
    """Humidity ratio coincident with the maximum temperature (constant humidity ratio throughout day)."""

    Enthalpy_At_Maximum_Dry_Bulb: Annotated[float, Field()]
    """Enthalpy coincident with the maximum temperature."""

    Daily_Wet_Bulb_Temperature_Range: Annotated[str, Field()]
    ...
    Ashrae_Clear_Sky_Optical_Depth_For_Beam_Irradiance__Taub_: Annotated[str, Field(default='0')]
    """Required if Solar Model Indicator = ASHRAETau or ASHRAETau2017"""

    Ashrae_Clear_Sky_Optical_Depth_For_Diffuse_Irradiance__Taud_: Annotated[str, Field(default='0')]
    """Required if Solar Model Indicator = ASHRAETau or ASHRAETau2017"""
