...
class Refrigeration_Walkin(EpBunch):
    ...
    Defrost_Drip_Down_Schedule_Name: Annotated[str, Field()]
    """The schedule values should be 0 (off) or 1 (on)"""
    ...
    Insulated_Floor_U_Value: Annotated[float, Field(gt=0.0, default=0.3154)]
    ...
    Insulated_Surface_U_Value_Facing_Zone_1: Annotated[float, Field(gt=0.0, default=0.3154)]
    """The default value corresponds to R18 [ft2-F-hr/Btu]"""
    ...
    Insulated_Surface_U_Value_Facing_Zone_2: Annotated[float, Field(gt=0.0, default=0.3154)]
    """The default value corresponds to R18 [ft2-F-hr/Btu]"""
    ...
    Insulated_Surface_U_Value_Facing_Zone_3: Annotated[float, Field(gt=0.0, default=0.3154)]
    """The default value corresponds to R18 [ft2-F-hr/Btu]"""
