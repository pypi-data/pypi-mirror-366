...
class Coil_Cooling_Dx_Twostagewithhumiditycontrolmode(EpBunch):
    ...
    Normal_Mode_Stage_1_2_Coil_Performance_Object_Type: Annotated[Literal['CoilPerformance:DX:Cooling'], Field()]

    Normal_Mode_Stage_1_2_Coil_Performance_Name: Annotated[str, Field()]
    ...
    Dehumidification_Mode_1_Stage_1_2_Coil_Performance_Object_Type: Annotated[Literal['CoilPerformance:DX:Cooling'], Field()]

    Dehumidification_Mode_1_Stage_1_2_Coil_Performance_Name: Annotated[str, Field()]
