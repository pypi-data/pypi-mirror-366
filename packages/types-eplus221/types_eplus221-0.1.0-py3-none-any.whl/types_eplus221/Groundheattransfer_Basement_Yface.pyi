...
class Groundheattransfer_Basement_Yface(EpBunch):
    """This is only needed when using manual gridding (not recommended)"""

    N1: Annotated[str, Field()]

    N2: Annotated[str, Field()]

    N3: Annotated[str, Field()]

    N4: Annotated[str, Field()]

    N5: Annotated[str, Field()]

    N6: Annotated[str, Field()]
