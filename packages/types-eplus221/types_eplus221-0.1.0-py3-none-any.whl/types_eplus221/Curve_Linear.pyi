...
class Curve_Linear(EpBunch):
    ...
    Input_Unit_Type_For_X: Annotated[Literal['Dimensionless', 'Temperature', 'VolumetricFlow', 'Pressure', 'MassFlow', 'Power', 'Distance'], Field(default='Dimensionless')]
