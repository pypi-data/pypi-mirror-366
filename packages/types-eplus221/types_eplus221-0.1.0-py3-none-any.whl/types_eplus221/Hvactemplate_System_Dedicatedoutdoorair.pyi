...
class Hvactemplate_System_Dedicatedoutdoorair(EpBunch):
    ...
    Heating_Coil_Setpoint_At_Outdoor_Dry_Bulb_Low: Annotated[str, Field(default='15.0')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Heating_Coil_Reset_Outdoor_Dry_Bulb_Low: Annotated[str, Field(default='7.8')]
    """Applicable only for OutdoorAirTemperatureReset control."""

    Heating_Coil_Setpoint_At_Outdoor_Dry_Bulb_High: Annotated[str, Field(default='12.2')]
    """Applicable only for OutdoorAirTemperatureReset control."""
