...
class Dehumidifier_Desiccant_Nofans(EpBunch):
    ...
    Leaving_Dry_Bulb_Function_Of_Entering_Dry_Bulb_And_Humidity_Ratio_Curve_Name: Annotated[str, Field()]
    """Leaving dry-bulb of process air as a function of entering dry-bulb"""

    Leaving_Dry_Bulb_Function_Of_Air_Velocity_Curve_Name: Annotated[str, Field()]
    """Leaving dry-bulb of process air as a function of air velocity,"""

    Leaving_Humidity_Ratio_Function_Of_Entering_Dry_Bulb_And_Humidity_Ratio_Curve_Name: Annotated[str, Field()]
    ...
    Regeneration_Energy_Function_Of_Entering_Dry_Bulb_And_Humidity_Ratio_Curve_Name: Annotated[str, Field()]
    ...
    Regeneration_Velocity_Function_Of_Entering_Dry_Bulb_And_Humidity_Ratio_Curve_Name: Annotated[str, Field()]
