...
class Electricequipment_Ite_Aircooled(EpBunch):
    ...
    Cpu_End_Use_Subcategory: Annotated[str, Field(default='ITE-CPU')]
    """Any text may be used here to categorize the end-uses in the ABUPS End Uses by Subcategory table."""

    Fan_End_Use_Subcategory: Annotated[str, Field(default='ITE-Fans')]
    """Any text may be used here to categorize the end-uses in the ABUPS End Uses by Subcategory table."""

    Electric_Power_Supply_End_Use_Subcategory: Annotated[str, Field(default='ITE-UPS')]
    """Any text may be used here to categorize the end-uses in the ABUPS End Uses by Subcategory table."""
