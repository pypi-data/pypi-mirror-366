...
class Windowmaterial_Screen_Equivalentlayer(EpBunch):
    ...
    Screen_Beam_Beam_Solar_Transmittance: Annotated[float, Field(ge=0, lt=1, default=autocalculate)]
    """The beam-beam transmittance of the screen material at normal incidence."""

    Screen_Beam_Diffuse_Solar_Transmittance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The beam-diffuse solar transmittance of the screen material at normal"""

    Screen_Beam_Diffuse_Solar_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The beam-diffuse solar reflectance of the screen material at normal"""

    Screen_Beam_Beam_Visible_Transmittance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The beam-beam visible transmittance of the screen material at normal"""

    Screen_Beam_Diffuse_Visible_Transmittance: Annotated[float, Field(default=..., ge=0, lt=1)]
    """The beam-diffuse visible transmittance of the screen material at normal"""

    Screen_Beam_Diffuse_Visible_Reflectance: Annotated[float, Field(default=..., ge=0, lt=1)]
