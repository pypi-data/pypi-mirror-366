...
class Refrigeration_Compressorrack(EpBunch):
    ...
    Water_Cooled_Condenser_Inlet_Node_Name: Annotated[str, Field()]

    Water_Cooled_Condenser_Outlet_Node_Name: Annotated[str, Field()]
    ...
    Water_Cooled_Condenser_Outlet_Temperature_Schedule_Name: Annotated[str, Field()]
    """Applicable only when loop Flow type is VariableFlow."""

    Water_Cooled_Condenser_Design_Flow_Rate: Annotated[float, Field(gt=0.0)]
    """Applicable only when loop flow type is ConstantFlow."""

    Water_Cooled_Condenser_Maximum_Flow_Rate: Annotated[float, Field(gt=0.0)]

    Water_Cooled_Condenser_Maximum_Water_Outlet_Temperature: Annotated[float, Field(ge=10.0, le=60.0, default=55.0)]

    Water_Cooled_Condenser_Minimum_Water_Inlet_Temperature: Annotated[float, Field(ge=10.0, le=30.0, default=10.0)]
