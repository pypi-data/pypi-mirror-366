...
class Waterheater_Heatpump_Pumpedcondenser(EpBunch):
    ...
    Condenser_Water_Flow_Rate: Annotated[float, Field(gt=0)]
    ...
    DX_Coil_Object_Type: Annotated[Literal['Coil:WaterHeating:AirToWaterHeatPump:Pumped', 'Coil:WaterHeating:AirToWaterHeatPump:VariableSpeed', 'CoilSystem:IntegratedHeatPump:AirSource'], Field(default='Coil:WaterHeating:AirToWaterHeatPump:Pumped')]
    """Specify the type of DX coil used by this heat pump water heater. The only"""

    DX_Coil_Name: Annotated[str, Field(default=...)]
    """Must match the name used in the corresponding Coil:WaterHeating:AirToWaterHeatPump:* object, or CoilSystem:IntegratedHeatPump:AirSource"""
    ...
    Fan_Object_Type: Annotated[Literal['Fan:SystemModel', 'Fan:OnOff'], Field(default='Fan:OnOff')]
