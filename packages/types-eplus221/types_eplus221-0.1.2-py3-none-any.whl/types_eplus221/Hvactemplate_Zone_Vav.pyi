...
class Hvactemplate_Zone_Vav(EpBunch):
    ...
    Constant_Minimum_Air_Flow_Fraction: Annotated[str, Field(default='0.2')]
    """This field is used if the field Zone Minimum Air Flow Input Method is Constant"""

    Fixed_Minimum_Air_Flow_Rate: Annotated[float, Field()]
    ...
    Damper_Heating_Action: Annotated[Literal['Normal', 'Reverse'], Field(default='Reverse')]

    Maximum_Flow_per_Zone_Floor_Area_During_Reheat: Annotated[float, Field()]
    """Used only when Reheat Coil Object Type = Coil:Heating:Water and Damper Heating Action = Reverse"""

    Maximum_Flow_Fraction_During_Reheat: Annotated[float, Field()]
    """Used only when Reheat Coil Object Type = Coil:Heating:Water and Damper Heating Action = Reverse"""
