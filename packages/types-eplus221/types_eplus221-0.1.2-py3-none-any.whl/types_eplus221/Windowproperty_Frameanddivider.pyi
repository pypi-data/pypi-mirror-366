...
class Windowproperty_Frameanddivider(EpBunch):
    ...
    Ratio_of_FrameEdge_Glass_Conductance_to_CenterOfGlass_Conductance: Annotated[float, Field(gt=0.0, le=4.0, default=1.0)]
    ...
    Ratio_of_DividerEdge_Glass_Conductance_to_CenterOfGlass_Conductance: Annotated[float, Field(gt=0.0, le=4.0, default=1.0)]
    """Excludes air films"""
