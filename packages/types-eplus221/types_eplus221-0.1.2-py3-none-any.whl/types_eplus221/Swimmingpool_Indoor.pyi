...
class Swimmingpool_Indoor(EpBunch):
    ...
    Makeup_Water_Supply_Schedule_Name: Annotated[str, Field(default=...)]
    ...
    Cover_ShortWavelength_Radiation_Factor: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]

    Cover_LongWavelength_Radiation_Factor: Annotated[float, Field(ge=0.0, le=1.0, default=0.0)]
