...
class Hvactemplate_System_Unitaryheatpump_Airtoair(EpBunch):
    ...
    Heat_Pump_Heating_Coil_Type: Annotated[Literal['SingleSpeedDXHeatPump'], Field(default='SingleSpeedDXHeatPump')]
    ...
    Heat_Pump_Heating_Coil_Rated_COP: Annotated[str, Field(default='2.75')]
    """Heat Pump Heating Coil Rated Capacity divided by power input to the compressor and outdoor fan,"""

    Heat_Pump_Heating_Minimum_Outdoor_DryBulb_Temperature: Annotated[float, Field(ge=-20.0, default=-8.0)]

    Heat_Pump_Defrost_Maximum_Outdoor_DryBulb_Temperature: Annotated[float, Field(ge=0.0, le=7.22, default=5.0)]
    ...
    Supplemental_Heating_Coil_Type: Annotated[Literal['Electric', 'Gas', 'HotWater'], Field(default='Electric')]
    ...
    Supplemental_Heating_Coil_Maximum_Outdoor_DryBulb_Temperature: Annotated[float, Field(le=21.0, default=21.0)]
    """Supplemental heater will not operate when outdoor temperature exceeds this value."""

    Supplemental_Gas_Heating_Coil_Efficiency: Annotated[str, Field(default='0.8')]
    """Applies only if Supplemental Heating Coil Type is Gas"""

    Supplemental_Gas_Heating_Coil_Parasitic_Electric_Load: Annotated[str, Field(default='0.0')]
    """Applies only if Supplemental Heating Coil Type is Gas"""
    ...
    Economizer_Maximum_Limit_DryBulb_Temperature: Annotated[float, Field()]
    ...
    Economizer_Minimum_Limit_DryBulb_Temperature: Annotated[float, Field()]
