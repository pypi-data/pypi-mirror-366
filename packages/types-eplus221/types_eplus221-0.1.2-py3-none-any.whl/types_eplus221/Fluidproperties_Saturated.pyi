...
class Fluidproperties_Saturated(EpBunch):
    """fluid properties for the saturated region"""

    Fluid_Name: Annotated[str, Field()]

    Fluid_Property_Type: Annotated[Literal['Enthalpy', 'Density', 'SpecificHeat', 'Pressure'], Field()]
    """Enthalpy Units are J/kg"""

    Fluid_Phase: Annotated[Literal['Fluid', 'FluidGas'], Field()]
