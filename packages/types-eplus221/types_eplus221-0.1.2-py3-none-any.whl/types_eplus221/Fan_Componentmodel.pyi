...
class Fan_Componentmodel(EpBunch):
    ...
    Normalized_Fan_Static_Efficiency_Curve_NameNonStall_Region: Annotated[str, Field(default=...)]
    """xfan <= 0"""

    Normalized_Fan_Static_Efficiency_Curve_NameStall_Region: Annotated[str, Field(default=...)]
    """xfan > 0"""

    Normalized_Dimensionless_Airflow_Curve_NameNonStall_Region: Annotated[str, Field(default=...)]
    """xspd <= 0"""

    Normalized_Dimensionless_Airflow_Curve_NameStall_Region: Annotated[str, Field(default=...)]
    """xspd > 0"""

    Maximum_Belt_Efficiency_Curve_Name: Annotated[str, Field()]
    """Determines maximum fan drive belt efficiency in log space"""

    Normalized_Belt_Efficiency_Curve_Name__Region_1: Annotated[str, Field()]
    """Region 1 (0 <= xbelt < xbelt,trans)"""

    Normalized_Belt_Efficiency_Curve_Name__Region_2: Annotated[str, Field()]
    """Region 2 (xbelt,trans <= xbelt <= 1)"""

    Normalized_Belt_Efficiency_Curve_Name__Region_3: Annotated[str, Field()]
