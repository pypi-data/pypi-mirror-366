...
class Foundation_Kiva_Settings(EpBunch):
    ...
    FarField_Width: Annotated[float, Field(gt=0.0, default=40)]

    DeepGround_Boundary_Condition: Annotated[Literal['ZeroFlux', 'GroundWater', 'Autoselect'], Field(default='Autoselect')]

    DeepGround_Depth: Annotated[float, Field(gt=0.0, default=autocalculate)]
