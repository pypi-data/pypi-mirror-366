...
class Setpointmanager_Returntemperature_Hotwater(EpBunch):
    ...
    Minimum_Supply_Temperature_Setpoint: Annotated[float, Field(default=77)]
    """This is the minimum reset temperature for the hot water supply."""

    Maximum_Supply_Temperature_Setpoint: Annotated[float, Field(default=82)]
    ...
    Return_Temperature_Setpoint_Constant_Value: Annotated[float, Field(default=71)]
