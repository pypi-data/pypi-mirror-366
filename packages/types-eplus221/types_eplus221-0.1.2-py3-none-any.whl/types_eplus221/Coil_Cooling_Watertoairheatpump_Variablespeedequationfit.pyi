...
class Coil_Cooling_Watertoairheatpump_Variablespeedequationfit(EpBunch):
    ...
    WatertoRefrigerant_HX_Water_Inlet_Node_Name: Annotated[str, Field(default=...)]

    WatertoRefrigerant_HX_Water_Outlet_Node_Name: Annotated[str, Field(default=...)]
    ...
    Initial_Moisture_Evaporation_Rate_Divided_by_SteadyState_AC_Latent_Capacity: Annotated[float, Field(ge=0, default=0)]

    Flag_for_Using_Hot_Gas_Reheat_0_or_1: Annotated[float, Field(ge=0, default=0)]
