...
class BaseManimAnimationWrapper:
    ...
    def __init__(
        ...
        if (
            not PythonValidator.is_subclass_of(animation_generator_instance_or_class, BaseManimAnimation) and
            not PythonValidator.is_subclass_of(animation_generator_instance_or_class, BaseThreeDManimAnimation)
        ):
