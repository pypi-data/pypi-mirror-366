...
from virtualitics_sdk.llm.chat import ChatInputProcessor as ChatInputProcessor, ChatOutputProcessor as ChatOutputProcessor
...
class App:
    ...
    **EXAMPLE:**
    ...
    def __init__(self, name: str, description: str, image_path: str | None = None, is_shareable: bool = False, sort_key: str | None = None, on_llm_request: ChatInputProcessor | None = None, on_llm_response: ChatOutputProcessor | None = None) -> None: ...
