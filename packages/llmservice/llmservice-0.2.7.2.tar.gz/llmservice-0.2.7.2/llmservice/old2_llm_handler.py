...
MODEL_PROVIDERS = {
    ...
    # GPT-4.x family (custom/preview models)
    ...
    # o3 family (future models)
    "o3": "openai",
    
    # o4 family (future models)
    "o4-mini": "openai",
...
class LLMHandler:
    ...
    def llm_call_request_2_openai_payload(self,llm_call_request):
            llm_call_request.model
            llm_call_request.system_prompt
            llm_call_request.user_prompt
            llm_call_request.input_audio_b64
            llm_call_request.images
            llm_call_request.tool_call
            llm_call_request.output_data_format
            llm_call_request.audio_output_config

            return openai_payload_dict

            


    def process_call_request(self,llm_call_request):
        ...
        if self.is_it_gpt_model(llm_call_request.model_name):
            
            
            
            payload=self.llm_call_request_2_openai_payload(llm_call_request)
