...
class PymunkRigidBody(Component):
    ...
    def __init__(self, game_object, mass=1.0, gravity_scale=1.0, drag=0.0,
        ...
        print(f"PymunkRigidBody created with mass={self.mass}, gravity_scale={self.gravity_scale}, lock_rotation={self.lock_rotation}")

    def start(self):
        """Initialize the rigidbody. The actual pymunk body will be created by the physics system."""
        print(f"PymunkRigidBody started on {self.game_object.name}")
    ...
    def update(self, engine):
        ...
        if self.body and not self.is_kinematic:
            ...
            is_circle = self.game_object.get_component(PymunkCircleCollider) is not None
    ...
    def set_mass(self, mass):
        ...
        print(f"PymunkRigidBody mass changed to {self.mass}")

    def set_gravity_scale(self, scale):
        """Change how much gravity affects this object."""
        self.gravity_scale = scale
        print(f"PymunkRigidBody gravity scale changed to {self.gravity_scale}")
    ...
    def set_kinematic(self, is_kinematic):
        ...
        if self.body:
            if is_kinematic:
                ...
                # CRITICAL FIX: Restore mass and moment when switching back to dynamic
        ...
        print(f"PymunkRigidBody kinematic mode: {self.is_kinematic}")

    # ================ Debug Methods ================

    def __repr__(self):
        return (f"PymunkRigidBody(mass={self.mass}, velocity={self.velocity}, "
