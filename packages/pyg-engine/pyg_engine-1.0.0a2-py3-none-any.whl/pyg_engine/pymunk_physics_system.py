...
from .pymunk_collider import PymunkCollider, PymunkBoxCollider, PymunkCircleCollider, CollisionInfo
from .material import PhysicsMaterial, Materials

class PymunkPhysicsSystem:
    ...
    def __init__(self):
        ...
        self.space.iterations = 30  # Higher solver iterations for stability
    ...
    def _setup_physics_objects(self, game_objects):
        ...
        for obj in game_objects:
            ...
            rb = obj.get_component(PymunkRigidBody)
            collider = obj.get_component(PymunkCollider)
    ...
    def _create_physics_body(self, game_object, rigidbody, collider):
        ...
        if rigidbody.is_kinematic:
            ...
            if isinstance(collider, PymunkBoxCollider):
                moment = pymunk.moment_for_box(rigidbody.mass, (collider.width, collider.height))
            elif isinstance(collider, PymunkCircleCollider):
        ...
        if isinstance(collider, PymunkCircleCollider):
        ...
        elif isinstance(collider, PymunkBoxCollider):
            # Create box shape
            ...
            if rb and rb.body:
                ...
                if not rb.is_kinematic or not is_being_dragged:
                    ...
                    if not (body_x != body_x or body_y != body_y):  # NaN check
                        ...
                        is_circle = obj.get_component(PymunkCircleCollider) is not None
    ...
    def add_object(self, game_object):
        ...
        rb = game_object.get_component(PymunkRigidBody)
        collider = game_object.get_component(PymunkCollider)
    ...
    def __del__(self):
        ...
        if hasattr(self, 'space'):
            ...
            print("PymunkPhysicsSystem cleaned up") 