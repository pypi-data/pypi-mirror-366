...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Dynamic PSST Compiler - Learning Prompt Symbol Technology")
    parser.add_argument("command", choices=["compress", "expand", "learn", "stats", "optimize"], 
    ...
    try:
        if args.command == "compress":
            output = dynamic_compress_file(args.input, args.output, args.glossary, args.learning_data)
            ...
            print(f"Learned from: {args.input}")
