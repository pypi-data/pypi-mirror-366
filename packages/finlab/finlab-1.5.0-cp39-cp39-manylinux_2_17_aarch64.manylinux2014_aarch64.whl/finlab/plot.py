...
def plot_line(
    ...
    """
    Line chart with:
    ▸ zone-coloured segments (h_line_color_ranges / v_line_color_ranges)
    ▸ optional guide lines, coloured bands, benchmark, last-point marker.
    """
    ...
    palette_iter = iter(_PLOTLY_PALETTE)
