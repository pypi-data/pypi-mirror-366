...
skadi.TopologyStore = class extends skadi.StoreBase {
    ...
    async load_from(file, node_renamings, read_only) {
        try {
            let db = null;
            if (!read_only) {
...
skadi.DirectoryApi = class extends skadi.Api {
    ...
    add_topology(topology_id, metadata, status) {
        ...
        if (status) {
            this.topology_status[topology_id] = status;
        }
    ...
    render_topology(topology_id) {
        ...
        if (status) {
            let img = label.append("img");
            if (status["running"]) {
                img.attr("src",skadi.icon_running_topology).style("vertical-align","text-top").style("margin-left","10px");
            } else {
                img.attr("src",skadi.icon_stopped_topology).style("vertical-align","text-top").style("margin-left","10px");
            }
        }
