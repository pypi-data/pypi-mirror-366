...
class ChatPreview(BaseModel):
    ...
    def model_dump(self) -> dict:
        ...
        dump["time_left"] = TimeLeft.get_time_left(
            time_left_for_free_conversation_seconds=(self.free_conversation_expire_date - datetime.now(tz=ZoneInfo("UTC"))).total_seconds(),
            time_left_for_free_template_window_seconds=(self.free_template_window_expire_date - datetime.now(tz=ZoneInfo("UTC"))).total_seconds()
        ).model_dump()
