...
class AuthManager:
    ...
    def login(self, email: str = None, password: str = None, provider: str = "google", use_supabase: bool = True) -> Dict:
        ...
        # Use Supabase OAuth (recommended) or legacy OAuth as fallback
        if use_supabase:
            try:
                print("🔐 Using Supabase OAuth (recommended)...")
...
def login(email: str = None, password: str = None, provider: str = "google", base_url: str = "https://app.avocavo.app", verify_ssl: bool = True) -> Dict:
    """
