...
{Fore.light_green}Total Items={Style.bold}{Fore.spring_green_3a}{TotalItems}{Style.reset}
{Fore.light_green}Total CRV Items(each crv adds an xtra 1)={Fore.spring_green_3a}{TotalCRVItems}{Style.reset}
                    {Style.reset}"""
                    else:
