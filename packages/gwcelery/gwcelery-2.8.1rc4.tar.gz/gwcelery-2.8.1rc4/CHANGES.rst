...
2.8.1rc4 "Wood Booger" (2025-07-31)
-----------------------------------

-   Bump ligo-followup-advocate to v1.3.7. This is to be compatible with Aframe
...
-   Turn off online inference tasks for Aframe only events.

-   Change path to distance marginalization lookup table in RapidPE-RIFT config file.

-   Remove INTEGRAL after decommission. Reduce expected GRB rate by 5 per year.
