...
"""
from lobapi.models.from_3 import From3
from lobapi.models.merge_variables import MergeVariables
from lobapi.models.thumbnail import Thumbnail
from lobapi.models.to_3 import To3


class ReturnsALetterObject(object):

    """Implementation of the 'Returns a letter object' model.
    ...
    Attributes:
        ...
        mfrom (From3): The model property of type From3.
        ...
        thumbnails (List[Thumbnail]): The model property of type
            List[Thumbnail].
        merge_variables (MergeVariables): The model property of type
            MergeVariables.
    ...
    def __init__(self,
                 ...
                 send_date=None,
                 object=None):
        """Constructor for the ReturnsALetterObject class"""
    ...
    def from_dictionary(cls,
        ...
        mfrom = From3.from_dictionary(dictionary.get('from')) if dictionary.get('from') else None
        ...
        merge_variables = MergeVariables.from_dictionary(dictionary.get('merge_variables')) if dictionary.get('merge_variables') else None
