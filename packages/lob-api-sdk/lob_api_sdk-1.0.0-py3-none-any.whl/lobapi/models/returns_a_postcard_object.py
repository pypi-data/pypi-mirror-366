...
"""
from lobapi.models.to_6 import To6


class ReturnsAPostcardObject(object):

    """Implementation of the 'Returns a postcard object' model.

    Attributes:
        id (str): The model property of type str.
        description (str): The model property of type str.
        metadata (Any): The model property of type Any.
        to (To6): The model property of type To6.
    ...
    def __init__(self,
                 ...
                 send_date=None,
                 object=None):
        """Constructor for the ReturnsAPostcardObject class"""
    ...
    def from_dictionary(cls,
        ...
        to = To6.from_dictionary(dictionary.get('to')) if dictionary.get('to') else None
