...
"""
from lobapi.models.column_mapping import ColumnMapping


class AnArrayOfMatchingUploadsEachEntryInTheArrayIsASeparateUpload(object):

    """Implementation of the 'An array of matching uploads. Each entry in the array is a separate upload.' model.

    Attributes:
        id (str): The model property of type str.
        account_id (str): The model property of type str.
        campaign_id (str): The model property of type str.
        column_mapping (ColumnMapping): The model property of type
            ColumnMapping.
    ...
    def __init__(self,
                 ...
                 date_created=None,
                 date_modified=None):
        """Constructor for the AnArrayOfMatchingUploadsEachEntryInTheArrayIsASeparateUpload class"""
    ...
    def from_dictionary(cls,
        ...
        column_mapping = ColumnMapping.from_dictionary(dictionary.get('columnMapping')) if dictionary.get('columnMapping') else None
