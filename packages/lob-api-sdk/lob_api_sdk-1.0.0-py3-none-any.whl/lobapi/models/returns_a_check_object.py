...
from lobapi.models.to import To


class ReturnsACheckObject(object):

    """Implementation of the 'Returns a check object' model.
    ...
    Attributes:
        ...
        to (To): The model property of type To.
    ...
    def __init__(self,
                 ...
                 send_date=None,
                 object=None):
        """Constructor for the ReturnsACheckObject class"""
    ...
    def from_dictionary(cls,
        ...
        to = To.from_dictionary(dictionary.get('to')) if dictionary.get('to') else None
