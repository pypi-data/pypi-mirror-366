...
class Bytes(DatabaseEntity):
    ...
    def find_bytes_between(
        ...
        elif start_ea < self.m_database.minimum_ea or start_ea > self.m_database.maximum_ea:
            raise InvalidEAError(start_ea)

        if end_ea is None:
            end_ea = self.m_database.maximum_ea
        elif end_ea < self.m_database.minimum_ea or end_ea > self.m_database.maximum_ea:
