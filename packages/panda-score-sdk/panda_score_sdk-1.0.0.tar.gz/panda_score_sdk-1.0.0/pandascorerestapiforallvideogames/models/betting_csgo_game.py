...
from pandascorerestapiforallvideogames.models.csgo_map import CSGOMap
...
class BettingCSGOGame(object):
    ...
    Attributes:
        ...
        map (CSGOMap): The model property of type CSGOMap.
    ...
    def from_dictionary(cls,
        ...
        map = CSGOMap.from_dictionary(dictionary.get('map')) if dictionary.get('map') else None
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.begin_at,
                ...
                and APIHelper.is_valid_type(value=dictionary.map,
                                            type_callable=lambda value: CSGOMap.validate(value),
                                            is_value_nullable=True,
                                            is_model_dict=True) \
