...
from pandascorerestapiforallvideogames.models.market_status_enum import MarketStatusEnum
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.id,
                ...
                and APIHelper.is_valid_type(value=dictionary.line,
                                            type_callable=lambda value: isinstance(value, str),
                                            is_value_nullable=True) \
                and APIHelper.is_valid_type(value=dictionary.margin,
                ...
                and APIHelper.is_valid_type(value=dictionary.participant_type,
                                            ...
                                            is_value_nullable=True) \
                and APIHelper.is_valid_type(value=dictionary.selections,
                                            type_callable=lambda value: MarketSelection.validate(value),
                                            is_model_dict=True,
                                            is_inner_model_dict=True) \
                and APIHelper.is_valid_type(value=dictionary.status,
                                            type_callable=lambda value: MarketStatusEnum.validate(value)) \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('id'),
                                       type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('line'),
                                        type_callable=lambda value: isinstance(value, str),
                                        is_value_nullable=True) \
            and APIHelper.is_valid_type(value=dictionary.get('margin'),
                                        type_callable=lambda value: isinstance(value, float)) \
            ...
            and APIHelper.is_valid_type(value=dictionary.get('participant_type'),
                                        type_callable=lambda value: OpponentTypeEnum.validate(value),
                                        is_value_nullable=True) \
            and APIHelper.is_valid_type(value=dictionary.get('selections'),
                                        type_callable=lambda value: MarketSelection.validate(value),
                                        is_model_dict=True,
                                        is_inner_model_dict=True) \
