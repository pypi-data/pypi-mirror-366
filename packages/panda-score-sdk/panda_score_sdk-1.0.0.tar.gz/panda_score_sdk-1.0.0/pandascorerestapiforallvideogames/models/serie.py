...
from pandascorerestapiforallvideogames.models.videogame_title import VideogameTitle
...
class Serie(object):
    ...
    Attributes:
        ...
        videogame_title (VideogameTitle): The model property of type
            VideogameTitle.
    ...
    def from_dictionary(cls,
        ...
        videogame_title = VideogameTitle.from_dictionary(dictionary.get('videogame_title')) if dictionary.get('videogame_title') else None
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.begin_at,
                ...
                and APIHelper.is_valid_type(value=dictionary.videogame_title,
                                            type_callable=lambda value: VideogameTitle.validate(value),
                                            is_value_nullable=True,
                                            is_model_dict=True) \
