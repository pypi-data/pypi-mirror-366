...
from pandascorerestapiforallvideogames.models.live_event import LiveEvent
...
class Live(object):
    ...
    Attributes:
        endpoints (List[LiveEndpoint]): The model property of type
            List[LiveEndpoint].
        event (LiveEvent): The model property of type LiveEvent.
    ...
    def from_dictionary(cls,
        ...
        event = LiveEvent.from_dictionary(dictionary.get('event')) if dictionary.get('event') else None
