...
class BettingMatch(object):
    ...
    Attributes:
        ...
        league (BettingLeague): The model property of type BettingLeague.
        ...
        serie (BettingSerie): The model property of type BettingSerie.
        ...
        videogame_version (ShortVideogameVersion): The model property of type
    ...
    def from_dictionary(cls,
        ...
        games = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BettingGame2'), dictionary.get('games'), False) if dictionary.get('games') is not None else None
        id = dictionary.get("id") if dictionary.get("id") else None
        league = BettingLeague.from_dictionary(dictionary.get('league')) if dictionary.get('league') else None
        ...
        results = APIHelper.deserialize_union_type(UnionTypeLookUp.get('MatchResult2'), dictionary.get('results'), False) if dictionary.get('results') is not None else None
        ...
        serie = BettingSerie.from_dictionary(dictionary.get('serie')) if dictionary.get('serie') else None
        ...
        videogame_version = ShortVideogameVersion.from_dictionary(dictionary.get('videogame_version')) if dictionary.get('videogame_version') else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.begin_at,
                ...
                and APIHelper.is_valid_type(value=dictionary.game_advantage,
                                            ...
                                            is_value_nullable=True) \
                and UnionTypeLookUp.get('BettingGame2').validate(dictionary.games).is_valid \
                ...
                and APIHelper.is_valid_type(value=dictionary.rescheduled,
                                            type_callable=lambda value: isinstance(value, bool),
                                            is_value_nullable=True) \
                and UnionTypeLookUp.get('MatchResult2').validate(dictionary.results).is_valid \
                and APIHelper.is_valid_type(value=dictionary.scheduled_at,
                                            type_callable=lambda value: isinstance(value, APIHelper.RFC3339DateTime),
                                            is_value_nullable=True) \
                and APIHelper.is_valid_type(value=dictionary.serie,
                                            type_callable=lambda value: BettingSerie.validate(value),
                                            is_value_nullable=True,
                                            is_model_dict=True) \
                ...
                and APIHelper.is_valid_type(value=dictionary.videogame_version,
                                            type_callable=lambda value: ShortVideogameVersion.validate(value),
                                            is_value_nullable=True,
                                            is_model_dict=True) \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('begin_at'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('game_advantage'),
                                        type_callable=lambda value: isinstance(value, Any),
                                        is_value_nullable=True) \
            and UnionTypeLookUp.get('BettingGame2').validate(dictionary.get('games')).is_valid \
            ...
            and APIHelper.is_valid_type(value=dictionary.get('rescheduled'),
                                        type_callable=lambda value: isinstance(value, bool),
                                        is_value_nullable=True) \
            and UnionTypeLookUp.get('MatchResult2').validate(dictionary.get('results')).is_valid \
