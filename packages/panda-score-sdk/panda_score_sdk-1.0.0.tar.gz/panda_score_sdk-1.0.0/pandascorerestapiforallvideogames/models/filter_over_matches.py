...
class FilterOverMatches(object):
    ...
    def from_dictionary(cls,
        ...
        opponent_id = APIHelper.deserialize_union_type(UnionTypeLookUp.get('TeamIDOrSlug2'), dictionary.get('opponent_id'), False) if dictionary.get('opponent_id') is not None else APIHelper.SKIP
