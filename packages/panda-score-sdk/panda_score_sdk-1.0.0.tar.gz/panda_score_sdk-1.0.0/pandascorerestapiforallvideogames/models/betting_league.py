...
class BettingLeague(object):
    ...
    Attributes:
        ...
        videogame (LeagueVideogameLoL | LeagueVideogameCSGO |
            LeagueVideogameDota2 | LeagueVideogameOverwatch |
            LeagueVideogamePUBG | LeagueVideogameFortnite |
            LeagueVideogameRocketLeague | LeagueVideogameCodmw |
            LeagueVideogameR6siege | LeagueVideogameFifa |
            LeagueVideogameValorant): The model property of type
            LeagueVideogameLoL | LeagueVideogameCSGO | LeagueVideogameDota2 |
            LeagueVideogameOverwatch | LeagueVideogamePUBG |
            LeagueVideogameFortnite | LeagueVideogameRocketLeague |
            LeagueVideogameCodmw | LeagueVideogameR6siege |
            LeagueVideogameFifa | LeagueVideogameValorant.
    ...
    def from_dictionary(cls,
        ...
        videogame = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BettingLeagueVideogame'), dictionary.get('videogame'), False) if dictionary.get('videogame') is not None else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.id,
                ...
                and APIHelper.is_valid_type(value=dictionary.url,
                                            type_callable=lambda value: isinstance(value, str),
                                            is_value_nullable=True) \
                and UnionTypeLookUp.get('BettingLeagueVideogame').validate(dictionary.videogame).is_valid
        ...
        return APIHelper.is_valid_type(value=dictionary.get('id'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('url'),
                                        type_callable=lambda value: isinstance(value, str),
                                        is_value_nullable=True) \
            and UnionTypeLookUp.get('BettingLeagueVideogame').validate(dictionary.get('videogame')).is_valid
