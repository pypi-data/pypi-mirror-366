...
class TournamentsController(BaseController):
    ...
    def get_tournaments_tournament_id_or_slug(self,
        ...
        Args:
            tournament_id_or_slug (int | str): A tournament ID or slug
        ...
        return super().new_api_call_builder.request(
            ...
            .template_param(Parameter()
                            ...
                            .should_encode(True)
                            .validator(lambda value: UnionTypeLookUp.get('TournamentIDOrSlug').validate(value)))
            .header_param(Parameter()
                          .key('accept')
                          .value('application/json'))
            .auth(Or(Single('BearerToken'), Single('QueryToken')))
    ...
    def get_tournaments_tournament_id_or_slug_brackets(self,
        ...
        Args:
            tournament_id_or_slug (int | str): A tournament ID or slug
            filter (FilterOverBrackets, optional): Options to filter results.
                String fields are case sensitive
            range (RangeOverBrackets, optional): Options to select results
                within ranges
            sort (List[SortOverBracketEnum], optional): Options to sort results
            search (SearchOverBrackets, optional): Options to search results
            page (int | Page | None, optional): Pagination in the form of
                `page=2` or `page[size]=30&amp;page[number]=2`
            per_page (int, optional): Equivalent to `page[size]`
