...
class IncidentOfTypeLeague(object):
    ...
    Attributes:
        ...
        id (int): An incident ID
        modified_at (datetime): The model property of type datetime.
        object (League): The model property of type League.
    ...
    def from_dictionary(cls,
        ...
        id = APIHelper.deserialize_union_type(UnionTypeLookUp.get('IncidentID'), dictionary.get('id'), False) if dictionary.get('id') is not None else None
        ...
        object = League.from_dictionary(dictionary.get('object')) if dictionary.get('object') else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.change_type,
                ...
                and UnionTypeLookUp.get('IncidentID').validate(dictionary.id).is_valid \
                ...
                and APIHelper.is_valid_type(value=dictionary.object,
                                            type_callable=lambda value: League.validate(value),
                                            is_model_dict=True) \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('change_type'),
                                       type_callable=lambda value: IncidentChangeTypeEnum.validate(value)) \
            and UnionTypeLookUp.get('IncidentID').validate(dictionary.get('id')).is_valid \
