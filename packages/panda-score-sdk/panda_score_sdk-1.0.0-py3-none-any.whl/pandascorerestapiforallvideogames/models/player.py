...
class Player(object):
    ...
    Attributes:
        ...
        current_team (BaseTeam): The model property of type BaseTeam.
    ...
    def from_dictionary(cls,
        ...
        current_team = BaseTeam.from_dictionary(dictionary.get('current_team')) if dictionary.get('current_team') else None
