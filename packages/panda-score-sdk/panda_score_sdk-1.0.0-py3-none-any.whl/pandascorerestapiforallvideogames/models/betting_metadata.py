...
from pandascorerestapiforallvideogames.models.betting_group import BettingGroup
...
class BettingMetadata(object):
    ...
    Attributes:
        betting_group (BettingGroup): The model property of type BettingGroup.
        blueprint (BettingGroup): The model property of type BettingGroup.
    ...
    def from_dictionary(cls,
        ...
        betting_group = BettingGroup.from_dictionary(dictionary.get('betting_group')) if dictionary.get('betting_group') else None
        blueprint = BettingGroup.from_dictionary(dictionary.get('blueprint')) if dictionary.get('blueprint') else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.betting_group,
                                           type_callable=lambda value: BettingGroup.validate(value),
