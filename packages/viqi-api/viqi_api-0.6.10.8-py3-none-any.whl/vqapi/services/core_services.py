...
class DirProxy(FuturizedServiceProxy):
    ...
    def list_files(
        ...
        Args:
            ...
            ensure_latest: if true, ensure latest state is returned, otherwise use fast pathdb
        ...
        if ensure_latest is not None:
            params["ensure_latest"] = str(ensure_latest)
        params["limit"] = limit
