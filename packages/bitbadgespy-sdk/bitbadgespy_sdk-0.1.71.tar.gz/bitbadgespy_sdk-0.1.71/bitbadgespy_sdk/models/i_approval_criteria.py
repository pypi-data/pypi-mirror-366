...
class IApprovalCriteria(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["coinTransfers", "merkleChallenges", "mustOwnBadges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "autoDeletionOptions", "requireToEqualsInitiatedBy", "requireFromEqualsInitiatedBy", "requireToDoesNotEqualInitiatedBy", "requireFromDoesNotEqualInitiatedBy", "overridesFromOutgoingApprovals", "overridesToIncomingApprovals", "userRoyalties", "dynamicStoreChallenges"]
