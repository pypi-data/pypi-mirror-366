...
class SchemaDefinition(_message.Message):
    __slots__ = ("schemaType", "partType", "table", "fields", "namedTypes", "namedEnums")
    ...
    def __init__(self, schemaType: _Optional[_Union[SchemaType, str]] = ..., partType: _Optional[_Union[PartType, str]] = ..., table: _Optional[_Union[TableSchema, _Mapping]] = ..., fields: _Optional[_Iterable[_Union[FieldSchema, _Mapping]]] = ..., namedTypes: _Optional[_Mapping[str, SchemaDefinition]] = ..., namedEnums: _Optional[_Mapping[str, EnumValues]] = ...) -> None: ...
