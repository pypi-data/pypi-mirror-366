...
class LlamaAPIConnector:
    ...
    def query(self, instructions: str, context: str, json_schema: dict = {},
        ...
        response = requests.post(url, data=json.dumps(payload, ensure_ascii=False), timeout=timeout)
        extracted_data = {}
        if response.status_code == 200:
            ...
            try:
                ...
                LOGGER.exception(f"Loading JSON from response failed with error: {e}. Response.text: '{response.text}'")
