...
class InvoicePaymentMethodClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, psp, type, provider_token, psp_customer_id, created_by, updated_by, *args, **kwargs):  # noqa: E501
        """InvoicePaymentMethodClass - a model defined in OpenAPI
        ...
        Args:
            ...
            psp (str): The payment service provider associated with this payment method.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, psp, type, provider_token, psp_customer_id, created_by, updated_by, *args, **kwargs):  # noqa: E501
        """InvoicePaymentMethodClass - a model defined in OpenAPI
