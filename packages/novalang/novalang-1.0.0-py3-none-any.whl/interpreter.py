...
class Interpreter:
    ...
    def _setup_builtins(self):
        """Setup built-in functions with interpreter context."""
        ...
        self.environment.define("trim", BuiltinFunction(lambda s: str(s).strip()))
        
        # JSON functions
        import json
        self.environment.define("stringifyJSON", BuiltinFunction(lambda obj: json.dumps(obj, indent=2)))
        self.environment.define("parseJSON", BuiltinFunction(json.loads))
        ...
        def assert_func(condition, message=None):
            ...
            return True
        self.environment.define("assert", BuiltinFunction(assert_func))
