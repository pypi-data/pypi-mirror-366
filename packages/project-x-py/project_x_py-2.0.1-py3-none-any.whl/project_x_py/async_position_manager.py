...
class AsyncPositionManager:
    ...
    async def calculate_position_pnl(
        ...
        Example:
            ...
            ...     position, 2050.0, point_value=10.0  # MGC = $10/point
            ... )
    ...
    async def calculate_portfolio_pnl(
        ...
        Example:
            ...
            >>> print(f"Positions analyzed: {portfolio_pnl['positions_with_prices']}/"
    ...
    async def export_portfolio_report(self) -> dict[str, Any]:
        ...
        Example:
            ...
            >>> print(f"Exposure: ${report['portfolio_summary']['total_exposure']:,.2f}")
            ...
            >>> # Save report to file
            >>> import json
