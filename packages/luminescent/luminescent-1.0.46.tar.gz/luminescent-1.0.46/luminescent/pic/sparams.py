...
def make_prob(
    ...
    component=None,
    wavelengths=None,
    characteristic_wavelength=None,
    entries=None,
    keys=["2,1"],
    study="sparams",
    nres=4,
    ...
    **kwargs
    ...
    if characteristic_wavelength is None:
        characteristic_wavelength = median(wavelengths)
    # nres *= characteristic_wavelength / min(map(min, wavelengths))
