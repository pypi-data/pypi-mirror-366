...
"""
Unit tests for :py:mod:`hawat.blueprints.pivot`.
"""
...
class SearchTestCase(TestRunnerMixin, HawatTestCase):
    """
    Class for testing ``pivot.search`` endpoint.
    """
    ...
    def _attempt_succeed(self):
        self.assertGetURL(
            "/pivot/search",
            200,
            [b"Calculate event pivot tables"],
        )
...
class APISearchTestCase(TestRunnerMixin, HawatTestCase):
    """
    Class for testing ``pivot.apisearch`` endpoint.
    """
