...
class BaseFrameworkSetup(ABC):
    ...
    def extract_openapi(self, openapi_json_path: Path, target_folder: Path, drop_if_empty: bool = True) -> None:
        self._extract_openapi(openapi_json_path, target_folder, drop_if_empty=drop_if_empty)

    def extract_openapi_legacy(self, openapi_json_path: Path, target_folder: Path, drop_if_empty: bool = True) -> None:
        self._extract_openapi(openapi_json_path, target_folder, legacy=True, drop_if_empty=drop_if_empty)
    ...
    def cleanup(self, target_folder: Optional[Path] = None) -> None:
