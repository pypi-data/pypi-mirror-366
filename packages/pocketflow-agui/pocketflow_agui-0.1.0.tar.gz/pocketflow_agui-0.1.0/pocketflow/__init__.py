...
class BaseNode:
    def __init__(self):
        ...
        self.agui_callback: Optional[Callable] = None

    def set_agui_callback(self, callback: Callable):
        self.agui_callback = callback

    def emit_agui_event(self, event_type: str, data: Dict[str, Any]):
        if self.agui_callback:
            self.agui_callback(event_type, data)
...
class Flow(BaseNode):
    ...
    def _orch(self,shared,params=None):
        ...
        while curr:
            curr.set_params(p)
            if self.agui_callback: curr.set_agui_callback(self.agui_callback)
