...
from agentsphere import Sandbox as SandboxBase, CommandHandle, CommandResult, TimeoutException, CommandExitException, ProxyTypes
...
class Sandbox(SandboxBase):
    default_template = "agentsphere-desktop-v1"
