...
from .typedefs import (DeleteResponse, EmbedText, QueryResponse, QueryText,
                       UpsertResponse)
...
class Vectors(tp.NamedTuple):
    ...
    async def get_vectors_ids(self, *, namespace: str) -> tp.List[str]:
        """
    ...
    async def get_vector(self, *, namespace: str, id: str) -> tp.Any:
        """
