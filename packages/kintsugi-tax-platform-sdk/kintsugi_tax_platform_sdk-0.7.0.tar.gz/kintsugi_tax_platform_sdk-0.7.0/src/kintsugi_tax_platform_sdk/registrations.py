...
class Registrations(BaseSDK):
    def get_registrations_v1_registrations_get(
        self,
        *,
        status_in: Optional[
            str
    ...
    async def get_registrations_v1_registrations_get_async(
        self,
        *,
        status_in: Optional[
            str
    ...
    def create_registration_v1_registrations_post(
        self,
        *,
    ...
    async def create_registration_v1_registrations_post_async(
        self,
        *,
        request: Union[models.CreateRegistration, models.CreateRegistrationTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def get_registration_by_id_v1_registrations_registration_id_get(
        self,
        *,
        registration_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def get_registration_by_id_v1_registrations_registration_id_get_async(
        self,
        *,
        registration_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def update_registration_v1_registrations_registration_id_put(
        self,
        *,
        registration_id: str,
    ...
    async def update_registration_v1_registrations_registration_id_put_async(
        self,
        *,
        registration_id: str,
        registration_date: Optional[str] = None,
    ...
    def deregister_registration_v1_registrations_registration_id_deregister_post(
        self,
        *,
        registration_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def deregister_registration_v1_registrations_registration_id_deregister_post_async(
        self,
        *,
        registration_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
