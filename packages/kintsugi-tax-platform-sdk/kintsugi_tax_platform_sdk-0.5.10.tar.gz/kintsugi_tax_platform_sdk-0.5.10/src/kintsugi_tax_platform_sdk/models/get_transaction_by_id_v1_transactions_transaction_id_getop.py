...
class GetTransactionByIDV1TransactionsTransactionIDGetSecurityTypedDict(TypedDict):
    api_key_header: NotRequired[str]
    http_bearer: NotRequired[str]


class GetTransactionByIDV1TransactionsTransactionIDGetSecurity(BaseModel):
