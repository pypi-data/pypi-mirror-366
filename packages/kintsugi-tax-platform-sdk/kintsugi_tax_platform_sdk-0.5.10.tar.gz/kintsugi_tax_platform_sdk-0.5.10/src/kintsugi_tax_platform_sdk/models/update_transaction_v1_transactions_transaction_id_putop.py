...
class UpdateTransactionV1TransactionsTransactionIDPutSecurityTypedDict(TypedDict):
    api_key_header: NotRequired[str]
    http_bearer: NotRequired[str]


class UpdateTransactionV1TransactionsTransactionIDPutSecurity(BaseModel):
