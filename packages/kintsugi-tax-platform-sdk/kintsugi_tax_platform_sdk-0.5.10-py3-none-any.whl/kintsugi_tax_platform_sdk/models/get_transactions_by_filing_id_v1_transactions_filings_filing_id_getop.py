...
class GetTransactionsByFilingIDV1TransactionsFilingsFilingIDGetSecurityTypedDict(
    TypedDict
):
...
class GetTransactionsByFilingIDV1TransactionsFilingsFilingIDGetSecurity(BaseModel):
