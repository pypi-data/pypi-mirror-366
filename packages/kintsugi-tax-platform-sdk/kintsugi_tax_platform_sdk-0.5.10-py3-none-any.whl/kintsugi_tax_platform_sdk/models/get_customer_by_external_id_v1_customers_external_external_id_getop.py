...
class GetCustomerByExternalIDV1CustomersExternalExternalIDGetSecurityTypedDict(
    TypedDict
):
...
class GetCustomerByExternalIDV1CustomersExternalExternalIDGetSecurity(BaseModel):
