...
class GetTransactionByExternalIDV1TransactionsExternalExternalIDGetSecurityTypedDict(
    TypedDict
):
...
class GetTransactionByExternalIDV1TransactionsExternalExternalIDGetSecurity(BaseModel):
