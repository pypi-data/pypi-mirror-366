...
class BigQueryJobOperator(BigQueryExecuteQueryOperator):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        self.log.warning("The class `awehflow.operators.gcp.BigQueryJobOperator` is deprecated and will be removed after August 1, 2025. Please use `awehflow.operators.gcp.BigQueryJobExecutionOperator` instead")
