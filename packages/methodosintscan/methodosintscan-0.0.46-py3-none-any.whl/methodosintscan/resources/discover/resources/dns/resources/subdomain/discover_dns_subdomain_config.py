...
class DiscoverDnsSubdomainConfig_Intelligent(UniversalBaseModel):
    discovery_type: typing.Literal["intelligent"] = pydantic.Field(alias="discoveryType", default="intelligent")
    domains: typing.List[str]
    threads: int
    timeout: int
    max_recursion: int = pydantic.Field(alias="maxRecursion")
    dns_resolver: typing.Optional[str] = pydantic.Field(alias="dnsResolver", default=None)
...
DiscoverDnsSubdomainConfig = typing.Union[
    DiscoverDnsSubdomainConfig_Active, DiscoverDnsSubdomainConfig_Passive, DiscoverDnsSubdomainConfig_Intelligent
]
