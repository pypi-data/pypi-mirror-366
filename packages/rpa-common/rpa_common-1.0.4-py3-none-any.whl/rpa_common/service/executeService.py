...
class executeService():
    ...
    @staticmethod
    def request(driver, url, method="POST", params=None, data=None, headers=None):
        '''
        @Desc    : 请求
        @Author  : 钟水洲
    ...
    @staticmethod
    def request_file(driver, url, file_url, method="POST", params=None, data=None, headers=None):
        '''
        @Desc    : 请求
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
