...
def main():
    parser = argparse.ArgumentParser(
        description="🎥 Download YouTube videos or extract audio easily.",
        epilog="""
Examples:
  ytmagic https://youtu.be/abc123                # Best video+audio
  ytmagic https://youtu.be/abc123 -q 720         # Download 720p
  ytmagic https://youtu.be/abc123 -a             # Download and convert to MP3
  ytmagic -a https://youtu.be/abc123 -p ~/Music  # Audio to custom folder
        """,
