...
class DtoGenericResponseDtoInjectionV2Response(BaseModel):
    ...
    data: Optional[DtoInjectionV2Response] = Field(default=None, description="Generic type data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoInjectionV2Response.from_dict(obj["data"]) if obj.get("data") is not None else None,
