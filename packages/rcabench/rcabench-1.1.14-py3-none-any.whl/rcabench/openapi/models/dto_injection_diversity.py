    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.attribute_coverages:
            for _key_attribute_coverages in self.attribute_coverages:
                if self.attribute_coverages[_key_attribute_coverages]:
                    _field_dict[_key_attribute_coverages] = self.attribute_coverages[_key_attribute_coverages].to_dict()
        ...
        if self.fault_service_coverages:
            for _key_fault_service_coverages in self.fault_service_coverages:
                if self.fault_service_coverages[_key_fault_service_coverages]:
                    _field_dict[_key_fault_service_coverages] = self.fault_service_coverages[_key_fault_service_coverages].to_dict()
        ...
        if self.pair_distribution:
            for _item_pair_distribution in self.pair_distribution:
                if _item_pair_distribution:
                    _items.append(_item_pair_distribution.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fault_service_coverages": dict(
                ...
                for _k, _v in obj["fault_service_coverages"].items()
            )
            if obj.get("fault_service_coverages") is not None
            else None,
            "pair_distribution": [DtoPairStats.from_dict(_item) for _item in obj["pair_distribution"]] if obj.get("pair_distribution") is not None else None,
