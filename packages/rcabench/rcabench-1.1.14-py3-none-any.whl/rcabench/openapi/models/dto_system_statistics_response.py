...
class DtoSystemStatisticsResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containers": DtoContainerStatistics.from_dict(obj["containers"]) if obj.get("containers") is not None else None,
            "datasets": DtoDatasetStatistics.from_dict(obj["datasets"]) if obj.get("datasets") is not None else None,
            "executions": DtoExecutionStatistics.from_dict(obj["executions"]) if obj.get("executions") is not None else None,
            "generated_at": obj.get("generated_at"),
            "injections": DtoInjectionStatistics.from_dict(obj["injections"]) if obj.get("injections") is not None else None,
            "projects": DtoProjectStatistics.from_dict(obj["projects"]) if obj.get("projects") is not None else None,
            "tasks": DtoTaskStatistics.from_dict(obj["tasks"]) if obj.get("tasks") is not None else None,
            "users": DtoUserStatistics.from_dict(obj["users"]) if obj.get("users") is not None else None
        })
