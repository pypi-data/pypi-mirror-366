...
class SuperOptiXLMStudioBackend(SuperOptiXBaseBackend):
        ...
        try:
            ...
            for model in installed_models:
                if model.name == model_name:
                    ...
                    console.print(
                        f"  [bold green]super model dspy lmstudio/{model_name}[/bold green]"
                    )
                    return True
        except Exception as e:
    ...
    def uninstall_model(self, model_name: str) -> bool:
        ...
        console.print()
        console.print(f"📁 Model path: ~/.cache/lm-studio/models/mlx-community/Llama-3.2-1B-Instruct-4bit/")
        ...
        try:
            ...
            try:
                ...
                return {
                    ...
                    "model": model_name,
                    "prompt": prompt,
                    "response": f"LM Studio model {model_name} is available. Use 'lms chat' for interactive mode or start a server with 'lms server start --model {model_name}'",
                }
