...
class SeqLinear(nn.Module):
    ...
    def bidirectional(self, x):
        ...
        out_f = torch.einsum('bthd, bhts, bshd, bshe -> bthe', C, decay_f, B, x)
        out_b = torch.einsum('bthd, bhts, bshd, bshe -> bthe', C, decay_b, B, x)
