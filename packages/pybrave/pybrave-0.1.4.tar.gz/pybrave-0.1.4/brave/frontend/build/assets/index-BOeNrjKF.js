import{r as m,j as e,B as n,F as _,S as d,a as g}from"./index-BT6xGZJ2.js";import{A as h}from"./index-CBZATGQG.js";import{f}from"./utils-D2B0dIuM.js";import{T as c}from"./index-BLVx9eCn.js";import"./index-GyOG3fhK.js";import"./Table-DToc2eAE.js";import"./addEventListener-keZ10fsH.js";import"./index-B8dMEHii.js";import"./index-DhrsRx8L.js";import"./index-DbUQ2vkP.js";import"./index-ZwQ_cfLa.js";import"./index-CZyOcRSJ.js";import"./index-B10G697B.js";import"./index-Bw31C-LM.js";import"./index-ThqNjMmR.js";import"./index-BtaRUSBQ.js";import"./index-3P32b7zB.js";import"./index-B0T9HVny.js";const y=({record:t,plot:a,setHtmlUrl:u,cleanDom:l,resultTableList:o,form:p})=>{const[r,i]=m.useState();return e.jsx(e.Fragment,{children:e.jsx(c,{onChange:l,items:[{key:"1",label:"多样本分析",children:e.jsxs(e.Fragment,{children:[e.jsx(n,{type:"primary",onClick:()=>{a({saveAnalysisMethod:"mutations_gene",moduleName:"circos_plot_mutations",params:{file_path:"/ssd1/wy/workspace2/leipu/leipu_workspace2/output/breseq/OSP-6/data/OSP-6.count"},formDom:e.jsx(e.Fragment,{children:e.jsx(_.Item,{name:"list_files",label:"选择样本",children:e.jsx(d,{mode:"multiple",style:{maxWidth:"20rem"},allowClear:!0,options:o.breseq?o.breseq.map(s=>({label:`${s.sample_name} (${s.content.reference})`,value:`${s.sample_name}#${s.content.annotated_tsv}`})):[]})})}),tableDesc:`
+ 选择样本说明:
...
| "seq_id": "Chr"                            | 突变发生在哪条序列上（例如染色体或质粒）                       |
                ...
                `})},children:"变异统计"})]})}]})})},N=()=>{const[t,a]=m.useState([]),[u,l]=m.useState(!1),o=async()=>{l(!0);const r=await g.get("/api/mutation");console.log(r),l(!1),a(r.data)};m.useEffect(()=>{o()},[]);const p=[{title:"参考基因组",dataIndex:"reference",key:"reference",ellipsis:!0,render:(r,i)=>{var s;return e.jsx(e.Fragment,{children:(s=i==null?void 0:i.content)==null?void 0:s.reference})}}];return e.jsx(e.Fragment,{children:e.jsx(c,{items:[{label:"breseq",key:"breseq",children:e.jsx(h,{appendSampleColumns:p,analysisMethod:[{name:"breseq",label:"breseq",inputKey:["breseq"],mode:"multiple"}],analysisType:"sample",children:e.jsx(y,{})})}]})})};export{N as default};
