...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        # Use of `copy.deepcopy` is possible but not traceable in torch dynamo.
...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        hidden_states, new_key_states, new_value_states = hidden_states
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
    ...
    ) -> Tuple[torch.FloatTensor, List[torch.FloatTensor], List[torch.FloatTensor]]:
        output_attentions = (
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            hidden_states, new_key_states, new_value_states = layer_outputs
            new_key_states_list.append(new_key_states)
            new_value_states_list.append(new_value_states)

        hidden_states = self.norm(hidden_states)
        return hidden_states, new_key_states_list, new_value_states_list
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        hidden_states, new_key_states_list, new_value_states_list = outputs
        ...
        if labels is not None:
            ...
            loss = loss_fct(shift_logits, shift_labels)  # noqa: F841

        return logits, new_key_states_list, new_value_states_list
