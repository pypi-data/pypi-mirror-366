...
class GPTJAttention(nn.Module):
    ...
    def _get_embed_positions(self, position_ids):
        # Note: Prior to December 2nd, 2024, the code that ensures embed_positions
        # and position_ids are on the same device was not present.
        # It is not clear at the moment why the code was removed from the original transformers
        # repo in the first place, but we revert such removal so
        # as to enable GPU validation of untraced GPTJ_huggingface_rope model.
