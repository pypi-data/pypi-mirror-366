...
from .kv_caching import kv_index_update
from .utils import renew_attention_module

logger = logging.get_logger(__name__)


# GPTJCausalForLM.forward returns Tuple[torch.Tesor, Tuple[Tuple[torch.Tensor, torch.Tensor], ...]]
