    ...
    for(size_t k = 0; k < input.shape[0]; k++){                
        ...
        for(size_t i = 0; i < biases.len; i++){
            ...
            for(size_t j = 0; j+7 < weights.shape[0]; j+=8){
                ...
                accs[0] += input.data[input_inner + j*input.stride[1]] * weights.data[j*weights.stride[0]+weights_outer];
                accs[1] += input.data[input_inner + (j+1)*input.stride[1]] * weights.data[(j+1)*weights.stride[0]+weights_outer];
                accs[2] += input.data[input_inner + (j+2)*input.stride[1]] * weights.data[(j+2)*weights.stride[0]+weights_outer];
                accs[3] += input.data[input_inner + (j+3)*input.stride[1]] * weights.data[(j+3)*weights.stride[0]+weights_outer];
                accs[4] += input.data[input_inner + (j+4)*input.stride[1]] * weights.data[(j+4)*weights.stride[0]+weights_outer];
                accs[5] += input.data[input_inner + (j+5)*input.stride[1]] * weights.data[(j+5)*weights.stride[0]+weights_outer];
                accs[6] += input.data[input_inner + (j+6)*input.stride[1]] * weights.data[(j+6)*weights.stride[0]+weights_outer];
                accs[7] += input.data[input_inner + (j+7)*input.stride[1]] * weights.data[(j+7)*weights.stride[0]+weights_outer];
