    ...
    class ApplePayConfig:
        ...
        products = {
            "vip001": {
                ...
                "price": 28,
                "currency": "CNY",
                "type": "non_renewable",  # consumable, non_consumable, auto_renewable, non_renewable 必须与models.py中的ProductType匹配
                "duration": 30,
            ...
            "vip002": {
                ...
                "price": 48,
                "currency": "CNY",
                "type": "auto_renewable",  # consumable, non_consumable, auto_renewable, non_renewable 必须与models.py中的ProductType匹配
                "duration": 30,
                "duration_type": "day",  # day, week, month, year
                "优惠券": {
                    "discount_9": {
            ...
            "vip003": {
                ...
                "price": 48,
                "currency": "CNY",
                "type": "consumable",  # consumable, non_consumable, auto_renewable, non_renewable 必须与models.py中的ProductType匹配
                "duration": None,
