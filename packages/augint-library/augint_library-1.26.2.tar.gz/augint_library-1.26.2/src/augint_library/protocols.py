...
This module defines the core protocols (interfaces) that implementations
in this library should follow. These protocols establish contracts between
different components and enable type-safe dependency injection.

For detailed specifications and examples, see specs/interfaces/example.py.

Example:
    >>> from augint_library.protocols import DataProcessor
    >>>
    >>> def process_with_any_processor(processor: DataProcessor, data):
    ...     return processor.process(data, timeout=30)
"""
