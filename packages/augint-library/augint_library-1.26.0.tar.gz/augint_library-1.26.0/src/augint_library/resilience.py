...
This module provides retry and circuit breaker decorators for making
functions more resilient to transient failures. These patterns are
essential for distributed systems and external service calls.
"""
