...
class TelemetryClient:
    ...
    def __init__(self) -> None:
        ...
        self._consent_file = Path.home() / ".augint" / "consent.json"
    ...
    def _should_enable_telemetry(self) -> bool:
        ...
        env_enabled = os.getenv("AUGINT_TELEMETRY_ENABLED", "").lower()
    ...
    def _initialize_sentry(self) -> None:
        ...
        try:
            ...
            sentry_sdk.init(
                ...
                release=release,
                # Environment
                environment=os.getenv("AUGINT_ENVIRONMENT", "production"),
    ...
    def _anonymize_path(self, filepath: str) -> str:
        ...
        # If it contains augint_library, show path from there
        for i, part in enumerate(path.parts):
            if part == "augint_library":
