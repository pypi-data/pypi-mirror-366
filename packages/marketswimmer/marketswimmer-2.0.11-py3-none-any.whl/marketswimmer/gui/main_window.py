...
class MarketSwimmerGUI(QMainWindow):
    ...
    def download_data(self):
        ...
        command = f'"{sys.executable}" -m marketswimmer analyze {self.current_ticker} --force'
    ...
    def create_visualizations(self):
        ...
        command = f'"{sys.executable}" -m marketswimmer visualize --ticker {self.current_ticker}'
        self.run_command(command)
