...
from ARParser.constants import *
from ARParser.resources import public
from ARParser.stringblock import StringBlock
from ARParser.exceptions import ResParserError
from ARParser.parser_arsc import ARSCHeader, ARSCParser
...
class AXMLParser:
    ...
    def getAttributeName(
        self, index: int,
        resource_name: bool = False,
        arscobj: Union[ARSCParser, None] = None
    ) -> str:
        """
        ...
        if not res or res == ":":
            ...
            # into problems.
            if resource_name and arscobj:
                res = arscobj.get_resource_xml_name(attr, exclude_pkg_id=True)
            if not res:
