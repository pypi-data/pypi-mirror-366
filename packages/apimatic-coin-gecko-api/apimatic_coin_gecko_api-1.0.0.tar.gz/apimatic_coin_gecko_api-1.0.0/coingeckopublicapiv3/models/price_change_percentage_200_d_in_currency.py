...
class PriceChangePercentage200dInCurrency(object):

    """Implementation of the 'PriceChangePercentage200dInCurrency' model.
    ...
    def __init__(self,
                 ...
                 eur=APIHelper.SKIP,
                 usd=APIHelper.SKIP):
        """Constructor for the PriceChangePercentage200dInCurrency class"""
