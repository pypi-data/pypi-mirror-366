...
class FloorPrice30dPercentageChange(object):

    """Implementation of the 'FloorPrice30dPercentageChange' model.
    ...
    def __init__(self,
        ...
        """Constructor for the FloorPrice30dPercentageChange class"""
