...
class FloorPrice14dPercentageChange(object):

    """Implementation of the 'FloorPrice14dPercentageChange' model.
    ...
    def __init__(self,
        ...
        """Constructor for the FloorPrice14dPercentageChange class"""
