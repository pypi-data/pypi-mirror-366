...
class MarketCap24hPercentageChange(object):

    """Implementation of the 'MarketCap24hPercentageChange' model.
    ...
    def __init__(self,
        ...
        """Constructor for the MarketCap24hPercentageChange class"""
