...
class FloorPrice7dPercentageChange(object):

    """Implementation of the 'FloorPrice7dPercentageChange' model.
    ...
    def __init__(self,
        ...
        """Constructor for the FloorPrice7dPercentageChange class"""
