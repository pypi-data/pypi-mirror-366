...
from coingeckopublicapiv3.models.market_1 import Market1


class Ticker1(object):

    """Implementation of the 'Ticker1' model.

    Attributes:
        base (str): coin ticker base currency
        target (str): coin ticker target currency
        market (Market1): coin ticker exchange
        last (float): coin ticker last price
        volume (float): coin ticker volume
        cost_to_move_up_usd (float): coin ticker cost to move up in usd
        cost_to_move_down_usd (float): coin ticker cost to move down in usd
        ...
        bid_ask_spread_percentage (float): coin ticker bid ask spread
            percentage
        timestamp (str): coin ticker timestamp
        last_traded_at (str): coin ticker last traded timestamp
        last_fetch_at (str): coin ticker last fetch timestamp
    ...
    def __init__(self,
                 ...
                 cost_to_move_up_usd=APIHelper.SKIP,
                 cost_to_move_down_usd=APIHelper.SKIP,
        ...
        """Constructor for the Ticker1 class"""
        ...
        if volume is not APIHelper.SKIP:
            self.volume = volume 
        if cost_to_move_up_usd is not APIHelper.SKIP:
            self.cost_to_move_up_usd = cost_to_move_up_usd 
        if cost_to_move_down_usd is not APIHelper.SKIP:
            self.cost_to_move_down_usd = cost_to_move_down_usd 
    ...
    def from_dictionary(cls,
        ...
        market = Market1.from_dictionary(dictionary.get('market')) if 'market' in dictionary.keys() else APIHelper.SKIP
        ...
        cost_to_move_up_usd = dictionary.get("cost_to_move_up_usd") if dictionary.get("cost_to_move_up_usd") else APIHelper.SKIP
        cost_to_move_down_usd = dictionary.get("cost_to_move_down_usd") if dictionary.get("cost_to_move_down_usd") else APIHelper.SKIP
        ...
        last_fetch_at = dictionary.get("last_fetch_at") if dictionary.get("last_fetch_at") else APIHelper.SKIP
        ...
        token_info_url = dictionary.get("token_info_url") if "token_info_url" in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'cost_to_move_up_usd={(self.cost_to_move_up_usd if hasattr(self, "cost_to_move_up_usd") else None)!r}, '
                f'cost_to_move_down_usd={(self.cost_to_move_down_usd if hasattr(self, "cost_to_move_down_usd") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'cost_to_move_up_usd={(self.cost_to_move_up_usd if hasattr(self, "cost_to_move_up_usd") else None)!s}, '
                f'cost_to_move_down_usd={(self.cost_to_move_down_usd if hasattr(self, "cost_to_move_down_usd") else None)!s}, '
