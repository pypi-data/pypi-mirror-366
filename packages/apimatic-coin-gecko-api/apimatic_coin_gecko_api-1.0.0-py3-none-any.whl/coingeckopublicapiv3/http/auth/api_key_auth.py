...
class ApiKeyAuth(HeaderAuth):
    ...
    def error_message(self):
        ...
        """
        return "ApiKeyAuth: x-cg-demo-api-key is undefined."

    def __init__(self, api_key_auth_credentials):
        auth_params = {}
        if api_key_auth_credentials is not None \
                and api_key_auth_credentials.x_cg_demo_api_key is not None:
            auth_params["x-cg-demo-api-key"] = api_key_auth_credentials.x_cg_demo_api_key
