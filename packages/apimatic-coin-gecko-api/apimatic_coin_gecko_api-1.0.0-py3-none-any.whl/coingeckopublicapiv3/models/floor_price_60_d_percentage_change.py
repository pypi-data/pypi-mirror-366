...
class FloorPrice60dPercentageChange(object):

    """Implementation of the 'FloorPrice60dPercentageChange' model.
    ...
    def __init__(self,
        ...
        """Constructor for the FloorPrice60dPercentageChange class"""
