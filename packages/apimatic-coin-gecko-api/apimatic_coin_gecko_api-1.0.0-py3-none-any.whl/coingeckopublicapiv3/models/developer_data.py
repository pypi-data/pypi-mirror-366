...
from coingeckopublicapiv3.models.code_additions_deletions_4_weeks import CodeAdditionsDeletions4Weeks


class DeveloperData(object):

    """Implementation of the 'DeveloperData' model.
    ...
    Attributes:
        ...
        pull_request_contributors (float): coin repository pull request
            contributors
        code_additions_deletions_4_weeks (CodeAdditionsDeletions4Weeks): coin
            code additions and deletions in 4 weeks
        commit_count_4_weeks (float): coin repository commit count in 4 weeks
        last_4_weeks_commit_activity_series (List[float]): coin repository
            last 4 weeks commit activity series
    ...
    _names = {
        ...
        "last_4_weeks_commit_activity_series": 'last_4_weeks_commit_activity_series'
    }
    ...
    def __init__(self,
                 ...
                 last_4_weeks_commit_activity_series=APIHelper.SKIP):
        """Constructor for the DeveloperData class"""
        ...
        if last_4_weeks_commit_activity_series is not APIHelper.SKIP:
            self.last_4_weeks_commit_activity_series = last_4_weeks_commit_activity_series 
    ...
    def from_dictionary(cls,
        ...
        code_additions_deletions_4_weeks = CodeAdditionsDeletions4Weeks.from_dictionary(dictionary.get('code_additions_deletions_4_weeks')) if 'code_additions_deletions_4_weeks' in dictionary.keys() else APIHelper.SKIP
        commit_count_4_weeks = dictionary.get("commit_count_4_weeks") if dictionary.get("commit_count_4_weeks") else APIHelper.SKIP
        last_4_weeks_commit_activity_series = dictionary.get("last_4_weeks_commit_activity_series") if dictionary.get("last_4_weeks_commit_activity_series") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'last_4_weeks_commit_activity_series={(self.last_4_weeks_commit_activity_series if hasattr(self, "last_4_weeks_commit_activity_series") else None)!r})')
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'last_4_weeks_commit_activity_series={(self.last_4_weeks_commit_activity_series if hasattr(self, "last_4_weeks_commit_activity_series") else None)!s})')
