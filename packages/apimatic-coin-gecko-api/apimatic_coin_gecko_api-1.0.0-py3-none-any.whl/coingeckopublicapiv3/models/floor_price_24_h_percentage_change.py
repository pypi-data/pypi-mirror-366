...
class FloorPrice24hPercentageChange(object):

    """Implementation of the 'FloorPrice24hPercentageChange' model.
    ...
    def __init__(self,
        ...
        """Constructor for the FloorPrice24hPercentageChange class"""
