...
class DerivativesExchangesID(object):

    """Implementation of the 'DerivativesExchangesID' model.
    ...
    Attributes:
        ...
        tickers (List[DerivativesTickersList]): The model property of type
            List[DerivativesTickersList].
    ...
    def __init__(self,
        ...
        """Constructor for the DerivativesExchangesID class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('tickers') is not None:
            tickers = [DerivativesTickersList.from_dictionary(x) for x in dictionary.get('tickers')]
        else:
            tickers = APIHelper.SKIP
