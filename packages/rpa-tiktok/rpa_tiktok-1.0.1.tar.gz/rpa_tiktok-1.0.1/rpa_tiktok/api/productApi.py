...
class productApi():
    ...
    @staticmethod
    def getCategory(driver, options):
        '''
        @Desc    : 获取类目
        @Author  : 钟水洲
    ...
    @staticmethod
    def getShopProductList(driver, options):
        '''
        @Desc    : 获取店铺产品
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def getGlobalProductList(driver, options):
        '''
        @Desc    : 获取全球产品
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def getGlobalProductDetail(driver, options):
        '''
        @Desc    : 获取全球产品详情
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def getShopProductDetail(driver, options):
        '''
        @Desc    : 获取店铺产品详情
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def getTitleCategory(driver, options):
        '''
        @Desc    : 根据标题获取推荐类目
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def getCategoryProperties(driver, options):
        '''
        @Desc    : 获取类目属性
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def getProductRating(driver, options):
        '''
        @Desc    : 获取商品评分
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def removeProduct(driver, options):
        '''
        @Desc    : 下架店铺产品
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def createGlobalProduct(driver, options):
        '''
        @Desc    : 创建全球产品
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def estimateShippingCost(driver, options):
        '''
        @Desc    : 获取产品预估物流成本
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def getProductBundle(driver, options):
        '''
        @Desc    : 获取商品搭配
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def publishGlobalProduct(driver, options):
        '''
        @Desc    : 发布到指定市场
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
    ...
    @staticmethod
    def mcalculatePrice(driver, options):
        '''
        @Desc    : 计算价格
        @Author  : 钟水洲
        @Time    : 2024/05/31 15:42:22
