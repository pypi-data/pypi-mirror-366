...
from .base import ImageGenerator, GeneratorConfig, GeneratorError
...
class GeneratorRegistry:
    ...
    def register_class(
        ...
        if not issubclass(generator_class, ImageGenerator):
            raise ValueError(f"Generator class must inherit from ImageGenerator")
    ...
    def get_generator(self, name: str) -> Optional[ImageGenerator]:
        """
        获取生成器实例
    ...
    def get_generator_info(self, name: str) -> Optional[Dict[str, str]]:
        """
        获取生成器信息
