...
class ConfigValidator:
    ...
    def get_configuration_suggestions(self, generator_name: str) -> List[str]:
        ...
        if not self.config_manager._config_files:
            suggestions.append(
                f"Consider creating a configuration file (e.g., mcp-imgutils.json) "
                f"in your home directory or current working directory"
            )
    ...
    def _validate_api_key_format(self, generator_name: str, api_key: str) -> Optional[str]:
        """
        验证API密钥格式
