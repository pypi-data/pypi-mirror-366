...
class GlobalResourceManager:
    ...
    def initialize(self, manager: Optional[ResourceManager] = None) -> None:
        """
        初始化全局资源管理器
...
def initialize_resource_manager(manager: Optional[ResourceManager] = None) -> None:
    """
    初始化全局资源管理器
...
async def cleanup_resources(
    ...
    max_disk_size_mb: Optional[float] = None,
