...
class ForceUpdateSensorStatisticsResponse(BaseModel):
    ...
    """ # noqa: E501
    updated_sensor_ids: List[StrictInt]
    total_updated: StrictInt
    __properties: ClassVar[List[str]] = ["updated_sensor_ids", "total_updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updated_sensor_ids": obj.get("updated_sensor_ids"),
