...
import { extractNotebookVariables, filterKernelVariablesByNotebook } from '../utils/VariableExtractor';
...
export class AnthropicMessageCreator {
  ...
  private static async prepareExtraSystemMessages(
    ...
    try {
      const kernelPreview = await KernelPreviewUtils.getKernelPreview();
