...
class AgentSessionManager:
    ...
    def create_user_session(self, user_id: str) -> Dict[str, Any]:
        ...
        thread_id = str(uuid.uuid4())  # Unique thread per user
        ...
        # Save to database
        self._save_session_to_db(user_id, thread_id, session_data)
    ...
    def _save_session_to_db(self, user_id: str, thread_id: str, session_data: Dict[str, Any]):
        ...
        try:
            with get_db_connection_context() as db:
                ...
                if hasattr(db, 'cursor') and callable(getattr(db, 'cursor', None)):
                    ...
                    upsert_sql = """
                    INSERT INTO user_sessions (user_id, thread_id, session_data, created_at, updated_at, is_active)
                    VALUES (%s, %s, %s, %s, %s, %s)
