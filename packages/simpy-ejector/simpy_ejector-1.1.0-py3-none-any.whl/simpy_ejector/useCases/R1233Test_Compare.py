...
subcooling = params["Tin"] - RP.SATPdll(P = params["pin"], z= [1.0] , kph= 1 ).T
...
if True:
    ...
    # frictionInterface : needed to reach similar speed, balance out between the two flows
    mixingParams = { 'massExchangeFactor' : 2.e-4, 'dragFactor': 0.1, 'frictionInterface': 0.1, 'frictionWall': 0.0}
    ...
    [print(mi) for mi in mixersolutions.items()]
