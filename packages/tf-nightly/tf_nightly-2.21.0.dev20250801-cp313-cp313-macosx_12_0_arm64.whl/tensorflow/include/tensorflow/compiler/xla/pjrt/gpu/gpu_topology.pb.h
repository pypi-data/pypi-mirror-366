...
/* @@protoc_insertion_point(class_definition:xla.GpuTopologyProto) */ {
 ...
 public:
  ...
  ::google::protobuf::RepeatedField<::int32_t>* PROTOBUF_NONNULL mutable_device_ids();

  private:
  const ::google::protobuf::RepeatedField<::int32_t>& _internal_device_ids() const;
  ::google::protobuf::RepeatedField<::int32_t>* PROTOBUF_NONNULL _internal_mutable_device_ids();
...
inline ::google::protobuf::RepeatedField<::int32_t>* PROTOBUF_NONNULL GpuTopologyProto::mutable_device_ids()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
