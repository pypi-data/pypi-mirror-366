...
{
    "distutils": {
        "name": "fb_api_wrapper.libs.define_api",
        "sources": [
            "fb_api_wrapper\\libs\\define_api.py"
        ]
    },
    "module_name": "fb_api_wrapper.libs.define_api"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fb_api_wrapper__libs__define_api
#define __PYX_HAVE_API__fb_api_wrapper__libs__define_api
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "fb_api_wrapper.libs.define_api" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "fb_api_wrapper.libs.define_api"
extern int __pyx_module_is_main_fb_api_wrapper__libs__define_api;
int __pyx_module_is_main_fb_api_wrapper__libs__define_api = 0;

/* Implementation of "fb_api_wrapper.libs.define_api" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_fb_api_wrapper__libs__define_api) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fb_api_wrapper.libs.define_api")) {
      if (unlikely((PyDict_SetItemString(modules, "fb_api_wrapper.libs.define_api", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fb_api_wrapper/libs/define_api.py":2
 * HEADERS = {
 ...
 */
  ...
  /* "fb_api_wrapper/libs/define_api.py":21
 * }
 * 
 ...
 */
  ...
  /* "fb_api_wrapper/libs/define_api.py":22
 * 
 * API_URL = "https://www.facebook.com/api/graphql/"
 * RANDOM_COOKIE = True             # <<<<<<<<<<<<<<
 * DEFAULT_REQUESTS_TIMEOUT = 10
 ...
 */
  ...
  /* "fb_api_wrapper/libs/define_api.py":23
 * API_URL = "https://www.facebook.com/api/graphql/"
 * RANDOM_COOKIE = True
 * DEFAULT_REQUESTS_TIMEOUT = 10             # <<<<<<<<<<<<<<
 * DEFAULT_SLEEP_TIME = 0
 */
  ...
  /* "fb_api_wrapper/libs/define_api.py":24
 * RANDOM_COOKIE = True
 * DEFAULT_REQUESTS_TIMEOUT = 10
 * DEFAULT_SLEEP_TIME = 0             # <<<<<<<<<<<<<<
 */
  ...
  /* "fb_api_wrapper/libs/define_api.py":1
 * HEADERS = {             # <<<<<<<<<<<<<<
 *     'authority': 'www.facebook.com',
 *     'accept': '*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*',
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init fb_api_wrapper.libs.define_api", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init fb_api_wrapper.libs.define_api");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
