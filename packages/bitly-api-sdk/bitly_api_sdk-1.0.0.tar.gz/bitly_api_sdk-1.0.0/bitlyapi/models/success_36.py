...
from bitlyapi.models.references_10 import References10


class SUCCESS36(object):

    """Implementation of the 'SUCCESS36' model.

    Attributes:
        references (References10): The model property of type References10.
    ...
    def __init__(self,
                 ...
                 launchpad_ids=None,
                 id=None):
        """Constructor for the SUCCESS36 class"""
    ...
    def from_dictionary(cls,
        ...
        references = References10.from_dictionary(dictionary.get('references')) if dictionary.get('references') else None
