...
"""
from bitlyapi.models.references_5 import References5


class SUCCESS14(object):

    """Implementation of the 'SUCCESS14' model.

    Attributes:
        references (References5): The model property of type References5.
    ...
    def __init__(self,
                 ...
                 role=None,
                 guid=None):
        """Constructor for the SUCCESS14 class"""
    ...
    def from_dictionary(cls,
        ...
        references = References5.from_dictionary(dictionary.get('references')) if dictionary.get('references') else None
