...
from bitlyapi.exceptions.conflict_exception import ConflictException
...
class CustomBitlinksController(BaseController):

    """A Controller to access Endpoints in the bitlyapi API."""
    def __init__(self, config):
        super(CustomBitlinksController, self).__init__(config)

    def add_custom_bitlink(self,
                           accept,
                           body):
        """Does a POST request to /custom_bitlinks.

        Add a keyword (or "custom back-half") to a Bitlink with a Custom
        Domain (domains must match). This endpoint can also be used for
        initial redirects to a link.

        Args:
            accept (str): The request header parameter.
            body (AddCustomBitlinkRequest): The request body parameter.
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('409', 'Conflict', ConflictException)
