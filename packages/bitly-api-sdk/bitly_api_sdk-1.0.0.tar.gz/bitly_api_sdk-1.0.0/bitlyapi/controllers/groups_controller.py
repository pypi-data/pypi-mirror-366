...
from bitlyapi.models.success_24 import SUCCESS24
...
class GroupsController(BaseController):
    ...
    def retrieve_groups(self,
                        organization_guid,
                        accept):
        """Does a GET request to /groups.

        Returns a list of groups in the organization.

        Args:
            organization_guid (str): A GUID for a Bitly organization
            accept (str): The request header parameter.

        Returns:
            SUCCESS24: Response from the API.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SUCCESS24.from_dictionary)
