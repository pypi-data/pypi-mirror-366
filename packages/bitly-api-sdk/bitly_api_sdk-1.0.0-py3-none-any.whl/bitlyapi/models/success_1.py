...
"""
from bitlyapi.models.metric import Metric


class SUCCESS1(object):

    """Implementation of the 'SUCCESS1' model.
    ...
    Attributes:
        ...
        metrics (List[Metric]): The model property of type List[Metric].
    ...
    def __init__(self,
                 ...
                 unit=None,
                 metrics=None):
        """Constructor for the SUCCESS1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('metrics') is not None:
            metrics = [Metric.from_dictionary(x) for x in dictionary.get('metrics')]
