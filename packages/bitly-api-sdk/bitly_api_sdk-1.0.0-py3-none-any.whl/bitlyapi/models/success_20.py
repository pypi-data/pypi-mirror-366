...
"""
from bitlyapi.models.metric_2 import Metric2


class SUCCESS20(object):

    """Implementation of the 'SUCCESS20' model.
    ...
    Attributes:
        ...
        metrics (List[Metric2]): The model property of type List[Metric2].
    ...
    def __init__(self,
                 ...
                 unit=None,
                 metrics=None):
        """Constructor for the SUCCESS20 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('metrics') is not None:
            metrics = [Metric2.from_dictionary(x) for x in dictionary.get('metrics')]
