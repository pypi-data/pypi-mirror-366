...
from bitlyapi.models.success_4 import SUCCESS4
...
class OrganizationsController(BaseController):
    ...
    def __init__(self, config):
        super(OrganizationsController, self).__init__(config)
    ...
    def retrieve_organizations(self,
        ...
        Returns:
            SUCCESS4: Response from the API.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SUCCESS4.from_dictionary)
