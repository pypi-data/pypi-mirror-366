...
class ChannelGuidController(BaseController):

    """A Controller to access Endpoints in the bitlyapi API."""
    def __init__(self, config):
        super(ChannelGuidController, self).__init__(config)

    def get_a_channel(self,
                      channel_guid,
                      accept):
        """Does a GET request to /channels/{channel_guid}.

        Returns a channel's details.

        Args:
            channel_guid (str): (Required) A GUID for a Bitly Channel
    ...
    def update_a_channel(self,
                         ...
                         accept,
                         body):
        """Does a PATCH request to /channels/{channel_guid}.
        ...
        Args:
            channel_guid (str): (Required) A GUID for a Bitly Channel
            accept (str): The request header parameter.
            body (UpdateAChannelRequest): The request body parameter.
