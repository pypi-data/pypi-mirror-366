...
from bitlyapi.models.success_9 import SUCCESS9
...
class PreferencesController(BaseController):
    ...
    def __init__(self, config):
        super(PreferencesController, self).__init__(config)

    def retrieve_group_preferences(self,
                                   group_guid,
                                   accept):
        """Does a GET request to /groups/{group_guid}/preferences.
        ...
        Returns:
            SUCCESS9: Response from the API.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SUCCESS9.from_dictionary)
    ...
    def update_group_preferences(self,
                                 group_guid,
                                 accept,
                                 body):
        """Does a PATCH request to /groups/{group_guid}/preferences.
        ...
        Args:
            group_guid (str): (Required) A GUID for a Bitly group
            accept (str): The request header parameter.
            body (UpdateGroupPreferencesRequest): The request body parameter.
