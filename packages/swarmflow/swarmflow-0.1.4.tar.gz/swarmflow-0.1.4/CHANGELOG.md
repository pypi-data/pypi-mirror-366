...
### Added
- **Auto-extracted LLM metadata**: Automatically detects and extracts model, provider, token usage, and cost estimation from OpenAI and Anthropic responses
- **Enhanced observability**: LLM metadata is automatically added to task traces and monitoring dashboard
