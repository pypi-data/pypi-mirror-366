...
def get_multiversion_base():
    ...
    return str(Path(__file__).parent.parent / ".dpncy_versions")
...
class MultiversionFinder:
    ...
    def find_spec(self, fullname, path, target=None):
        ...
        env_var_name = f"_DPNCY_ACTIVE_{top_level.upper().replace('-', '_')}"
...
def install_hook():
    """Installs the dpncy import hook if not already active"""
