            ...
            try:
                ...
                if data.__class__.__module__.startswith("openai"):
                    for chunk in data:
                        ...
                        # Attempt to extract content - supports both chat completion and responses API formats
                        content = None

                        try:
                            # Check for responses API format (new)
                            if (
                                hasattr(chunk, "type")
                                and chunk.type
                                ...
                                content = chunk.delta
                            # Check for chat completion format (legacy)
                            elif (
                            ...
                            log.warning(
                                "Could not extract content from chunk: %s",
                                attr_error,
                            )
                            content = None
