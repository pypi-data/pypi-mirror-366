...
class SecretsBackendFactory:
    @classmethod
    def select_and_run(cls, config: TfrunnerConfig, project: ProjectConfig, environment: str) -> dict[str, str]:
        """
        ...
        return cls.run(kind=secrets_backend.kind, environment=environment, spec=secrets_backend.spec)
