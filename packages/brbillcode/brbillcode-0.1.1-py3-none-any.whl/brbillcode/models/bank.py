...
class BankBill:
    ...
    def __get_expiry(self, expiry_factor: str, base_date=date(2025, 2, 2)) -> Union[date, None]:
        try:
            if expiry_factor[0] == "1":
                expiry_factor = "0" + expiry_factor[1:]

            base_date = base_date if expiry_factor[0] != "9" else date(1997, 10, 7)
