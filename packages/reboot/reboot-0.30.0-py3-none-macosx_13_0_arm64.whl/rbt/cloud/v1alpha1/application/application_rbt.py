...
IMPORT_reboot_versioning.check_generated_code_compatible("0.30.0")
...
class ApplicationServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def dispatch(
        ...
        *,
        ...
        on_loop_iteration: IMPORT_typing.Callable[[int], None] = lambda iteration: None,
        ...
        *,
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                # Check if this reader is from an `.always()`, i.e., _we_
                # generated an idempotency key, and if so, don't memoize!
                if idempotency.generated and idempotency.key is not None:
                    return await call()
...
class ApplicationServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    class _State:
        ...
        def always(self):
            return ApplicationServicer._State._Always(
                servicer=self._servicer,
            )
