...
from rara_subject_indexer.config import (
    ...
    DEFAULT_MIN_SCORE, DEFAULT_MAX_COUNT
)
...
class RaraSubjectIndexer:
    ...
    def apply_indexers(
        ...
        LOGGER.info(f"User set threshold_config: {threshold_config}")
        ...
        LOGGER.info(f"Filled all missing values with defaults in threshold_config: {self.threshold_config}")
