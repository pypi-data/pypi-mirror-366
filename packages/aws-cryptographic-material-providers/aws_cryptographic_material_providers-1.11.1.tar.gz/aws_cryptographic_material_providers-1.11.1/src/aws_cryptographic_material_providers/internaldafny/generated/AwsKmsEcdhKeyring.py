...
class DecryptSingleEncryptedDataKey(Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, edk):
        ...
        d_6_valueOrError1_ = Wrappers.default__.Need(((len(d_2_providerInfo_)) <= (Constants.default__.ECDH__PROVIDER__INFO__521__LEN)) and (RawECDHKeyring.default__.ValidProviderInfoLength(d_2_providerInfo_)), default__.E(_dafny.Seq("EDK ProviderInfo longer than expected")))
        ...
        d_8_valueOrError2_ = Wrappers.default__.Need((_dafny.Seq([d_7_keyringVersion_])) == (default__.AWS__KMS__ECDH__KEYRING__VERSION), default__.E(_dafny.Seq("Incorrect Keyring version found in provider info.")))
        ...
        out0_: Wrappers.Result
        out0_ = RawECDHKeyring.default__.DecompressPublicKey(d_14_providerInfoSenderPublicKey_, (self).curveSpec, (self).cryptoPrimitives)
        ...
        out1_: Wrappers.Result
        out1_ = RawECDHKeyring.default__.DecompressPublicKey(d_13_providerInfoRecipientPublicKey_, (self).curveSpec, (self).cryptoPrimitives)
        ...
        out2_ = RawECDHKeyring.default__.ValidatePublicKey((self).cryptoPrimitives, (self).curveSpec, d_16_senderPublicKey_)
        ...
        out3_ = RawECDHKeyring.default__.ValidatePublicKey((self).cryptoPrimitives, (self).curveSpec, d_18_recipientPublicKey_)
        ...
        d_23_valueOrError8_: Wrappers.Outcome = Wrappers.Outcome.default()()
        d_23_valueOrError8_ = Wrappers.default__.Need((ComAmazonawsKmsTypes.default__.IsValid__PublicKeyType(d_16_senderPublicKey_)) and (ComAmazonawsKmsTypes.default__.IsValid__PublicKeyType((self).recipientPublicKey)), default__.E(_dafny.Seq("Received serialized sender public key of incorrect length")))
        if (d_23_valueOrError8_).IsFailure():
            res = (d_23_valueOrError8_).PropagateFailure()
            return res
        d_24_sharedSecretPublicKey_: _dafny.Seq = _dafny.Seq({})
        d_25_sharedSecretKmsKeyId_: _dafny.Seq = _dafny.Seq("")
        source0_ = (self).keyAgreementScheme
        with _dafny.label("match0"):
            if True:
                if source0_.is_KmsPublicKeyDiscovery:
                    d_26_kmsPublicKeyDiscovery_ = source0_.KmsPublicKeyDiscovery
                    if True:
                        d_27_valueOrError9_: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.tuple())()
                        d_27_valueOrError9_ = AwsKmsUtils.default__.ValidateKmsKeyId((d_26_kmsPublicKeyDiscovery_).recipientKmsIdentifier)
                        if (d_27_valueOrError9_).IsFailure():
                            res = (d_27_valueOrError9_).PropagateFailure()
                            return res
                        d_28___v2_: tuple
                        d_28___v2_ = (d_27_valueOrError9_).Extract()
                        d_24_sharedSecretPublicKey_ = d_16_senderPublicKey_
                        d_25_sharedSecretKmsKeyId_ = (d_26_kmsPublicKeyDiscovery_).recipientKmsIdentifier
                    raise _dafny.Break("match0")
            if True:
                d_29_kmsPrivateKeyToStaticPublicKey_ = source0_.KmsPrivateKeyToStaticPublicKey
                if True:
                    d_30_valueOrError10_: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.tuple())()
                    d_30_valueOrError10_ = AwsKmsUtils.default__.ValidateKmsKeyId((d_29_kmsPrivateKeyToStaticPublicKey_).senderKmsIdentifier)
                    if (d_30_valueOrError10_).IsFailure():
                        res = (d_30_valueOrError10_).PropagateFailure()
                        return res
                    d_31___v3_: tuple
                    d_31___v3_ = (d_30_valueOrError10_).Extract()
                    d_25_sharedSecretKmsKeyId_ = (d_29_kmsPrivateKeyToStaticPublicKey_).senderKmsIdentifier
                    if ((d_29_kmsPrivateKeyToStaticPublicKey_).recipientPublicKey) == (d_18_recipientPublicKey_):
                        d_24_sharedSecretPublicKey_ = d_18_recipientPublicKey_
                    elif True:
                        d_24_sharedSecretPublicKey_ = d_16_senderPublicKey_
            pass
        d_32_valueOrError11_: Wrappers.Outcome = Wrappers.Outcome.default()()
        d_32_valueOrError11_ = Wrappers.default__.Need(ComAmazonawsKmsTypes.default__.IsValid__PublicKeyType(d_24_sharedSecretPublicKey_), default__.E(_dafny.Seq("Received Recipient Public Key of incorrect expected length")))
        if (d_32_valueOrError11_).IsFailure():
            res = (d_32_valueOrError11_).PropagateFailure()
            return res
        d_33_valueOrError12_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        out4_: Wrappers.Result
        out4_ = default__.DeriveSharedSecret((self).client, d_25_sharedSecretKmsKeyId_, d_24_sharedSecretPublicKey_, (self).grantTokens)
        d_33_valueOrError12_ = out4_
        if (d_33_valueOrError12_).IsFailure():
            res = (d_33_valueOrError12_).PropagateFailure()
            return res
        d_34_sharedSecret_: _dafny.Seq
        d_34_sharedSecret_ = (d_33_valueOrError12_).Extract()
        d_35_ecdhUnwrap_: EcdhEdkWrapping.EcdhUnwrap
        nw0_ = EcdhEdkWrapping.EcdhUnwrap()
        nw0_.ctor__(d_14_providerInfoSenderPublicKey_, d_13_providerInfoRecipientPublicKey_, d_34_sharedSecret_, default__.AWS__KMS__ECDH__KEYRING__VERSION, (self).curveSpec, (self).cryptoPrimitives)
        d_35_ecdhUnwrap_ = nw0_
        d_36_unwrapOutputRes_: Wrappers.Result
        out5_: Wrappers.Result
        out5_ = EdkWrapping.default__.UnwrapEdkMaterial((edk).ciphertext, (self).materials, d_35_ecdhUnwrap_)
        d_36_unwrapOutputRes_ = out5_
        d_37_valueOrError13_: Wrappers.Result = Wrappers.Result.default(EdkWrapping.UnwrapEdkMaterialOutput.default(EcdhEdkWrapping.EcdhUnwrapInfo.default()))()
        d_37_valueOrError13_ = d_36_unwrapOutputRes_
        if (d_37_valueOrError13_).IsFailure():
            res = (d_37_valueOrError13_).PropagateFailure()
            return res
        d_38_unwrapOutput_: EdkWrapping.UnwrapEdkMaterialOutput
        d_38_unwrapOutput_ = (d_37_valueOrError13_).Extract()
        d_39_valueOrError14_: Wrappers.Result = None
        d_39_valueOrError14_ = Materials.default__.DecryptionMaterialsAddDataKey((self).materials, (d_38_unwrapOutput_).plaintextDataKey, (d_38_unwrapOutput_).symmetricSigningKey)
        if (d_39_valueOrError14_).IsFailure():
            res = (d_39_valueOrError14_).PropagateFailure()
            return res
        d_40_result_: AwsCryptographyMaterialProvidersTypes.DecryptionMaterials
        d_40_result_ = (d_39_valueOrError14_).Extract()
        res = Wrappers.Result_Success(d_40_result_)
        return res
        return res
