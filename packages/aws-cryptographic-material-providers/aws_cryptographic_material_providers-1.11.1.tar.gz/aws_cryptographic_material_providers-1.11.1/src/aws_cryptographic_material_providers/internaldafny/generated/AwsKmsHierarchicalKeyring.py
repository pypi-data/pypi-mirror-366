...
class AwsKmsHierarchicalKeyring(Keyring.VerifiableInterface, AwsCryptographyMaterialProvidersTypes.IKeyring):
    ...
    def GetActiveCacheId(self, branchKeyId, branchKeyIdUtf8, cryptoPrimitives):
        ...
        def iife0_(_pat_let6_0):
            def iife1_(d_1_branchKeyId_):
                return ((d_1_branchKeyId_).is_Success) and (((0) <= (len((d_1_branchKeyId_).value))) and ((len((d_1_branchKeyId_).value)) < (StandardLibrary_UInt.default__.UINT32__LIMIT)))
            return iife1_(_pat_let6_0)
        d_0_valueOrError0_ = Wrappers.default__.Need((True) and (iife0_(UTF8.default__.Decode(branchKeyIdUtf8))), default__.E(_dafny.Seq("Invalid Branch Key ID Length")))
        if (d_0_valueOrError0_).IsFailure():
    ...
    def GetActiveHierarchicalMaterials(self, branchKeyId, cacheId, keyStore):
        ...
        if ((d_1_getCacheOutput_).is_Failure) or (not(default__.cacheEntryWithinLimits(((d_1_getCacheOutput_).value).creationTime, d_2_now_, (self).ttlSeconds))):
            ...
            d_12_valueOrError2_ = Wrappers.default__.Need((((d_1_getCacheOutput_).value).materials).is_BranchKey, default__.E(_dafny.Seq("Invalid Material Type.")))
...
class OnDecryptHierarchyEncryptedDataKeyFilter(Actions.DeterministicActionWithResult, Actions.DeterministicAction):
    ...
    def Invoke(self, edk):
        ...
        d_2_valueOrError0_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        def lambda0_(d_3_e_):
            return default__.E(_dafny.Seq("Invalid encoding, provider info is not UTF8."))

        d_2_valueOrError0_ = (UTF8.default__.Decode(d_0_providerInfo_)).MapFailure(lambda0_)
        if (d_2_valueOrError0_).IsFailure():
            res = (d_2_valueOrError0_).PropagateFailure()
            return res
        d_4_branchKeyId_: _dafny.Seq
        d_4_branchKeyId_ = (d_2_valueOrError0_).Extract()
        res = Wrappers.Result_Success(((self).branchKeyId) == (d_4_branchKeyId_))
        return res
        return res
...
class DecryptSingleEncryptedDataKey(Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, edk):
        ...
        d_2_branchKeyIdUtf8_: _dafny.Seq
        d_2_branchKeyIdUtf8_ = (edk).keyProviderInfo
        ...
        d_6_valueOrError1_ = Wrappers.default__.Need((len(d_5_providerWrappedMaterial_)) >= (default__.EDK__CIPHERTEXT__VERSION__INDEX), AwsCryptographyMaterialProvidersTypes.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Received EDK Ciphertext of incorrect length.")))
        if (d_6_valueOrError1_).IsFailure():
            res = (d_6_valueOrError1_).PropagateFailure()
            return res
        d_7_branchKeyVersionUuid_: _dafny.Seq
        d_7_branchKeyVersionUuid_ = _dafny.Seq((d_5_providerWrappedMaterial_)[default__.EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX:default__.EDK__CIPHERTEXT__VERSION__INDEX:])
        d_8_valueOrError2_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        d_8_valueOrError2_ = (UUID.default__.FromByteArray(d_7_branchKeyVersionUuid_)).MapFailure(AwsKmsUtils.default__.WrapStringToError)
        if (d_8_valueOrError2_).IsFailure():
            res = (d_8_valueOrError2_).PropagateFailure()
            return res
        d_9_version_: _dafny.Seq
        d_9_version_ = (d_8_valueOrError2_).Extract()
        d_10_valueOrError3_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        out0_: Wrappers.Result
        out0_ = (self).GetVersionCacheId(d_2_branchKeyIdUtf8_, d_9_version_, (self).cryptoPrimitives)
        d_10_valueOrError3_ = out0_
        if (d_10_valueOrError3_).IsFailure():
            res = (d_10_valueOrError3_).PropagateFailure()
            return res
        d_11_cacheId_: _dafny.Seq
        d_11_cacheId_ = (d_10_valueOrError3_).Extract()
        d_12_valueOrError4_: Wrappers.Result = Wrappers.Result.default(AwsCryptographyKeyStoreTypes.BranchKeyMaterials.default())()
        out1_: Wrappers.Result
        out1_ = (self).GetHierarchicalMaterialsVersion((self).branchKeyId, d_2_branchKeyIdUtf8_, d_9_version_, d_11_cacheId_)
        d_12_valueOrError4_ = out1_
        if (d_12_valueOrError4_).IsFailure():
            res = (d_12_valueOrError4_).PropagateFailure()
            return res
        d_13_hierarchicalMaterials_: AwsCryptographyKeyStoreTypes.BranchKeyMaterials
        d_13_hierarchicalMaterials_ = (d_12_valueOrError4_).Extract()
        d_14_branchKey_: _dafny.Seq
        d_14_branchKey_ = (d_13_hierarchicalMaterials_).branchKey
        d_15_branchKeyVersion_: _dafny.Seq
        d_15_branchKeyVersion_ = (d_13_hierarchicalMaterials_).branchKeyVersion
        d_16_valueOrError5_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        d_16_valueOrError5_ = (UTF8.default__.Decode(d_15_branchKeyVersion_)).MapFailure(AwsKmsUtils.default__.WrapStringToError)
        if (d_16_valueOrError5_).IsFailure():
            res = (d_16_valueOrError5_).PropagateFailure()
            return res
        d_17_branchKeyVersionAsString_: _dafny.Seq
        d_17_branchKeyVersionAsString_ = (d_16_valueOrError5_).Extract()
        d_18_valueOrError6_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        d_18_valueOrError6_ = (UUID.default__.ToByteArray(d_17_branchKeyVersionAsString_)).MapFailure(AwsKmsUtils.default__.WrapStringToError)
        if (d_18_valueOrError6_).IsFailure():
            res = (d_18_valueOrError6_).PropagateFailure()
            return res
        d_19_branchKeyVersionAsBytes_: _dafny.Seq
        d_19_branchKeyVersionAsBytes_ = (d_18_valueOrError6_).Extract()
        d_20_maybeCrypto_: Wrappers.Result
        out2_: Wrappers.Result
        out2_ = AtomicPrimitives.default__.AtomicPrimitives(AtomicPrimitives.default__.DefaultCryptoConfig())
        d_20_maybeCrypto_ = out2_
        d_21_valueOrError7_: Wrappers.Result = None
        def lambda0_(d_22_e_):
            return AwsCryptographyMaterialProvidersTypes.Error_AwsCryptographyPrimitives(d_22_e_)

        d_21_valueOrError7_ = (d_20_maybeCrypto_).MapFailure(lambda0_)
        if (d_21_valueOrError7_).IsFailure():
            res = (d_21_valueOrError7_).PropagateFailure()
            return res
        d_23_cryptoPrimitivesX_: AwsCryptographyPrimitivesTypes.IAwsCryptographicPrimitivesClient
        d_23_cryptoPrimitivesX_ = (d_21_valueOrError7_).Extract()
        d_24_cryptoPrimitives_: AtomicPrimitives.AtomicPrimitivesClient
        d_24_cryptoPrimitives_ = d_23_cryptoPrimitivesX_
        d_25_kmsHierarchyUnwrap_: KmsHierarchyUnwrapKeyMaterial
        nw0_ = KmsHierarchyUnwrapKeyMaterial()
        nw0_.ctor__(d_14_branchKey_, d_2_branchKeyIdUtf8_, d_19_branchKeyVersionAsBytes_, d_24_cryptoPrimitives_)
        d_25_kmsHierarchyUnwrap_ = nw0_
        d_26_unwrapOutputRes_: Wrappers.Result
        out3_: Wrappers.Result
        out3_ = EdkWrapping.default__.UnwrapEdkMaterial((edk).ciphertext, (self).materials, d_25_kmsHierarchyUnwrap_)
        d_26_unwrapOutputRes_ = out3_
        d_27_valueOrError8_: Wrappers.Result = Wrappers.Result.default(EdkWrapping.UnwrapEdkMaterialOutput.default(HierarchyUnwrapInfo.default()))()
        d_27_valueOrError8_ = d_26_unwrapOutputRes_
        if (d_27_valueOrError8_).IsFailure():
            res = (d_27_valueOrError8_).PropagateFailure()
            return res
        d_28_unwrapOutput_: EdkWrapping.UnwrapEdkMaterialOutput
        d_28_unwrapOutput_ = (d_27_valueOrError8_).Extract()
        d_29_valueOrError9_: Wrappers.Result = None
        d_29_valueOrError9_ = Materials.default__.DecryptionMaterialsAddDataKey((self).materials, (d_28_unwrapOutput_).plaintextDataKey, (d_28_unwrapOutput_).symmetricSigningKey)
        if (d_29_valueOrError9_).IsFailure():
            res = (d_29_valueOrError9_).PropagateFailure()
            return res
        d_30_result_: AwsCryptographyMaterialProvidersTypes.DecryptionMaterials
        d_30_result_ = (d_29_valueOrError9_).Extract()
        res = Wrappers.Result_Success(d_30_result_)
        return res
        return res
    ...
    def GetVersionCacheId(self, branchKeyIdUtf8, branchKeyVersion, cryptoPrimitives):
        ...
        if (d_5_valueOrError1_).IsFailure():
            ...
            return cacheId
        d_6_valueOrError2_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        def lambda0_(d_7_e_):
            return AwsCryptographyMaterialProvidersTypes.Error_AwsCryptographicMaterialProvidersException(d_7_e_)

        d_6_valueOrError2_ = (UTF8.default__.Encode(branchKeyVersion)).MapFailure(lambda0_)
        if (d_6_valueOrError2_).IsFailure():
            cacheId = (d_6_valueOrError2_).PropagateFailure()
            return cacheId
        d_8_versionBytes_: _dafny.Seq
        d_8_versionBytes_ = (d_6_valueOrError2_).Extract()
        d_9_suffix_: _dafny.Seq
        d_9_suffix_ = (((((self).logicalKeyStoreNameBytes) + (CacheConstants.default__.NULL__BYTE)) + (branchKeyIdUtf8)) + (CacheConstants.default__.NULL__BYTE)) + (d_8_versionBytes_)
        d_10_identifier_: _dafny.Seq
        d_10_identifier_ = ((((((d_3_resourceId_) + (CacheConstants.default__.NULL__BYTE)) + (d_4_scopeId_)) + (CacheConstants.default__.NULL__BYTE)) + ((self).partitionIdBytes)) + (CacheConstants.default__.NULL__BYTE)) + (d_9_suffix_)
        d_11_identifierDigestInput_: AwsCryptographyPrimitivesTypes.DigestInput
        d_11_identifierDigestInput_ = AwsCryptographyPrimitivesTypes.DigestInput_DigestInput(d_2_hashAlgorithm_, d_10_identifier_)
        d_12_maybeCacheDigest_: Wrappers.Result
        out0_: Wrappers.Result
        out0_ = Digest.default__.Digest(d_11_identifierDigestInput_)
        d_12_maybeCacheDigest_ = out0_
        ...
        d_13_valueOrError3_ = (d_12_maybeCacheDigest_).MapFailure(lambda1_)
        if (d_13_valueOrError3_).IsFailure():
            cacheId = (d_13_valueOrError3_).PropagateFailure()
            return cacheId
        d_15_cacheDigest_: _dafny.Seq
        d_15_cacheDigest_ = (d_13_valueOrError3_).Extract()
        cacheId = Wrappers.Result_Success(d_15_cacheDigest_)
        return cacheId
        return cacheId
...
class KmsHierarchyUnwrapKeyMaterial(MaterialWrapping.UnwrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_5_salt_ = _dafny.Seq((d_1_wrappedMaterial_)[:default__.H__WRAP__SALT__LEN:])
        d_6_iv_: _dafny.Seq
        ...
        d_10_valueOrError1_ = (input).serializedEC
        ...
        d_19_output_: MaterialWrapping.UnwrapOutput
        d_19_output_ = MaterialWrapping.UnwrapOutput_UnwrapOutput(d_18_unwrappedPdk_, HierarchyUnwrapInfo_HierarchyUnwrapInfo())
        res = Wrappers.Result_Success(d_19_output_)
        return res
        return res
...
class KmsHierarchyGenerateAndWrapKeyMaterial(MaterialWrapping.GenerateAndWrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        out1_: Wrappers.Result
        out1_ = (d_5_wrap_).Invoke(MaterialWrapping.WrapInput_WrapInput(d_4_pdk_, (input).algorithmSuite, (input).encryptionContext, (input).serializedEC))
...
class KmsHierarchyWrapKeyMaterial(MaterialWrapping.WrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_5_salt_: _dafny.Seq
        d_5_salt_ = _dafny.Seq((d_4_saltAndNonce_)[:default__.H__WRAP__SALT__LEN:])
        ...
        d_7_valueOrError1_ = (input).serializedEC
