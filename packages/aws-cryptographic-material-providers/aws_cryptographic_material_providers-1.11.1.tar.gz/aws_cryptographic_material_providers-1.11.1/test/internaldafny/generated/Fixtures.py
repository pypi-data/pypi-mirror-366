...
class default__:
    ...
    @_dafny.classproperty
    def x123(instance):
        d_0_s_ = _dafny.Seq([49, 50, 51])
        return d_0_s_
    @_dafny.classproperty
    def KmsMrkEC(instance):
        return _dafny.Map({default__.abc: default__.x123})
    @_dafny.classproperty
    def branchKeyId(instance):
        return _dafny.Seq("3f43a9af-08c5-4317-b694-3d3e883dcaef")
    @_dafny.classproperty
    def branchKeyIdActiveVersion(instance):
        return _dafny.Seq("a4905627-4b7f-4272-a847-f50dae245737")
    @_dafny.classproperty
    def branchKeyIdActiveVersionUtf8Bytes(instance):
        return _dafny.Seq([97, 52, 57, 48, 53, 54, 50, 55, 45, 52, 98, 55, 102, 45, 52, 50, 55, 50, 45, 97, 56, 52, 55, 45, 102, 53, 48, 100, 97, 101, 50, 52, 53, 55, 51, 55])
    @_dafny.classproperty
