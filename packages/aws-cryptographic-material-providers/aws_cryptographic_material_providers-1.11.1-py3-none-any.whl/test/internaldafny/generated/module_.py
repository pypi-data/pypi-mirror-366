    ...
    def Test____Main____(noArgsParameter__):
        ...
        try:
            ...
            if True:
                ...
                _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
                d_0_success_ = False
        _dafny.print(_dafny.string_of(_dafny.Seq("TestCreateKeysWithSpecialECKeys.TestCreateKeyWithEmptyKeyEC: ")))
        try:
            if True:
                TestCreateKeysWithSpecialECKeys.default__.TestCreateKeyWithEmptyKeyEC()
                if True:
                    _dafny.print(_dafny.string_of(_dafny.Seq("PASSED\n")))
        except _dafny.HaltException as e:
            ...
            if True:
                ...
                _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
                d_0_success_ = False
        _dafny.print(_dafny.string_of(_dafny.Seq("TestCreateKeysWithSpecialECKeys.TestCreateKeyWithWhiteSpaceEC: ")))
        try:
            if True:
                TestCreateKeysWithSpecialECKeys.default__.TestCreateKeyWithWhiteSpaceEC()
                if True:
                    _dafny.print(_dafny.string_of(_dafny.Seq("PASSED\n")))
        except _dafny.HaltException as e:
            ...
            if True:
                ...
                _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
                d_0_success_ = False
        _dafny.print(_dafny.string_of(_dafny.Seq("TestCreateKeysWithSpecialECKeys.TestCreateKeyWithAllSpecialCharsEC: ")))
        try:
            if True:
                TestCreateKeysWithSpecialECKeys.default__.TestCreateKeyWithAllSpecialCharsEC()
                if True:
                    _dafny.print(_dafny.string_of(_dafny.Seq("PASSED\n")))
        except _dafny.HaltException as e:
        ...
        try:
            ...
            d_97_haltMessage_ = e.message
            if True:
                _dafny.print(_dafny.string_of(_dafny.Seq("FAILED\n	")))
                _dafny.print(_dafny.string_of(d_97_haltMessage_))
                _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
                d_0_success_ = False
        ...
        try:
            ...
            d_98_haltMessage_ = e.message
            if True:
                _dafny.print(_dafny.string_of(_dafny.Seq("FAILED\n	")))
                _dafny.print(_dafny.string_of(d_98_haltMessage_))
                _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
                d_0_success_ = False
        ...
        try:
            ...
            d_99_haltMessage_ = e.message
            if True:
                _dafny.print(_dafny.string_of(_dafny.Seq("FAILED\n	")))
                _dafny.print(_dafny.string_of(d_99_haltMessage_))
                _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
                d_0_success_ = False
        if not(d_0_success_):
