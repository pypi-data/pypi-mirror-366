...
class default__:
    ...
    @_dafny.classproperty
    def ECDH__KDF__DELIMITER(instance):
        return _dafny.Seq([0])
    @_dafny.classproperty
    ...
    def KMS__ECDH__PROVIDER__ID(instance):
        d_0_s_ = _dafny.Seq([97, 119, 115, 45, 107, 109, 115, 45, 101, 99, 100, 104])
        return d_0_s_
    @_dafny.classproperty
    def RAW__ECDH__PROVIDER__ID(instance):
        d_0_s_ = _dafny.Seq([114, 97, 119, 45, 101, 99, 100, 104])
        return d_0_s_
    @_dafny.classproperty
    def ECDH__KDF__PRF__NAME(instance):
        d_0_s_ = _dafny.Seq([72, 77, 65, 67, 95, 83, 72, 65, 51, 56, 52])
        return d_0_s_
    @_dafny.classproperty
    def ECDH__KDF__UTF8(instance):
        d_0_s_ = _dafny.Seq([101, 99, 100, 104, 45, 107, 101, 121, 45, 100, 101, 114, 105, 118, 97, 116, 105, 111, 110])
        return d_0_s_
...
class AwsKmsEncryptedDataKey:
    ...
    def _Is(source__):
        d_1_edk_: AwsCryptographyMaterialProvidersTypes.EncryptedDataKey = source__
        return (((d_1_edk_).keyProviderId) == (default__.PROVIDER__ID)) and (UTF8.default__.ValidUTF8Seq((d_1_edk_).keyProviderInfo))
