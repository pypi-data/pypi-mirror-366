...
class default__:
    ...
    def CreateRawAesKeyring(config, input):
        ...
        d_6_wrapping__key__size_: int
        d_6_wrapping__key__size_ = len((input).wrappingKey)
        d_7_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome.default()()
        d_7_valueOrError2_ = Wrappers.default__.Need((((d_6_wrapping__key__size_) == (16)) or ((d_6_wrapping__key__size_) == (24))) or ((d_6_wrapping__key__size_) == (32)), AwsCryptographyMaterialProvidersTypes.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Invalid wrapping key length")))
        ...
        d_8_valueOrError3_ = Wrappers.default__.Need((d_6_wrapping__key__size_) == ((d_1_wrappingAlg_).keyLength), AwsCryptographyMaterialProvidersTypes.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Wrapping key length does not match specified wrapping algorithm")))
        if (d_8_valueOrError3_).IsFailure():
            output = (d_8_valueOrError3_).PropagateFailure()
            return output
        d_9_keyring_: RawAESKeyring.RawAESKeyring
        nw0_ = RawAESKeyring.RawAESKeyring()
        nw0_.ctor__(d_4_namespace_, d_5_name_, (input).wrappingKey, d_1_wrappingAlg_, (config).crypto)
        d_9_keyring_ = nw0_
        output = Wrappers.Result_Success(d_9_keyring_)
        return output
        return output
