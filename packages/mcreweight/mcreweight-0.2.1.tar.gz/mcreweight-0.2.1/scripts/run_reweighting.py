...
def main():
    ...
    parser.add_argument("--monitoring_vars", nargs='+', default=["eCalTot/nEcalClusters", "nFTClusters", "nVPClusters", "log(B_CHI2DOF)", "log(abs(B_BPVFD))", "B_ETA", "L1_PT", "L1_P", "L1_ENERGY"],
