...
def sync_detailed(
    ...
    *,
    ...
    """Add a single reference to a class-property.
     ...
     Add a single reference to an object. This adds a reference to the array of cross-references of the
    given property in the source object specified by its collection name and id
