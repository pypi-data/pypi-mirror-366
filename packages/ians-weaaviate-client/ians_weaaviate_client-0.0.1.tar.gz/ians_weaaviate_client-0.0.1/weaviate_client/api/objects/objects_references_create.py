...
def sync_detailed(
    ...
    *,
    ...
    """Add a single reference to a class-property.
     ...
     Add a cross-reference. <br/><br/>**Note**: This endpoint is deprecated and will be removed in a
    future version. Use the `/objects/{className}/{id}/references/{propertyName}` endpoint instead.
