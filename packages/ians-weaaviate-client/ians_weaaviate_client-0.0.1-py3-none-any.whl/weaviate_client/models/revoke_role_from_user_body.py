...
T = TypeVar("T", bound="RevokeRoleFromUserBody")


@_attrs_define
class RevokeRoleFromUserBody:
    """
    Attributes:
        roles (Union[Unset, list[str]]): the roles that revoked from the key or user
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_role_from_user_body = cls(
            roles=roles,
            user_type=user_type,
        )

        revoke_role_from_user_body.additional_properties = d
        return revoke_role_from_user_body
