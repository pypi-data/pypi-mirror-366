...
T = TypeVar("T", bound="BatchDeleteResponseMatch")


@_attrs_define
class BatchDeleteResponseMatch:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_delete_response_match = cls(
            class_=class_,
            where=where,
        )

        batch_delete_response_match.additional_properties = d
        return batch_delete_response_match
