...
class OverpaymentIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(OverpaymentIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specified_overpayments(self,
                                                        overpayment_id,
                                                        xero_tenant_id):
        """Does a GET request to /Overpayments/{OverpaymentID}.
    ...
    def allows_you_to_create_a_single_allocation_for_an_overpayment(self,
                                                                    summarize_errors,
                                                                    overpayment_id,
                                                                    xero_tenant_id,
                                                                    body):
        """Does a PUT request to /Overpayments/{OverpaymentID}/Allocations.
        ...
        Args:
            ...
            overpayment_id (str): (Required) Unique identifier for a
                Overpayment
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToCreateASingleAllocationForAnOverpaymentRequest):
