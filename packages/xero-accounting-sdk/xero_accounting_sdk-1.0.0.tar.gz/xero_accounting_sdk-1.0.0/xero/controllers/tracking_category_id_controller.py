...
class TrackingCategoryIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(TrackingCategoryIDController, self).__init__(config)

    def allows_you_to_retrieve_tracking_categories_and_options_for_specified_category(self,
                                                                                      tracking_category_id,
                                                                                      xero_tenant_id):
        """Does a GET request to /TrackingCategories/{TrackingCategoryID}.
    ...
    def allows_you_to_update_tracking_categories(self,
                                                 tracking_category_id,
                                                 xero_tenant_id,
                                                 body):
        """Does a POST request to /TrackingCategories/{TrackingCategoryID}.

        Args:
            tracking_category_id (str): (Required) Unique identifier for a
                TrackingCategory
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateTrackingCategoriesRequest): The request
                body parameter.
    ...
    def allows_you_to_delete_tracking_categories(self,
                                                 tracking_category_id,
                                                 xero_tenant_id):
        """Does a DELETE request to /TrackingCategories/{TrackingCategoryID}.
