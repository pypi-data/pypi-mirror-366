...
class ContactGroupIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(ContactGroupIDController, self).__init__(config)

    def allows_you_to_retrieve_a_unique_contact_group_by_id(self,
                                                            contact_group_id,
                                                            xero_tenant_id):
        """Does a GET request to /ContactGroups/{ContactGroupID}.
    ...
    def allows_you_to_update_a_contact_group(self,
                                             contact_group_id,
                                             xero_tenant_id,
                                             body):
        """Does a POST request to /ContactGroups/{ContactGroupID}.

        Args:
            contact_group_id (str): (Required) Unique identifier for a Contact
                Group
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateAContactGroupRequest): The request body
                parameter.
