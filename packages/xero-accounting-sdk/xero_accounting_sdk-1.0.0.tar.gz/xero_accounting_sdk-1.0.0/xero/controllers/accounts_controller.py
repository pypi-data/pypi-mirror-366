...
class AccountsController(BaseController):
    ...
    def allows_you_to_retrieve_the_full_chart_of_accounts(self,
                                                          where,
                                                          order,
                                                          if_modified_since,
                                                          xero_tenant_id):
    ...
    def allows_you_to_create_a_new_chart_of_accounts(self,
                                                     xero_tenant_id,
                                                     body):
        """Does a PUT request to /Accounts.

        Args:
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToCreateANewChartOfAccountsRequest): The request
                body parameter.
