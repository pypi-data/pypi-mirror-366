...
class MiscController(BaseController):
    ...
    def allows_you_to_retrieve_invoice_reminder_settings(self,
                                                         xero_tenant_id):
        """Does a GET request to /InvoiceReminders/Settings.
    ...
    def allows_you_to_set_the_chart_of_accounts_the_conversion_date_and_conversion_balances(self,
                                                                                            xero_tenant_id,
                                                                                            body):
        """Does a POST request to /Setup.

        Args:
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToSetTheChartOfAccountsTheConversionDateAndConversio
                nBalancesRequest): The request body parameter.
