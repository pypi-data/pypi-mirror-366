...
class QuoteIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(QuoteIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specified_quote(self,
                                                 quote_id,
                                                 xero_tenant_id):
        """Does a GET request to /Quotes/{QuoteID}.
    ...
    def allows_you_to_update_a_specified_quote(self,
                                               quote_id,
                                               xero_tenant_id,
                                               body):
        """Does a POST request to /Quotes/{QuoteID}.

        Args:
            quote_id (str): (Required) Unique identifier for an Quote
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateASpecifiedQuoteRequest): The request body
                parameter.
    ...
    def allows_you_to_retrieve_quotes_as_pdf_files(self,
                                                   quote_id,
                                                   xero_tenant_id):
        """Does a GET request to /Quotes/{QuoteID}/pdf.
