...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._implicit_auth_credentials = self.create_auth_credentials_object(
            o_auth_client_id, o_auth_redirect_uri, o_auth_token,
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   o_auth_token=None, implicit_auth_credentials=None):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.SERVER_1: 'https://api.xero.com/api.xro/2.0',
    ...
    def create_auth_credentials_object(o_auth_client_id, o_auth_redirect_uri,
                                       o_auth_token, implicit_auth_credentials,
                                       stack_level=4):
        ...
        warnings.warn(message=('The \'o_auth_client_id\', \'o_auth_redirect_uri'
                               '\', \'o_auth_token\' params are deprecated. Use'
