...
"""
from xero.models.cells_1 import Cells1
from xero.models.row_1 import Row1


class Row2(object):

    """Implementation of the 'Row2' model.

    Attributes:
        row_type (str): The model property of type str.
        title (str): The model property of type str.
        cells (List[Cells1]): The model property of type List[Cells1].
    ...
    def __init__(self,
                 ...
                 cells=None,
                 rows=None):
        """Constructor for the Row2 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Cells') is not None:
            cells = [Cells1.from_dictionary(x) for x in dictionary.get('Cells')]
        rows = None
