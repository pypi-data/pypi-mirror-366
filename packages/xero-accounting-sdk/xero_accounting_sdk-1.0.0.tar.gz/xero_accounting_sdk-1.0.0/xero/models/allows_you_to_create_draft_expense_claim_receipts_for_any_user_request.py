...
class AllowsYouToCreateDraftExpenseClaimReceiptsForAnyUserRequest(object):

    """Implementation of the 'Allows you to create draft expense claim receipts for any user Request' model.
    ...
    def __init__(self,
                 receipts=None):
        """Constructor for the AllowsYouToCreateDraftExpenseClaimReceiptsForAnyUserRequest class"""
