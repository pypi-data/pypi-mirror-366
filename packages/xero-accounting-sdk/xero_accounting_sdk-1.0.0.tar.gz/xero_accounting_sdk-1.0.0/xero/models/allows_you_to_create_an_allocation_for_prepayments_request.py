...
class AllowsYouToCreateAnAllocationForPrepaymentsRequest(object):

    """Implementation of the 'Allows you to create an Allocation for prepayments Request' model.
    ...
    def __init__(self,
                 allocations=None):
        """Constructor for the AllowsYouToCreateAnAllocationForPrepaymentsRequest class"""
