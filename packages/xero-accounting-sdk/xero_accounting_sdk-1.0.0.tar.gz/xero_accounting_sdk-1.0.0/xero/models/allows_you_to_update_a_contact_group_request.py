...
class AllowsYouToUpdateAContactGroupRequest(object):

    """Implementation of the 'Allows you to update a Contact Group Request' model.
    ...
    def __init__(self,
                 contact_groups=None):
        """Constructor for the AllowsYouToUpdateAContactGroupRequest class"""
