...
class AllowsYouToUpdateOrCreateOneOrMorePurchaseOrdersRequest(object):

    """Implementation of the 'Allows you to update or create one or more purchase orders Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AllowsYouToUpdateOrCreateOneOrMorePurchaseOrdersRequest class"""
