...
class Overpayment(object):
    ...
    """Implementation of the 'Overpayment' model.
    ...
    Attributes:
        ...
        overpayment_id (str): The model property of type str.
    ...
    def __init__(self,
                 ...
                 payments=None,
                 attachments=None):
        """Constructor for the Overpayment class"""
    ...
    def from_dictionary(cls,
        ...
        overpayment_id = dictionary.get("OverpaymentID") if dictionary.get("OverpaymentID") else None
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'overpayment_id={self.overpayment_id!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'overpayment_id={self.overpayment_id!s}, '
