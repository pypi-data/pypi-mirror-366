...
class AllowsYouToCreateAllocationOnCreditNoteRequest(object):

    """Implementation of the 'Allows you to create Allocation on CreditNote Request' model.
    ...
    def __init__(self,
                 allocations=None):
        """Constructor for the AllowsYouToCreateAllocationOnCreditNoteRequest class"""
