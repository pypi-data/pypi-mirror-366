...
class AllowsYouToUpdateOptionsForASpecifiedTrackingCategoryRequest(object):

    """Implementation of the 'Allows you to update options for a specified tracking category Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AllowsYouToUpdateOptionsForASpecifiedTrackingCategoryRequest class"""
