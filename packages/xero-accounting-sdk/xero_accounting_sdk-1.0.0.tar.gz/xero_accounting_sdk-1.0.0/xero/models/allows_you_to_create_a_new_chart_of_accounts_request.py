...
class AllowsYouToCreateANewChartOfAccountsRequest(object):

    """Implementation of the 'Allows you to create a new chart of accounts Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AllowsYouToCreateANewChartOfAccountsRequest class"""
