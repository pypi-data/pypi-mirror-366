...
class AllowsYouToUpdateASpecifiedManualJournalRequest(object):

    """Implementation of the 'Allows you to update a specified manual journal Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AllowsYouToUpdateASpecifiedManualJournalRequest class"""
