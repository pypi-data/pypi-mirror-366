...
class ReceiptIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(ReceiptIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specified_draft_expense_claim_receipts(self,
                                                                        unitdp,
                                                                        receipt_id,
                                                                        xero_tenant_id):
        """Does a GET request to /Receipts/{ReceiptID}.
    ...
    def allows_you_to_retrieve_a_specified_draft_expense_claim_receipts_1(self,
                                                                          unitdp,
                                                                          receipt_id,
                                                                          xero_tenant_id,
                                                                          body):
        """Does a POST request to /Receipts/{ReceiptID}.
        ...
        Args:
            ...
            receipt_id (str): (Required) Unique identifier for a Receipt
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToRetrieveASpecifiedDraftExpenseClaimReceiptsRequest
