...
class PurchaseOrderIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(PurchaseOrderIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specified_purchase_orders(self,
                                                           purchase_order_id,
                                                           xero_tenant_id):
        """Does a GET request to /PurchaseOrders/{PurchaseOrderID}.
    ...
    def allows_you_to_update_a_specified_purchase_order(self,
                                                        purchase_order_id,
                                                        xero_tenant_id,
                                                        body):
        """Does a POST request to /PurchaseOrders/{PurchaseOrderID}.

        Args:
            purchase_order_id (str): (Required) Unique identifier for a
                PurchaseOrder
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateASpecifiedPurchaseOrderRequest): The
    ...
    def allows_you_to_retrieve_purchase_orders_as_pdf_files(self,
                                                            purchase_order_id,
                                                            xero_tenant_id):
        """Does a GET request to /PurchaseOrders/{PurchaseOrderID}/pdf.

        Args:
            purchase_order_id (str): (Required) Unique identifier for an
                Purchase Order
            xero_tenant_id (str): (Required) Xero identifier for Tenant
