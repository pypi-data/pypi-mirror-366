...
class PaymentIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(PaymentIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specified_payment_for_invoices_and_credit_notes(self,
                                                                                 payment_id,
                                                                                 xero_tenant_id):
        """Does a GET request to /Payments/{PaymentID}.
    ...
    def allows_you_to_update_a_specified_payment_for_invoices_and_credit_notes(self,
                                                                               payment_id,
                                                                               xero_tenant_id,
                                                                               body):
        """Does a POST request to /Payments/{PaymentID}.

        Args:
            payment_id (str): (Required) Unique identifier for a Payment
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateASpecifiedPaymentForInvoicesAndCreditNotesRe
                quest): The request body parameter.
