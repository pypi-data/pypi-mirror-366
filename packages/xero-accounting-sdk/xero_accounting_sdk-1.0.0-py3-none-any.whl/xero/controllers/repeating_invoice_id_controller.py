...
class RepeatingInvoiceIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(RepeatingInvoiceIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specified_repeating_invoice(self,
                                                             repeating_invoice_id,
                                                             xero_tenant_id):
        """Does a GET request to /RepeatingInvoices/{RepeatingInvoiceID}.
