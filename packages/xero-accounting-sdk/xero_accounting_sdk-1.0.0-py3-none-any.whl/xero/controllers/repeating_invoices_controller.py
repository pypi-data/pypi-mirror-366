...
class RepeatingInvoicesController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(RepeatingInvoicesController, self).__init__(config)

    def allows_you_to_retrieve_any_repeating_invoices(self,
                                                      where,
                                                      order,
                                                      xero_tenant_id):
        """Does a GET request to /RepeatingInvoices.
