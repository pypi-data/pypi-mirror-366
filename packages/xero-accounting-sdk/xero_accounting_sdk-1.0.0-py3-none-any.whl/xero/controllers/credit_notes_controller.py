...
class CreditNotesController(BaseController):
    ...
    def __init__(self, config):
        super(CreditNotesController, self).__init__(config)

    def allows_you_to_retrieve_any_credit_notes(self,
                                                where,
                                                order,
                                                page,
                                                unitdp,
                                                if_modified_since,
                                                xero_tenant_id):
        """Does a GET request to /CreditNotes.

        Args:
            where (str): Filter by an any element
            order (str): Order by an any element
            page (str): e.g. page=1 – Up to 100 credit notes will be returned
                in a single API call with line items shown for each credit note
    ...
    def allows_you_to_create_a_credit_note(self,
                                           summarize_errors,
                                           unitdp,
                                           xero_tenant_id,
                                           body):
        """Does a PUT request to /CreditNotes.
        ...
        Args:
            ...
            unitdp (str): e.g. unitdp=4 – (Unit Decimal Places) You can opt in
                to use four decimal places for unit amounts
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToCreateACreditNoteRequest): The request body
                parameter.
    ...
    def allows_you_to_update_or_create_one_or_more_credit_notes(self,
                                                                summarize_errors,
                                                                unitdp,
                                                                xero_tenant_id,
                                                                body):
        """Does a POST request to /CreditNotes.
        ...
        Args:
            ...
            unitdp (str): e.g. unitdp=4 – (Unit Decimal Places) You can opt in
                to use four decimal places for unit amounts
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateORCreateOneOrMoreCreditNotesRequest): The
