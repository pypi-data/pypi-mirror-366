...
class BrandingThemeIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(BrandingThemeIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specific_branding_themes(self,
                                                          branding_theme_id,
                                                          xero_tenant_id):
        """Does a GET request to /BrandingThemes/{BrandingThemeID}.
