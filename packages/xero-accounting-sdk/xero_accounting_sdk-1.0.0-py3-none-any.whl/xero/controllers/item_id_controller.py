...
class ItemIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(ItemIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specified_item(self,
                                                unitdp,
                                                item_id,
                                                xero_tenant_id):
        """Does a GET request to /Items/{ItemID}.
    ...
    def allows_you_to_update_a_specified_item(self,
                                              unitdp,
                                              item_id,
                                              xero_tenant_id,
                                              body):
        ...
        Args:
            ...
            item_id (str): (Required) Unique identifier for an Item
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateASpecifiedItemRequest): The request body
                parameter.
    ...
    def allows_you_to_delete_a_specified_item(self,
                                              item_id,
                                              xero_tenant_id):
