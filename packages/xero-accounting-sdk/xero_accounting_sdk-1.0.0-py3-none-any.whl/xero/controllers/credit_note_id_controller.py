...
class CreditNoteIDController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(CreditNoteIDController, self).__init__(config)

    def allows_you_to_retrieve_a_specific_credit_note(self,
                                                      unitdp,
                                                      credit_note_id,
                                                      xero_tenant_id):
        """Does a GET request to /CreditNotes/{CreditNoteID}.
    ...
    def allows_you_to_update_a_specific_credit_note(self,
                                                    unitdp,
                                                    credit_note_id,
                                                    xero_tenant_id,
                                                    body):
        """Does a POST request to /CreditNotes/{CreditNoteID}.
        ...
        Args:
            ...
            credit_note_id (str): (Required) Unique identifier for a Credit
                Note
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToUpdateASpecificCreditNoteRequest): The request
                body parameter.
    ...
    def allows_you_to_retrieve_credit_note_as_pdf_files(self,
                                                        credit_note_id,
                                                        xero_tenant_id):
        """Does a GET request to /CreditNotes/{CreditNoteID}/pdf.
    ...
    def allows_you_to_create_allocation_on_credit_note(self,
                                                       summarize_errors,
                                                       credit_note_id,
                                                       xero_tenant_id,
                                                       body):
        """Does a PUT request to /CreditNotes/{CreditNoteID}/Allocations.
        ...
        Args:
            ...
            credit_note_id (str): (Required) Unique identifier for a Credit
                Note
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToCreateAllocationOnCreditNoteRequest): The request
                body parameter.
