...
class BankTransfersController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(BankTransfersController, self).__init__(config)

    def allows_you_to_retrieve_all_bank_transfers(self,
                                                  where,
                                                  order,
                                                  if_modified_since,
                                                  xero_tenant_id):
        """Does a GET request to /BankTransfers.
    ...
    def allows_you_to_create_a_bank_transfers(self,
                                              xero_tenant_id,
                                              body):
        """Does a PUT request to /BankTransfers.

        Args:
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToCreateABankTransfersRequest): The request body
                parameter.
