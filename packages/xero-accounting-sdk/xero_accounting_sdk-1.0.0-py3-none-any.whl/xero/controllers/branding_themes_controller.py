...
class BrandingThemesController(BaseController):

    """A Controller to access Endpoints in the xero API."""
    def __init__(self, config):
        super(BrandingThemesController, self).__init__(config)

    def allows_you_to_retrieve_all_the_branding_themes(self,
                                                       xero_tenant_id):
        """Does a GET request to /BrandingThemes.
