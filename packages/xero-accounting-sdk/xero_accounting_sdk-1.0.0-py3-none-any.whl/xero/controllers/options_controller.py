...
class OptionsController(BaseController):
    ...
    def __init__(self, config):
        super(OptionsController, self).__init__(config)

    def allows_you_to_create_options_for_a_specified_tracking_category(self,
                                                                       tracking_category_id,
                                                                       xero_tenant_id,
                                                                       body):
        """Does a PUT request to /TrackingCategories/{TrackingCategoryID}/Options.

        Args:
            tracking_category_id (str): (Required) Unique identifier for a
                TrackingCategory
            xero_tenant_id (str): (Required) Xero identifier for Tenant
            body (AllowsYouToCreateOptionsForASpecifiedTrackingCategoryRequest)
