...
class AllowsYouToCreateOptionsForASpecifiedTrackingCategoryRequest(object):

    """Implementation of the 'Allows you to create options for a specified tracking category Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AllowsYouToCreateOptionsForASpecifiedTrackingCategoryRequest class"""
