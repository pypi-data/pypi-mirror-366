...
class AllowsYouToCreateOneOrMoreManualJournalsRequest(object):

    """Implementation of the 'Allows you to create one or more manual journals Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AllowsYouToCreateOneOrMoreManualJournalsRequest class"""
