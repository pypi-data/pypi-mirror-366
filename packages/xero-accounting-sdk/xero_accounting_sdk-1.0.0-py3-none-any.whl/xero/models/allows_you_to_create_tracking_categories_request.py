...
class AllowsYouToCreateTrackingCategoriesRequest(object):

    """Implementation of the 'Allows you to create tracking categories Request' model.
    ...
    def __init__(self,
                 ...
                 status=None,
                 options=None):
        """Constructor for the AllowsYouToCreateTrackingCategoriesRequest class"""
