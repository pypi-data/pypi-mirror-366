...
class AllowsYouToCreateOneOrMorePurchaseOrdersRequest(object):

    """Implementation of the 'Allows you to create one or more purchase orders Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AllowsYouToCreateOneOrMorePurchaseOrdersRequest class"""
