...
class APIClient:
    ...
    def parse_and_register_project_number(self, project_path: str) -> Tuple[
    ...
    def log_launch_to_db(self, host_id: str, project_uuid: str, project_path: str, uuid_file_path: str,
                         ...
                         host_uuid_path: str, host_uuid_content: str, host_info: Dict[str, str]) -> Tuple[
        bool, int, Optional[str], Optional[int]]:
        """记录启动日志"""
        try:
            readme_content = self._read_readme_content(project_path)
            data = {
