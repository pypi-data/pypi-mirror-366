#!/usr/bin/env python3
"""
Working Test for Query Optimization System

This test properly tests the query optimization features with a working setup.
"""
...
async def test_query_optimization_working():
    """Test the query optimization system with a working setup."""
    print("🚀 Working Query Optimization Test")
    print("=" * 40)
    
    # Test 1: Query Analyzer - Direct Testing
    ...
    try:
        ...
        print("✅ Complex query analysis test completed")
        
    except Exception as e:
        print(f"   ❌ Complex query analysis test failed: {str(e)}")
        import traceback
        traceback.print_exc()
    ...
    try:
        ...
        report_filename = f"performance_report_working_{uuid.uuid4().hex[:8]}.json"
...
if __name__ == "__main__":
    asyncio.run(test_query_optimization_working()) 