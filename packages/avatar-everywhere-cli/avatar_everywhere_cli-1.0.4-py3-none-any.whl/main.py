...
def show_quick_start():
    ...
    quick_start_text.append("   avatar-everywhere verify --contract 0x... --token 123\n")
    quick_start_text.append("\n")
    quick_start_text.append("2. Convert Avatar:\n", style="bold green")
    quick_start_text.append("   avatar-everywhere convert avatar.glb --output avatar.vrm\n")
    quick_start_text.append("\n")
    quick_start_text.append("3. Get File Info:\n", style="bold green")
    quick_start_text.append("   avatar-everywhere info avatar.glb\n")
    quick_start_text.append("\n")
    quick_start_text.append("4. Check Requirements:\n", style="bold green")
    quick_start_text.append("   avatar-everywhere list-requirements\n")
    console.print(Panel(
        quick_start_text,
...
def main():
    ...
    try:
        ...
        console.print("\n[dim]For help, run: avatar-everywhere --help[/dim]")
