...
class Subscription(BaseModel):
    ...
    last_bill_date: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["active", "allow_tax", "auto_charge", "billing_amount", "billing_cycle", "billing_frequency", "contact_id", "end_date", "id", "last_bill_date", "merchant_account_id", "next_bill_date", "payment_method_id", "product_id", "quantity", "sale_affiliate_id", "start_date", "subscription_plan_id"]
