...
class UpdateSubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active", "allow_tax", "auto_charge", "billing_amount", "billing_cycle", "billing_frequency", "contact_id", "days_between_retries", "end_date", "lead_affiliate_id", "max_charge_attempts", "next_bill_date", "payment_method_id", "product_id", "quantity", "sale_affiliate_id", "shipping_address", "subscription_plan_id"]
