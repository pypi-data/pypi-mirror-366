...
class CreateSubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allow_duplicate", "allow_tax", "auto_charge", "billing_amount", "contact_id", "payment_method_id", "quantity", "sale_affiliate_id", "start_date", "subscription_plan_id"]
