...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '50c'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', '8be'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', '8c0'),
            routes: [
              {
