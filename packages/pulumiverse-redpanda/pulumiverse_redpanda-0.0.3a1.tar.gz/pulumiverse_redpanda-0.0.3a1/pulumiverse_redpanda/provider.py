...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] client_id: The id for the client. You need client_id AND client_secret to use this provider
        :param pulumi.Input[str] client_secret: Redpanda client secret. You need client_id AND client_secret to use this provider
        """
