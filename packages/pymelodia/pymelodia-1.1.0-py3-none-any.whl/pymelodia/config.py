...
class Config:
    ...
    DEFAULT_MAX_THREADS = 4  # 默认4个线程
    DEFAULT_ENABLE_MULTITHREADING = True  # 默认启用多线程
    ...
    def _load_defaults(self):
        ...
        self.enable_multithreading = self.DEFAULT_ENABLE_MULTITHREADING
    ...
    def _load_environment(self):
        ...
        env_mapping = {
            ...
            'MD_MAX_THREADS': ('max_threads', int),
            'MD_ENABLE_MULTITHREADING': ('enable_multithreading', lambda x: x.lower() == 'true'),
        }
