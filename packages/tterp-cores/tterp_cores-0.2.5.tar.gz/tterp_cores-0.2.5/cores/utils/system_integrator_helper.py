...
class SystemIntegratorJWTService:
    ...
    def validate_access_token(
        ...
        try:
            ...
            raise InvalidClientError(f"Invalid access token: {str(e)}") from e
    ...
    def validate_system_user_token(cls, token: str) -> SystemUserTokenPayload:
        ...
        try:
            ...
            raise TokenExpiredError("System user token has expired") from e
        except jwt.InvalidTokenError as e:
            raise InvalidClientError(f"Invalid system user token: {str(e)}") from e
