...
class ComputerAgent:
    ...
    def send_prompt(self, prompt: str):
        ...
        while True:
            ...
            self._handle_model_action(action)
    ...
    # --- Internal helpers (user can override for custom environments) ---

    def _handle_model_action(self, action):
        # Import here to avoid hard dependency if user overrides
        from cua_docker.cua_docker_actions import handle_model_action
        handle_model_action(action, self._vm)

    def _get_screenshot(self):
        from cua_docker.cua_docker_actions import get_screenshot
        return get_screenshot(self._vm)
