...
def generate_boltz_structure_path(input_path):
    base_path = Path(input_path)                 # e.g., /some/path/boltz/P12345
    base_name = base_path.name                   # e.g., P12345
    return base_path / f"boltz_results_{base_name}" / "predictions" / base_name / f"{base_name}_model_0.cif"
