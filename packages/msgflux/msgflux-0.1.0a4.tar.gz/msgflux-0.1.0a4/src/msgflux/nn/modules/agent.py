...
class Agent(Module):
        ...
        *,
        ...
        task_multimodal_inputs:
            ...
            !!! example
                ...
                task_multimodal_inputs={"audio": "audio.user"} # single audio
                task_multimodal_inputs={"image": ["images.user", "image.mask"]} # multi image
        task_messages:
    ...
    def inspect_model_execution_params(self, *args, **kwargs) -> Mapping[str, Any]:
        ...
        model_execution_params = self._prepare_model_execution(prefilling=self.prefilling, **inputs)
        return model_execution_params
