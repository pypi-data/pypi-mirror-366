...
class Configuration(HttpClientConfiguration):
    ...
    def x_rapidapi_key(self):
        return self._custom_header_authentication_credentials.x_rapidapi_key
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._custom_header_authentication_credentials = self.create_auth_credentials_object(
            x_rapidapi_key, custom_header_authentication_credentials)
    ...
    @staticmethod
    def create_auth_credentials_object(x_rapidapi_key,
                                       custom_header_authentication_credentials,
                                       stack_level=4):
        if x_rapidapi_key is None:
            return custom_header_authentication_credentials

        warnings.warn(message=('The \'x_rapidapi_key\' params are deprecated. U'
                               'se \'custom_header_authentication_credentials\''
                               ' param instead.'),
        ...
        return CustomHeaderAuthenticationCredentials(x_rapidapi_key)
