...
class DistanceResponse(object):
    ...
    """Implementation of the 'Distance Response' model.

    A decimal distance (in miles or kilometers)

    Attributes:
        errors (List[Error]): The model property of type List[Error].
        data (float): The distance in units as set by the distanceUnit param
            (defaults to miles)
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the DistanceResponse class"""
