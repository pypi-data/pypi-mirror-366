...
from geodbcitiesapi.models.language import Language
...
class LanguagesResponse(object):
    ...
    """Implementation of the 'Languages Response' model.
    ...
    Attributes:
        ...
        metadata (Metadata): Result metadata (currently only associated with
            collection results)
        data (List[Language]): The model property of type List[Language].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the LanguagesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Language.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
