...
from geodbcitiesapi.models.country_region_summary import CountryRegionSummary
...
class CountryRegionsResponse(object):

    """Implementation of the 'Country Regions Response' model.
    ...
    Attributes:
        ...
        metadata (Metadata): Result metadata (currently only associated with
            collection results)
        data (List[CountryRegionSummary]): A list of RegionSummaries
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the CountryRegionsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [CountryRegionSummary.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
