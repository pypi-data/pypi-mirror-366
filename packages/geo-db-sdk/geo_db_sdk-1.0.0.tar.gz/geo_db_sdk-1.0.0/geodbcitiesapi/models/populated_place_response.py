...
from geodbcitiesapi.models.populated_place_details import PopulatedPlaceDetails


class PopulatedPlaceResponse(object):

    """Implementation of the 'Populated-Place Response' model.
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the PopulatedPlaceResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('errors') is not None:
            ...
            errors = APIHelper.SKIP
        data = PopulatedPlaceDetails.from_dictionary(dictionary.get('data')) if 'data' in dictionary.keys() else APIHelper.SKIP
