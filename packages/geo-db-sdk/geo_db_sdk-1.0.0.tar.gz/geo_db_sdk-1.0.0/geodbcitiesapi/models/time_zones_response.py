...
from geodbcitiesapi.models.time_zone import TimeZone


class TimeZonesResponse(object):

    """Implementation of the 'Time-Zones Response' model.
    ...
    Attributes:
        ...
        metadata (Metadata): Result metadata (currently only associated with
            collection results)
        data (List[TimeZone]): The model property of type List[TimeZone].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the TimeZonesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [TimeZone.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
