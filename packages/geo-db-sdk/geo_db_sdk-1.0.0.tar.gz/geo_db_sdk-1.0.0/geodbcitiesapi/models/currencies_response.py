...
from geodbcitiesapi.models.currency import Currency
...
class CurrenciesResponse(object):
    ...
    """Implementation of the 'Currencies Response' model.
    ...
    Attributes:
        ...
        metadata (Metadata): Result metadata (currently only associated with
            collection results)
        data (List[Currency]): The model property of type List[Currency].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the CurrenciesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Currency.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
