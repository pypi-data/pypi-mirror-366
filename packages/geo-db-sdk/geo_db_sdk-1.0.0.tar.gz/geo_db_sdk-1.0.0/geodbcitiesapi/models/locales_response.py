...
from geodbcitiesapi.models.locale import Locale
from geodbcitiesapi.models.metadata import Metadata


class LocalesResponse(object):

    """Implementation of the 'Locales Response' model.
    ...
    Attributes:
        ...
        metadata (Metadata): Result metadata (currently only associated with
            collection results)
        data (List[Locale]): The model property of type List[Locale].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the LocalesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Locale.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
