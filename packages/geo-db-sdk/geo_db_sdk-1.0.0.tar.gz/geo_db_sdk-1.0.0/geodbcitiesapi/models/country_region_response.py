...
from geodbcitiesapi.models.country_region_details import CountryRegionDetails
from geodbcitiesapi.models.error import Error


class CountryRegionResponse(object):

    """Implementation of the 'Country Region Response' model.

    Country region details response

    Attributes:
        errors (List[Error]): The model property of type List[Error].
        data (CountryRegionDetails): Full country region details
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the CountryRegionResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('errors') is not None:
            ...
            errors = APIHelper.SKIP
        data = CountryRegionDetails.from_dictionary(dictionary.get('data')) if 'data' in dictionary.keys() else APIHelper.SKIP
