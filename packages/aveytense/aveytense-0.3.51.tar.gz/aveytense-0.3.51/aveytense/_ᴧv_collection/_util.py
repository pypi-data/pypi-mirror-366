...
class _BuiltinParamVar:
    ...
    def __init__(self, f):
        ...
        if _unsanitized_signature_ is not None and type(_unsanitized_signature_) is str:
            ...
            _signature_ = _unsanitized_signature_.removeprefix(_revoke_first_).removeprefix("/, ").replace("\n" + _SPACES_, "")
            _signature2_ = _signature_.removesuffix(")").split(", ")
...
class ParamVar:
    ...
    *Constructor general information* \\
    ...
    def __init__(self, f: __.Callable[..., __.Any], i = 0, /): # 0.3.42
        ...
        elif _overloads_ is not None and _reckon(__.get_overloads(f)) > 0:
