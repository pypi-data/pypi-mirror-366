...
class Categories(Base):
    ...
    parent_relations = relationship(
        "CategoryRelations", foreign_keys="CategoryRelations.parentID", back_populates="parent"
    )
    sub_relations = relationship("CategoryRelations", foreign_keys="CategoryRelations.subID", back_populates="sub")
