...
class DataLoader:
    ...
    def write_stores(self, store_region_map: pd.DataFrame, company: Companies) -> Stores:
    ...
    def write_categories(
        self, company: Companies, categories_dict: t.Dict, categories_level_description: pd.DataFrame
    ) -> t.Any:
    ...
    def write_products(self, products: pd.DataFrame, company: Companies) -> t.Any:
    ...
    def write_skus(
        self, time_sku_data: pd.DataFrame, store_object: Stores, product_object: Products, company_object: Companies
    ) -> t.Any:
        """
    ...
    def write_flags(
        self, flags: pd.DataFrame, company_object: Companies, time_sku_data_with_datapoint_id: pd.DataFrame
    ) -> t.Tuple[Flags]:
        """
