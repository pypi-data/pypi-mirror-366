...
Но пользователь может дополнить список промтами, правилами и контекстом в чате.
...
async def run_stdio():
    ...
    print("   2. get_product_list - список всех SKU товаров")
    print("   3. get_statistics - статистика по обработанным товарам")
    print("   4. save_product_prices - сохранение найденных цен в БД")
    print("   5. check_license_status - проверка статуса лицензии")
    print("   6. set_license_key - установка нового лицензионного ключа")
