...
def detect_project_root() -> Path:
    """
    Returns the hidden .syntaxmatrix folder under the project root,
    creating it if necessary.  All framework data & uploads live here.
    """
    proj_root = scandir()
    fw_root = proj_root / ".syntaxmatrix"
