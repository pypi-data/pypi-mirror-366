...
from a2a_openai_agents import A2ASkillConfig, A2AWrapper
...
class TestIntegration:
    ...
    def test_end_to_end_wrapper_creation(self):
        ...
        # Create wrapper
        wrapper = A2AWrapper(openai_agent=mock_agent, a2a_description="Integration test agent")
    ...
    async def test_task_management_workflow(self):
        ...
        test_task = Task(
            id=task_id, context_id="test-context", status=TaskStatus(state="working", message=None)
        )
        ...
        await wrapper.handle_a2a_task_update(
            task_id, "completed", "Task finished successfully", {"output": "processed result"}
        )
    ...
    def test_multiple_skills_configuration(self):
        ...
        skills = [
            A2ASkillConfig(name="skill_one", description="First skill", handler=skill1_handler),
            A2ASkillConfig(name="skill_two", description="Second skill", handler=skill2_handler),
        ]
    ...
    def test_agent_with_tools_and_custom_skills_mixed(self):
        ...
        custom_skill = A2ASkillConfig(
            name="custom_skill", description="Custom skill", handler=custom_handler
        )
    ...
    def test_wrapper_app_consistency(self):
        ...
        wrapper.a2a_skills = [
            A2ASkillConfig(name="test_skill", description="Test skill", handler=test_handler)
        ]
