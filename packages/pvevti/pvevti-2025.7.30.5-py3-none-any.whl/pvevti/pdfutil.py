        ...
        # Conditions and Route
        {
            ...
            "plots": [
                ...
                },
                {
                    ...
                    "plotType": "table",
                    "yData":    ["amb_t", "cab_breath_l_air_t", "cab_breath_r_air_t", "ac_on"]
                }
            ]
        },
...
default_electrical_pdf_config = {
    "docTitle": "Default Electrical Report",
        ...
        # Conditions and Route
        {
            ...
            "plots": [
                ...
                },
                {
                    "plotTitle":"Signals Overview",
                    "plotType": "table",
                    "yData":    ["amb_t", "amb_p", "bat_s_volt", "bat_l_volt", "alt_volt"]
                }
            ]
        },
        {
...
default_cooling_pdf_config = {
    "docTitle": "Default Cooling Report",
        ...
        # Conditions and Route
        {
            ...
            "plots": [
                ...
                },
                {
                    "plotTitle":"Signals Overview",
                    "plotType": "table",
                    "yData":    ["amb_t", "amb_p", "cti", "cto", "EngCoolantTemp", "CoolTemp_Cval_PT"]
                }
            ]
        },
        {
            ...
            "plots": [
                ...
                },
                {
                    ...
                    "plotType": "table",
                    "yData":    ["EngRPM_Cval_CPC3", "EngTrq_Cval_PT", "EngPctLoadAtCurrSpeed_Cval", "EngFuelTemp1", "EngAirIntakeTemp", "EngOilTemp1"]
                }
            ]
        },
        {
            ...
            "plots": [
                ...
                },
                {
                    "plotTitle":"Metrics Review",
                    "plotType": "table",
                    "yData":    ["fan_engagement_rate", "fan_fan_speed", "fan_drive", "fan_status_mcm", "Fan_Rq_PT", "fan_temp_error_coolant", "fan_temp_cntrl_i_inc_term_cool", "fan_temp_cntrl_p_term_cool"]
                }
            ]
        },
        {
...
default_powersteering_pdf_config = {
    "docTitle": "Default Power Steering Report",
        ...
        # Conditions and Route
        {
            ...
            "plots": [
                ...
                },
                {
                    "plotTitle":"Signals Overview",
                    "plotType": "table",
                    "yData":    ["amb_t", "amb_p", "STEER_RES_PSFLD_T", "SteerWheelAngle", "STR_RELAY_AIR_T", "StwAngl_Cval"]
                }
            ]
        },
        # Reservoir Data
