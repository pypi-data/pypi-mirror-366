...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('fig', 'atol', 'clear_output', 'tol', 'plotrates', 'its', '_final_residual', 'callback', 'printrates', 'sol', 'ax', 'callback_sol', 'plt', 'pre', 'ress', 'residuals', 'display', 'maxiter', 'iterations', 'mat')
