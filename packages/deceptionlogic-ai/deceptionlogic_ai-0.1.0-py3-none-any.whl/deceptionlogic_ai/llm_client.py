...
def load_env_vars(client: ModelClient):
    from deceptionlogic_ai.configuration import load_config
    from deceptionlogic_ai.utils import setup_mcp_client
    import os
...
@app.command(
    help="Chat with an LLM. To exit, type exit, quit, q, or kill into the terminal."
)
def chat(
