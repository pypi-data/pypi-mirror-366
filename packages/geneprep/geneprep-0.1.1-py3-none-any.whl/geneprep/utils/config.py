# add suport for override 20250627
import argparse
...
def setup_arg_parser():
    ...
    parser.add_argument("--api_key", type=str, default=None, help="Override the API key (optional)")
    parser.add_argument("--organization", type=str, default=None, help="Override the organization (optional)")
