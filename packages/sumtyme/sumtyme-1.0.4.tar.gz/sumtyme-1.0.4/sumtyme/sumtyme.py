...
def read_api_key(file_path):
    ...
    try:
        ...
        print("Error: The file content is not in the format.")
...
client = EIPClient(subdomain='london',apikey_path='api_key.txt')


entire_model = client.model_timeseries_environment(
    data_input='^DJI_max_1d.csv',
    interval=1,
    interval_unit='days',
