...
class OrganizationsName(object):

    """Implementation of the 'organizations_name' model.

    Attributes:
        value (str): A string with a length of at least 3.  Only lowercase
    ...
    def __init__(self,
        ...
        """Constructor for the OrganizationsName class"""
