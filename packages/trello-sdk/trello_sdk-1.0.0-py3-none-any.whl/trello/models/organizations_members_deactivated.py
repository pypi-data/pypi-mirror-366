...
class OrganizationsMembersDeactivated(object):

    """Implementation of the 'organizations_members_deactivated' model.
    ...
    def __init__(self,
        ...
        """Constructor for the OrganizationsMembersDeactivated class"""
