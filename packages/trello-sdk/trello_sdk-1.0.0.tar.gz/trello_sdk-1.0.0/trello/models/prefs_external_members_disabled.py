...
class PrefsExternalMembersDisabled(object):

    """Implementation of the 'prefs_externalMembersDisabled' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PrefsExternalMembersDisabled class"""
