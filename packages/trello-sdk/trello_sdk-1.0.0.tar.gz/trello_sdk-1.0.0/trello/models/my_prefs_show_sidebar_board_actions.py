...
class MyPrefsShowSidebarBoardActions(object):

    """Implementation of the 'myPrefs_showSidebarBoardActions' model.
    ...
    def __init__(self,
        ...
        """Constructor for the MyPrefsShowSidebarBoardActions class"""
