...
class LspEndpoint(threading.Thread):
    ...
    def call_method(self, method_name: str, **kwargs) -> Any:
        log_pylspclient_action("Calling method", method_name=method_name, kwargs=kwargs)
    ...
    def send_notification(self, method_name, **kwargs):
        ...
        """
        log_pylspclient_action("Sending notification to LSP Server", method_name=method_name, kwargs=kwargs)
