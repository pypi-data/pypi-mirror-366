...
pip install sagemaker_gen_ai_jupyterlab_extension-1.0.4.tar.gz
...
2. Upload the `sagemaker_gen_ai_jupyterlab_extension-1.0.4.tar.gz` in the MD workspace
3. Run `pip install sagemaker_gen_ai_jupyterlab_extension-1.0.4.tar.gz` in a terminal
