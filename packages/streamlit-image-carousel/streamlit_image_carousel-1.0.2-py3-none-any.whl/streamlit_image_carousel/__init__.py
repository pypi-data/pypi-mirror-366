...
from .config import (
    DEV_MODE, DEV_URL, COMPONENT_NAME,
    DEFAULT_MAX_VISIBLE, DEFAULT_ORIENTATION, DEFAULT_BACKGROUND_COLOR,
    DEFAULT_ACTIVE_BORDER_COLOR, DEFAULT_ACTIVE_GLOW_COLOR,
    DEFAULT_FALLBACK_BACKGROUND, DEFAULT_FALLBACK_GRADIENT_END,
    DEFAULT_TEXT_COLOR, DEFAULT_ARROW_COLOR
)
...
def image_carousel(
    ...
    active_border_color: str = DEFAULT_ACTIVE_BORDER_COLOR,
    active_glow_color: str = DEFAULT_ACTIVE_GLOW_COLOR,
    fallback_background: str = DEFAULT_FALLBACK_BACKGROUND,
    fallback_gradient_end: str = DEFAULT_FALLBACK_GRADIENT_END,
