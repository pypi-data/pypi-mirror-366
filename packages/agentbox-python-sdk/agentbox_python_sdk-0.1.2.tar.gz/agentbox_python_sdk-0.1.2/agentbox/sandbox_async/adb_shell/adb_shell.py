...
class ADBShell:
    ...
    async def connect(self):
        ...
        await _retry_async(self._start_ssh_forward, max_retries=5, delay=1, name="SSH forward")
        await _retry_async(self._adb_connect, max_retries=10, delay=1, name="adb connect")
        await _retry_async(self._adb_auth, max_retries=10, delay=1, name="adb auth")
