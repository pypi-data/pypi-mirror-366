...
def teamerror():
    ...
    def script006():
        ...
        def bs4():
            ...
            # Get input file - default to current directory if no path specified
            input_file = input("Enter path to links file (or just filename if in current directory): ").strip()
            
            # If no directory specified, look in current working directory
            ...
            output_dir = os.path.join(os.path.dirname(os.path.abspath(input_file)), "proxy_configs")
            os.makedirs(output_dir, exist_ok=True)
