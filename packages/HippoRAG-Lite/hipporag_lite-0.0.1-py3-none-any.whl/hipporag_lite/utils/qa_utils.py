...
from ..llm.request_llm import SiliconFlowLLM
...
def reason_step(dataset, prompt_template_manager: PromptTemplateManager, query: str, passages: list, thoughts: list, llm_client: SiliconFlowLLM):
    """
