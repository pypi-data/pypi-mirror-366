...
MESH_DOMAIN = "firmer.tech"
LOCAL_MDC = "XX00000000000000"
...
class URN:
    ...
    create.tenant.omega . 0001 . json . http2 . lx000001 . firmer.tech
    -------------------   ----   ----   -----   --------   -----------
    ...
    def match_node(self, mdc: str) -> bool:
        return self.mdc.lower() == mdc.lower()

    def string(self):
        urn = self.as_array(self.name)
        urn.reverse()
        urn.append(self.flag.string())
        urn.append(self.mdc.lower())
    ...
    def loc_urn(name: str) -> str:
        return URN.any_urn(name, LOCAL_MDC)

    @staticmethod
    def any_urn(name: str, mdc: str) -> str:
        urn = URN()
