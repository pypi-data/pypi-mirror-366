"""
car damage Monitoring Use Case for Post-Processing

This module provides car damage monitoring functionality ,
...
class CarDamageConfig(BaseConfig):
    ...
    usecase_categories: List[str] = field(
        default_factory=lambda: ['car damage']
    )
...
class CarDamageDetectionUseCase(BaseProcessor):
    ...
    def __init__(self):
        ...
        self.target_categories = ["car damage"]
        ...
        if config.enable_smoothing:
            if self.smoothing_tracker is None:
                smoothing_config = BBoxSmoothingConfig(
                    ...
                    confidence_threshold=config.confidence_threshold,  # Use car damage threshold as default
    ...
    def _generate_events(self, counting_summary: Dict, alerts: List, config: CarDamageConfig,
        ...
        if total_detections > 0:
            ...
            event = {
                ...
                "application_name": "car damage detection System",
