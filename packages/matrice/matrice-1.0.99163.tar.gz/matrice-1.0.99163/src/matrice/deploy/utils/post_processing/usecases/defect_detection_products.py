...
class BottleDefectUseCase(BaseProcessor):
    ...
    def _extract_predictions(self, detections: list) -> List[Dict[str, Any]]:
        ...
        # for res in results:
        #     if isinstance(res["bounding_box"], dict):
        #         # Ensure bounding box is in the expected format
        #         res["bounding_box"] = [
        #             res["bounding_box"].get("xmin", 0),
        #             res["bounding_box"].get("ymin", 0),
        #             res["bounding_box"].get("xmax", 0),
        #             res["bounding_box"].get("ymax", 0)
        #         ]
        #     elif isinstance(res["bounding_box"], list):
        #         # Ensure bounding box is a list of four elements
        #         res["bounding_box"] = res["bounding_box"][:4] if len(res["bounding_box"]) >= 4 else [0, 0, 0, 0]
        # print("--------------------detections-------------------------")
        # print(type(results[0]["bounding_box"]))
        # print(results[0]["bounding_box"])
        # print("--------------------mask-------------------------")
        # print(type(results[0]["mask"]))
