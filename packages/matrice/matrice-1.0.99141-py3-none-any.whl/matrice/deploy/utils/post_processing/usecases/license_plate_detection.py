...
class LicensePlateConfig(BaseConfig):
    """Configuration for license plate detection use case in  monitoring."""
...
class LicensePlateUseCase(BaseProcessor):
    ...
    def _generate_events(self, counting_summary: Dict, alerts: List, config: LicensePlateConfig,
        ...
        if total_detections > 0:
            ...
            event = {
                ...
                "application_name": "license_plate detection System",
