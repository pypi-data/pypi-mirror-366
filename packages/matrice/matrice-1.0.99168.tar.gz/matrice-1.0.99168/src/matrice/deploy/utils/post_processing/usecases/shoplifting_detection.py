...
class ShopliftingDetectionUseCase(BaseProcessor):
    ...
    def _generate_events(self, counting_summary: Dict, alerts: List, config: ShopliftingDetectionConfig,
        ...
        if total_detections > 0:
            ...
            event = {
                ...
                "application_name": "shoplifting detection System",
    ...
    def _generate_insights(self, summary: dict, config: ShopliftingDetectionConfig) -> List[str]:
        """
    ...
    def _check_alerts(self, summary: dict, config: ShopliftingDetectionConfig) -> List[Dict]:
        """
