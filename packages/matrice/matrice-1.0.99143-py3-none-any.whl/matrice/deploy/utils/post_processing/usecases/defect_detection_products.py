...
class BottleDefectConfig(BaseConfig):
    """Configuration for shoplifting detection use case in bottle defect monitoring."""
    ...
    usecase_categories: List[str] = field(
        default_factory=lambda: ['caps', 'HDPE', 'PET']
    )
...
class BottleDefectUseCase(BaseProcessor):
    ...
    def __init__(self):
        ...
        self.target_categories = ["caps", "HDPE", "PET"]
        ...
        if config.enable_smoothing:
            if self.smoothing_tracker is None:
                smoothing_config = BBoxSmoothingConfig(
                    ...
                    confidence_threshold=config.confidence_threshold,  # Use shoplifting threshold as default
    ...
    def _generate_events(self, counting_summary: Dict, alerts: List, config: BottleDefectConfig,
        ...
        if total_detections > 0:
            ...
            event = {
                "type": "defect_detection_products",
                ...
                "application_name": "Product defect detection System",
    ...
    def _generate_insights(self, summary: dict, config: BottleDefectConfig) -> List[str]:
        """
    ...
    def _check_alerts(self, summary: dict, config: BottleDefectConfig) -> List[Dict]:
        """
