...
def get_test_pdf_path():
    ...
    possible_paths = [
        ...
        project_root / "bad-pdfs/submissions/K046682-111320-OPA-LEA-Database-Install_1-Requestor-Copy---sample.pdf",
    ]
...
def test_page_specific_exclusions_preserved_in_slices():
    ...
    assert len(direct_exclusions) == len(sliced_exclusions), \
...
def test_pdf_and_page_exclusions_in_slices():
    ...
    page0 = pdf[0]
    page0.add_exclusion(page0.region(0, page0.height - 50, page0.width, page0.height), label="page0-footer")
