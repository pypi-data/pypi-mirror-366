...
from wallaroo.engine_config import Acceleration, Architecture, InvalidAccelerationError, QaicConfig
...
class TestPipelineVersion:
    ...
    @responses.activate
    def test_validate_acceleration_with_config(self):
        add_get_model_by_id_responder(
            api_endpoint=self.test_client.api_endpoint,
        ...
        assert expected_qaic_config == new_dc["engineAux"]["images"]["test-model-1"].get("accel")
