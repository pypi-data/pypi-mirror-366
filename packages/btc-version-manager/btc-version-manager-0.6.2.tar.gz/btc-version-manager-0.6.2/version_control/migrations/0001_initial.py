    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "relation_tree",
                    django.contrib.postgres.fields.jsonb.JSONField(null=True, verbose_name="Дерево отношений"),
                ),
                (
                    "tree_last_update",
                    models.DateTimeField(null=True, verbose_name="Последнее обновление дерева отношений"),
                ),
                (
                    "content_type",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "change_url",
                    models.TextField(null=True, verbose_name="URL создания версии"),
                ),
                (
                    "change_app",
                    models.TextField(null=True, verbose_name="APP создания версии"),
                ),
                ("created", models.DateTimeField(verbose_name="Дата и время версии")),
                (
                    "request_key",
                    models.UUIDField(null=True, verbose_name="Уникальный ключ request"),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="version_control.ModelObjectVersionGroup",
