...
class Test_Scalar_sin(unittest.TestCase):
    ...
    def runTest(self):
        ...
        self.assertEqual(random.sin(), random.sin())        # unit should be OK
        ...
        self.assertEqual(angle.sin(), np.sin(angle.values)) # unit should be OK

        # Units should be removed
        values = np.random.randn(10)
        random = Scalar(values, unit=Unit.DEG)
        self.assertTrue(random.sin().unit_ is None)
