...
class Test_Scalar_misc(unittest.TestCase):
    ...
    def runTest(self):
        ...
        self.assertRaises(ValueError, ints.__truediv__, (4,5))
        ...
        self.assertRaises(ValueError, ints.__truediv__, Scalar((4,5)))
        ...
        self.assertRaises(TypeError, ints.__itruediv__, (4,5))
        self.assertRaises(TypeError, ints.__itruediv__, Scalar((4,5)))
        ...
        self.assertRaises(ValueError, floats.__itruediv__, (4,5))
        ...
        self.assertRaises(ValueError, floats.__itruediv__, Scalar((4,5)))
        ...
        cm = cm.into_unit()
        EPS = 1.e-15
        self.assertTrue(np.all(np.abs(km.values - cm/1.e5) < 1.e5*EPS))

        self.assertRaises(ValueError, km.set_unit, Unit.SECONDS)
