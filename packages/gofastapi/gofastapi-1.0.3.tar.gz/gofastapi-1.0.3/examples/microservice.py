...
user_app = GoFastAPI(
    ...
    version="1.0.2",
    description="User management microservice with GoFastAPI - 25x faster than FastAPI"
)

# Product Service (Port 8004)
product_app = GoFastAPI(
    title="Product Microservice", 
    version="1.0.2",
    description="Product catalog microservice with GoFastAPI"
)
...
order_app = GoFastAPI(
    ...
    version="1.0.2", 
    description="Order processing microservice with GoFastAPI"
)
