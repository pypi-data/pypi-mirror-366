...
- **Current phase likely**: {"Red" if (context.get("test_results") or {}).get("failures") or (context.get("test_results") or {}).get("collection_errors") or (context.get("test_results") or {}).get("errors", 0) > 0 else "Green/Refactor"}
