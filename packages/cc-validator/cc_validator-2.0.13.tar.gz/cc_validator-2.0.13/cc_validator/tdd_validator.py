    ...
    async def execute_tdd_validation(
        ...
        try:
            ...
            if "error" not in result:
                ...
                # Detect cross-language suggestions based on current file
                if affected_files and affected_files[0]:
                    file_ext = os.path.splitext(affected_files[0])[1].lower()

                    # Add language-specific patterns to block based on file type
                    if file_ext == ".py":
                        # Block Java patterns in Python files
                        java_patterns = [
                            ".java",
                            "@Test",
                            "@Before",
                        ...
                        specific_hallucination_patterns.extend(java_patterns)
                    elif file_ext in [".js", ".ts"]:
                        # Block Java/Python patterns in JavaScript/TypeScript files
                        non_js_patterns = [
                            ".java",
                            "@Test",
                            "assertEquals",
                        ...
                        specific_hallucination_patterns.extend(non_js_patterns)
                    elif file_ext == ".go":
                        # Block non-Go patterns in Go files
                        non_go_patterns = [
                            ".java",
                            "@Test",
                            "assertEquals",
                        ...
                        specific_hallucination_patterns.extend(non_go_patterns)
