...
class FileModel(BaseModel):
    ...
    def name(self) -> str:
        """The file name."""
        return self._data.get("fileName", self._data.get("name", ""))

    @property
    def original_name(self) -> Optional[str]:
        """The original filename when uploaded."""
        return self._data.get("originalName", self._data.get("fileName"))
    ...
    def status(self) -> str:
        ...
        return self._data.get("status", self._data.get("uploadStatus", "unknown"))
