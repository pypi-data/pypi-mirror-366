...
class ReversalPatternProperties(ChartPatternProperties):
    ...
    # minimum volume difference percentage between peaks or troughs
    min_volume_diff_pct: float = 0.1
...
class ReversalPattern(ChartPattern):
    ...
    def volume_exceeds(self, volume1: float, volume2: float, properties: ReversalPatternProperties) -> bool:
        return (volume1 - volume2) / volume2 >= properties.min_volume_diff_pct
    ...
    def check_volumes_3_tops(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[1].point.volume, self.pivots[-2].point.volume, properties) and \
            self.volume_exceeds(self.pivots[3].point.volume, self.pivots[-2].point.volume, properties)

    def check_volumes_3_bottoms(self, properties: ReversalPatternProperties) -> bool:
        # right peak should have larger volumes than left peak
        # third trough should have lighter volume than the right peak
        return self.volume_exceeds(self.pivots[-3].point.volume, self.pivots[2].point.volume, properties) and \
            self.volume_exceeds(self.pivots[-3].point.volume, self.pivots[-2].point.volume, properties)
    ...
    def check_volumes_2_tops(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[1].point.volume, self.pivots[-2].point.volume, properties)
    ...
    def check_volumes_2_bottoms(self, properties: ReversalPatternProperties) -> bool:
        ...
        return self.volume_exceeds(self.pivots[-3].point.volume, self.pivots[-2].point.volume, properties) and \
            self.volume_exceeds(self.pivots[1].point.volume, self.pivots[-2].point.volume, properties)
    ...
    def check_profit(self, properties: ReversalPatternProperties) -> bool:
        ...
        reference_price = self.pivots[-1].point.price
