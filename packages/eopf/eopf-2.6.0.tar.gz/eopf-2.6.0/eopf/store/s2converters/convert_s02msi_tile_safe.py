...
def read_product_raster_data(
    ...
    *,
    ...
    if product_level == "L1C":
        _read_product_raster_data_l1c(band_name_to_wavelength, default_chunks, product_level, root_xdt, safe_path, xdt)
    elif product_level == "L2A":
        _read_product_raster_data_l2a(band_name_to_wavelength, default_chunks, product_level, root_xdt, safe_path, xdt)
...
def _read_product_raster_data_l2a(
    band_name_to_wavelength: dict[str, Any],
    default_chunks: Any,
    product_level: str,
    root_xdt: DataTree,
    safe_path: Path,
...
def _read_product_raster_data_l1c(
    band_name_to_wavelength: dict[str, Any],
    default_chunks: Any,
    product_level: str,
    root_xdt: DataTree,
        ...
        "history": [
            ...
            },
            {
                ...
                "inputs": {
                    ...
                    "used GRI file list": to_list_str(findalltext("n1:Auxiliary_Data_Info/GRI_List/GRI_FILENAME")),
