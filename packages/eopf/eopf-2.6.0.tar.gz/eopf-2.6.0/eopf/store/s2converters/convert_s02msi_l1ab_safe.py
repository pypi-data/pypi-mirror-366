...
def footprint_variables_building(
    ...
    top_lats, top_lons = _compute_top_lons_lats(npts_act, polygon_sides)

    bottom_lats, bottom_lons = _compute_bottom_lons_lats(npts_act, polygon_sides)

    # Calculate the total length of the side and the distances for each point
    left_lats, left_lons = _compute_left_lons_lats(npts_alt, polygon_sides)

    # Calculate the total length of the side and the distances for each point
    right_lats, right_lons = _compute_right_lons_lats(npts_alt, polygon_sides)
...
def _compute_right_lons_lats(
    npts_alt: int,
    polygon_sides: dict[str, LineString],
    ...
    return right_lats, right_lons


def _compute_left_lons_lats(
    npts_alt: int,
    polygon_sides: dict[str, LineString],
) -> Tuple[npt.NDArray[Any], npt.NDArray[Any]]:
    ...
    return left_lats, left_lons


def _compute_bottom_lons_lats(
    npts_act: int,
    polygon_sides: dict[str, LineString],
) -> Tuple[npt.NDArray[Any], npt.NDArray[Any]]:
    # Calculate the total length of the side and the distances for each point
    ...
    return bottom_lats, bottom_lons


def _compute_top_lons_lats(
    npts_act: int,
    polygon_sides: dict[str, LineString],
) -> Tuple[npt.NDArray[Any], npt.NDArray[Any]]:
    # Calculate the total length of the side and the distances for each point
