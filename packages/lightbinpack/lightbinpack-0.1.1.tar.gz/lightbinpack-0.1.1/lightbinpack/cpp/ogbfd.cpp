...
ogbfd(const std::vector<int> &lengths, int batch_max_length, int bins_per_group,
      int item_max_length = -1, int strategy = 0) {
...
PYBIND11_MODULE(ogbfd, m) {
    m.doc() =
        "Optimized Grouped BFD (Best Fit Decreasing) algorithm implementation";
