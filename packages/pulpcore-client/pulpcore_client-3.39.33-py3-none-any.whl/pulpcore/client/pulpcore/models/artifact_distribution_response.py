...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, content_guard=None, name=None, pulp_href=None, hidden=False, base_url=None, base_path=None, local_vars_configuration=None):  # noqa: E501
