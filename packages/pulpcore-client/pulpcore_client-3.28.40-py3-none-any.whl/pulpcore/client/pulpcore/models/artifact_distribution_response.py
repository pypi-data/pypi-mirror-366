...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_path=None, base_url=None, pulp_created=None, pulp_href=None, pulp_labels=None, hidden=False, content_guard=None, local_vars_configuration=None):  # noqa: E501
