...
@click.pass_context
@click.version_option(version="0.1.1", prog_name="mcp-mux")
...
def init() -> None:
    ...
    try:
        ...
        console.print("  • Run 'mcp-mux' to start the MCP server")
...
def model(model_name: str | None, list: bool) -> None:
    ...
    if model_name is None:
        ...
        console.print("\nUse 'mcp-mux model --list' to see available models")
        console.print("Use 'mcp-mux model <model-name>' to switch models")
        return
    ...
    console.print("\nNote: The new model will be used the next time you start mcp-mux.")
