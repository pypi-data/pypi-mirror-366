...
class RequestsTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        sweep_btn.setStyleSheet("background-color: #663307; color: white; font-size: 14px; padding: 0.5em 0em;")
        ...
        self.build_btn.setStyleSheet("background-color: #0f5c26; color: white; font-size: 14px; padding: 0.5em 0em;")
        ...
        self.cancel_button.setStyleSheet("background-color: #cc3333; color: white;")
        ...
        self.export_all_btn.setStyleSheet("color: white; font-size: 14px; padding: 0.5em 0em;")
