...
class default__:
    ...
    def KdfCounterMode(input):
        ...
        d_6_valueOrError1_ = Wrappers.default__.Need((True) and ((StandardLibrary_MemoryMath.default__.Add3(d_5_internalLength_, len(d_2_label___), len(d_3_info_))) < (StandardLibrary_UInt.default__.INT32__MAX__LIMIT)), AwsCryptographyPrimitivesTypes.Error_AwsCryptographicPrimitivesError(_dafny.Seq("Input Length exceeds INT32_MAX_LIMIT")))
    ...
    def RawDerive(ikm, explicitInfo, length, offset, digestAlgorithm):
        ...
        hi0_ = StandardLibrary_MemoryMath.default__.Add(d_3_iterations_, 1)
