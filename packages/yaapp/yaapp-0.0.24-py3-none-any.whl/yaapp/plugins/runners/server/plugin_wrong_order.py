"""
FINAL server runner plugin with instance method support.
"""
...
@yaapp.expose("server")
class Server:
    """FastAPI server with portalloc integration and instance method support."""
    ...
    def _start_server(self, host: str, port: int, reload: bool):
        ...
        async def rpc_endpoint(request: RPCRequest):
            """RPC function execution with instance method support."""
            ...
            for plugin_name, (obj, exposer) in yaapp._registry.items():
                try:
                    ...
                    # Case 2: Instance with methods (most common case for storage)
