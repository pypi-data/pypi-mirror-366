...
🌐 SERVER RUNNER HELP:
  ...
  --workers INT   Number of worker processes
    ...
    def _build_command_tree(self) -> Dict[str, Any]:
        ...
        for full_name, (obj, exposer) in self.yaapp._registry.items():
    ...
    def _add_rpc_endpoints(self, app):
        ...
        async def rpc_endpoint(request: RPCRequest):
            ...
            if '.' in function_name and function_name not in self.yaapp._registry:
                parts = function_name.split('.')
                if len(parts) == 2:
                    class_name, method_name = parts
                    if class_name in self.yaapp._registry:
                        cls, exposer = self.yaapp._registry[class_name]
    ...
    async def _call_function_async(self, function_name: str, kwargs: Dict[str, Any]):
        ...
        func, exposer = self.yaapp._registry[function_name]
                    ...
                    def make_streaming_endpoint(func_obj, func_name):
                        ...
                        async def streaming_endpoint(request: DynamicRequest):
                            ...
                            try:
                                ...
                                if func_name not in self.yaapp._registry:
                                ...
                                func, exposer = self.yaapp._registry[func_name]
