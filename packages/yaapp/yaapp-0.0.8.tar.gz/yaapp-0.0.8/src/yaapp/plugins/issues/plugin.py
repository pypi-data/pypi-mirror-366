...
class IssuesPlugin:
    ...
    def create(self, title: str, description: str, reporter: str, 
               priority: str = "medium", assignee: str = None) -> Result[str]:
        """Create a new issue."""
        ...
        try:
            storage_obj = self.yaapp.get_registry_item("storage")
        except KeyError:
    ...
    def list(self, status: str = None, assignee: str = None) -> Result[List[Dict[str, Any]]]:
