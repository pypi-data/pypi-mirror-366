"""
FastMCP tool implementation for Architecture GLiNER
"""
...
def extract_architecture_entities(
    ...
    Returns:
        ...
        - entities: List of extracted entities with scores and metadata
        - total_count: Total number of entities extracted
        - processing_info: Information about processing parameters
    """
    try:
...
def analyze_architecture_document(
    ...
    Returns:
        Dictionary containing:
        - entity_counts: Number of entities found
        - category_distribution: Distribution of entity categories
        - likely_phases: Most likely TOGAF ADM phases
        - likely_roles: Most likely architecture roles
        - document_complexity: Assessed complexity level
        - suggested_model: Recommended GLiNER model size
    """
    try:
