...
class VRIN:
    ...
    def __init__(
        ...
        base_url: str = "https://imx2jtbpb7.execute-api.us-west-1.amazonaws.com/prod",
        timeout: int = 30,
        max_retries: int = 3
    ):
        """
        ...
        for attempt in range(self.max_retries + 1):
            try:
                ...
                if response.status_code == 200:
                    ...
                    raise VRINAuthenticationError("Invalid API key", response.status_code, response.text)
