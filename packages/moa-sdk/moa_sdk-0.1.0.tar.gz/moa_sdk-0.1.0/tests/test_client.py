...
from moa import Config, Environment, MOAClient
...
def test_config_properties():
    ...
    assert config.base_url == "https://api.beta.memof.ai"
    assert config.api_base_url == "https://api.beta.memof.ai/api/v2/"
...
def test_client_api_access():
    ...
    from moa.api import GraphSearchAPI, MemoryAPI, RelationshipsAPI
