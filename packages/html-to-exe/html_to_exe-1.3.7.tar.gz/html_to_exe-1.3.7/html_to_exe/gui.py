...
class WebToEXEConverter:
    def __init__(self, root):
        self.root = root
        self.root.title("Web to EXE Converter")
    ...
    def create_ui(self):
        ...
        ttk.Entry(settings_tab, textvariable=self.web_dir, width=50).grid(row=1, column=1, padx=2)
        ...
        # Icon File
        ttk.Label(settings_tab, text="Icon (ico/png):").grid(row=4, column=0, sticky=tk.W, pady=2)
        ...
        platform_frame.grid(row=5, column=0, columnspan=3, sticky=tk.W+tk.E, pady=5)
