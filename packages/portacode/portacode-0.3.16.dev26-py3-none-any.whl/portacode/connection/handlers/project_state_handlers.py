    ...
    def get_detailed_status(self) -> GitDetailedStatus:
        ...
        try:
            ...
            for line in status_output.split('\n'):
                ...
                logger.debug("Git status line: '%s' -> file_path: '%s'", line, file_path)
                ...
                if file_path.startswith('"') and file_path.endswith('"'):
                    ...
                    logger.debug("Unquoted file_path: '%s'", file_path)
                ...
                if index_status != ' ' and index_status != '?':
                    ...
                    if change_type in ['added', 'modified'] and os.path.exists(abs_file_path):
                        ...
                        logger.debug("Computed hash for %s: %s", abs_file_path, content_hash)
                    else:
                        logger.debug("Skipping hash for %s: change_type=%s, exists=%s", 
