...
class ProjectStateManager:
    ...
    async def expand_folder(self, project_id: str, folder_path: str) -> bool:
        ...
        logger.info("expand_folder called: project_id=%s, folder_path=%s", project_id, folder_path)
...
class ProjectStateFolderExpandHandler(AsyncHandler):
    ...
    async def execute(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info("Extracted project_id: %s, folder_path: %s", project_id, folder_path)
