...
class GitFileChange:
    ...
    old_repo_path: Optional[str] = None  # For renamed files - old relative path from repo root
    old_name: Optional[str] = None  # For renamed files - old filename
    old_abs_path: Optional[str] = None  # For renamed files - old absolute path
    ...
    def get_detailed_status(self) -> GitDetailedStatus:
        ...
        try:
            ...
            for diff_item in staged_files:
                ...
                old_name = None
                old_abs_path = None
                if diff_item.renamed_file and diff_item.a_path != diff_item.b_path:
                    old_repo_path = diff_item.a_path
                    old_name = os.path.basename(diff_item.a_path)
                    old_abs_path = os.path.join(self.project_path, diff_item.a_path)
