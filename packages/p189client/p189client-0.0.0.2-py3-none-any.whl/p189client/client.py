...
CRE_JS_unifyLoginForPC_captchaToken_search: Final = re_compile(r"(?<='captchaToken' value=')[^']+").search
...
class P189BaseClient(ABC):
    ...
    def login_app_conf(
        ...
        **request_kwargs, 
        ...
        if not isinstance(payload, dict):
            payload = {"appId": payload}
        payload = {"appId": "cloud", "version": "2.0", **payload}
        request_kwargs.setdefault("parse", default_parse)
        if method.upper() == "POST":
            request_kwargs["data"] = payload
        else:
    ...
    def login_unify_pc(
        ...
        **request_kwargs, 
        ...
        """
        api = complete_url("portal/unifyLoginForPC.action")
        if not isinstance(payload, dict):
            payload = {"appId": payload}
        payload = {
            "appId": "8025431004", 
        ...
        def parse(resp, content, /):
            ...
            if m := CRE_JS_unifyLoginForPC_captchaToken_search(text):
    ...
    def login_url(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - ...
        """
        api = complete_url("portal/loginUrl.action")
        payload = {
            ...
            data = yield cls.login_submit(
                {
                    ...
                    "captchaToken": conf["captchaToken"], 
...
class P189Client(P189BaseClient):
    ...
    # TODO: 还有其它办法获取此值：https://github.com/s0urcelab/cloud189/blob/master/cloud189/client.py#L194
    @locked_cacheproperty
    def session_key(self, /) -> str:
...
# TODO: 实际测验一下网页版的账号密码登录，看看有什么新发现
