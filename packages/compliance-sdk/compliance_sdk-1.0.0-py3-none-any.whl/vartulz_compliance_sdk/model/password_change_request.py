...
class PasswordChangeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["companyId", "otp", "newPassword", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["companyId", "otp", "newPassword", ], str]):
