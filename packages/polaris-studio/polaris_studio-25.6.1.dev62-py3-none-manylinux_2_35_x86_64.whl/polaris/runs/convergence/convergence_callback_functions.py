...
def precache_kpis(current_iteration: ConvergenceIteration, skip_cache: bool = False):
    ...
    #   county_to_county_demand because it needs a lot of memory!
    metrics_to_cache = {
        m for m in kpi.available_metrics() if "skim" not in m and "network_gap" not in m and "county_to_county" not in m
    }
