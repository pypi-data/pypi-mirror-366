...
class WorkersScript(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#account_id WorkersScript#account_id}
        :param script_name: Name of the script, used in URLs and route configuration. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#script_name WorkersScript#script_name}
        :param assets: Configuration for assets within a Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#assets WorkersScript#assets}
        :param bindings: List of bindings attached to a Worker. You can find more about bindings on our docs: https://developers.cloudflare.com/workers/configuration/multipart-upload-metadata/#bindings. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#bindings WorkersScript#bindings}
        :param body_part: Name of the part in the multipart request that contains the script (e.g. the file adding a listener to the ``fetch`` event). Indicates a ``service worker syntax`` Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#body_part WorkersScript#body_part}
        :param compatibility_date: Date indicating targeted support in the Workers runtime. Backwards incompatible fixes to the runtime following this date will not affect this Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#compatibility_date WorkersScript#compatibility_date}
        :param compatibility_flags: Flags that enable or disable certain features in the Workers runtime. Used to enable upcoming features or opt in or out of specific changes not included in a ``compatibility_date``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#compatibility_flags WorkersScript#compatibility_flags}
        :param content: Module or Service Worker contents of the Worker. Exactly one of ``content`` or ``content_file`` must be specified. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#content WorkersScript#content}
        :param content_file: Path to a file containing the Module or Service Worker contents of the Worker. Exactly one of ``content`` or ``content_file`` must be specified. Must be paired with ``content_sha256``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#content_file WorkersScript#content_file}
        :param content_sha256: SHA-256 hash of the Worker contents. Used to trigger updates when source code changes. Must be provided when ``content_file`` is specified. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#content_sha256 WorkersScript#content_sha256}
        :param content_type: Content-Type of the Worker. Required if uploading a non-JavaScript Worker (e.g. "text/x-python"). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#content_type WorkersScript#content_type}
        :param keep_assets: Retain assets which exist for a previously uploaded Worker version; used in lieu of providing a completion token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#keep_assets WorkersScript#keep_assets}
        :param keep_bindings: List of binding types to keep from previous_upload. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#keep_bindings WorkersScript#keep_bindings}
        :param logpush: Whether Logpush is turned on for the Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#logpush WorkersScript#logpush}
        :param main_module: Name of the part in the multipart request that contains the main module (e.g. the file exporting a ``fetch`` handler). Indicates a ``module syntax`` Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#main_module WorkersScript#main_module}
        :param migrations: Migrations to apply for Durable Objects associated with this Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#migrations WorkersScript#migrations}
        :param observability: Observability settings for the Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#observability WorkersScript#observability}
        :param placement: Configuration for `Smart Placement <https://developers.cloudflare.com/workers/configuration/smart-placement>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#placement WorkersScript#placement}
        :param tail_consumers: List of Workers that will consume logs from the attached Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#tail_consumers WorkersScript#tail_consumers}
        :param usage_model: Usage model for the Worker invocations. Available values: "standard". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#usage_model WorkersScript#usage_model}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing WorkersScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#import import section} in the documentation of this resource for the id to use
    ...
    def put_assets(
        ...
        *,
        ...
        '''
        :param config: Configuration for assets within a Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#config WorkersScript#config}
        :param jwt: Token provided upon successful upload of all files from a registered manifest. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#jwt WorkersScript#jwt}
        '''
    ...
    def put_migrations(
        ...
        *,
        ...
        '''
        :param deleted_classes: A list of classes to delete Durable Object namespaces from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#deleted_classes WorkersScript#deleted_classes}
        :param new_classes: A list of classes to create Durable Object namespaces from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#new_classes WorkersScript#new_classes}
        :param new_sqlite_classes: A list of classes to create Durable Object namespaces with SQLite from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#new_sqlite_classes WorkersScript#new_sqlite_classes}
        :param new_tag: Tag to set as the latest migration tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#new_tag WorkersScript#new_tag}
        :param old_tag: Tag used to verify against the latest migration tag for this Worker. If they don't match, the upload is rejected. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#old_tag WorkersScript#old_tag}
        :param renamed_classes: A list of classes with Durable Object namespaces that were renamed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#renamed_classes WorkersScript#renamed_classes}
        :param steps: Migrations to apply in order. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#steps WorkersScript#steps}
        :param transferred_classes: A list of transfers for Durable Object namespaces from a different Worker and class to a class defined in this Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#transferred_classes WorkersScript#transferred_classes}
        '''
    ...
    def put_observability(
        ...
        *,
        ...
        '''
        :param enabled: Whether observability is enabled for the Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#enabled WorkersScript#enabled}
        :param head_sampling_rate: The sampling rate for incoming requests. From 0 to 1 (1 = 100%, 0.1 = 10%). Default is 1. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#head_sampling_rate WorkersScript#head_sampling_rate}
        :param logs: Log settings for the Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#logs WorkersScript#logs}
        '''
    ...
    def put_placement(self, *, mode: typing.Optional[builtins.str] = None) -> None:
        '''
        :param mode: Enables `Smart Placement <https://developers.cloudflare.com/workers/configuration/smart-placement>`_. Available values: "smart". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#mode WorkersScript#mode}
        '''
...
class WorkersScriptAssetsConfig:
    def __init__(
        ...
        *,
        ...
        '''
        :param headers: The contents of a _headers file (used to attach custom headers on asset responses). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#headers WorkersScript#headers}
        :param html_handling: Determines the redirects and rewrites of requests for HTML content. Available values: "auto-trailing-slash", "force-trailing-slash", "drop-trailing-slash", "none". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#html_handling WorkersScript#html_handling}
        :param not_found_handling: Determines the response when a request does not match a static asset, and there is no Worker script. Available values: "none", "404-page", "single-page-application". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#not_found_handling WorkersScript#not_found_handling}
        :param redirects: The contents of a _redirects file (used to apply redirects or proxy paths ahead of asset serving). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#redirects WorkersScript#redirects}
        :param run_worker_first: When true, requests will always invoke the Worker script. Otherwise, attempt to serve an asset matching the request, falling back to the Worker script. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#run_worker_first WorkersScript#run_worker_first}
        :param serve_directly: When true and the incoming request matches an asset, that will be served instead of invoking the Worker script. When false, requests will always invoke the Worker script. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#serve_directly WorkersScript#serve_directly}
        '''
        if __debug__:
...
class WorkersScriptBindings:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: A JavaScript variable name for the binding. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#name WorkersScript#name}
        :param type: The kind of resource that the binding provides. Available values: "ai", "analytics_engine", "assets", "browser", "d1", "dispatch_namespace", "durable_object_namespace", "hyperdrive", "json", "kv_namespace", "mtls_certificate", "plain_text", "pipelines", "queue", "r2_bucket", "secret_text", "service", "tail_consumer", "vectorize", "version_metadata", "secrets_store_secret", "secret_key", "workflow". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#type WorkersScript#type}
        :param algorithm: Algorithm-specific key parameters. `Learn more <https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#algorithm>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#algorithm WorkersScript#algorithm}
        :param bucket_name: R2 bucket to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#bucket_name WorkersScript#bucket_name}
        :param certificate_id: Identifier of the certificate to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#certificate_id WorkersScript#certificate_id}
        :param class_name: The exported class name of the Durable Object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#class_name WorkersScript#class_name}
        :param dataset: The name of the dataset to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#dataset WorkersScript#dataset}
        :param environment: The environment of the script_name to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#environment WorkersScript#environment}
        :param format: Data format of the key. `Learn more <https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#format>`_. Available values: "raw", "pkcs8", "spki", "jwk". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#format WorkersScript#format}
        :param id: Identifier of the D1 database to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#id WorkersScript#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param index_name: Name of the Vectorize index to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#index_name WorkersScript#index_name}
        :param json: JSON data to use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#json WorkersScript#json}
        :param key_base64: Base64-encoded key data. Required if ``format`` is "raw", "pkcs8", or "spki". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#key_base64 WorkersScript#key_base64}
        :param key_jwk: Key data in `JSON Web Key <https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#json_web_key>`_ format. Required if ``format`` is "jwk". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#key_jwk WorkersScript#key_jwk}
        :param namespace: Namespace to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#namespace WorkersScript#namespace}
        :param namespace_id: Namespace identifier tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#namespace_id WorkersScript#namespace_id}
        :param outbound: Outbound worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#outbound WorkersScript#outbound}
        :param pipeline: Name of the Pipeline to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#pipeline WorkersScript#pipeline}
        :param queue_name: Name of the Queue to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#queue_name WorkersScript#queue_name}
        :param script_name: The script where the Durable Object is defined, if it is external to this Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#script_name WorkersScript#script_name}
        :param secret_name: Name of the secret in the store. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#secret_name WorkersScript#secret_name}
        :param service: Name of Worker to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#service WorkersScript#service}
        :param store_id: ID of the store containing the secret. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#store_id WorkersScript#store_id}
        :param text: The text value to use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#text WorkersScript#text}
        :param usages: Allowed operations with the key. `Learn more <https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#keyUsages>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#usages WorkersScript#usages}
        :param workflow_name: Name of the Workflow to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#workflow_name WorkersScript#workflow_name}
        '''
...
class WorkersScriptBindingsOutbound:
    def __init__(
        ...
        *,
        ...
        '''
        :param params: Pass information from the Dispatch Worker to the Outbound Worker through the parameters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#params WorkersScript#params}
        :param worker: Outbound worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#worker WorkersScript#worker}
        '''
...
class WorkersScriptBindingsOutboundOutputReference(
    ...
    def put_worker(
        ...
        *,
        ...
        '''
        :param environment: Environment of the outbound worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#environment WorkersScript#environment}
        :param service: Name of the outbound worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#service WorkersScript#service}
        '''
...
class WorkersScriptMigrationsRenamedClasses:
    def __init__(
        ...
        *,
        ...
        '''
        :param from_: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#from WorkersScript#from}.
        :param to: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#to WorkersScript#to}.
        '''
        if __debug__:
...
class WorkersScriptMigrationsStepsTransferredClasses:
    def __init__(
        ...
        *,
        ...
        '''
        :param from_: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#from WorkersScript#from}.
        :param from_script: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#from_script WorkersScript#from_script}.
        :param to: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#to WorkersScript#to}.
        '''
        if __debug__:
...
class WorkersScriptObservabilityLogs:
    def __init__(
        ...
        *,
        ...
        '''
        :param enabled: Whether logs are enabled for the Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#enabled WorkersScript#enabled}
        :param invocation_logs: Whether `invocation logs <https://developers.cloudflare.com/workers/observability/logs/workers-logs/#invocation-logs>`_ are enabled for the Worker. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#invocation_logs WorkersScript#invocation_logs}
        :param head_sampling_rate: The sampling rate for logs. From 0 to 1 (1 = 100%, 0.1 = 10%). Default is 1. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#head_sampling_rate WorkersScript#head_sampling_rate}
        '''
        if __debug__:
...
class WorkersScriptTailConsumers:
    def __init__(
        ...
        *,
        ...
        '''
        :param service: Name of Worker that is to be the consumer. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#service WorkersScript#service}
        :param environment: Optional environment if the Worker utilizes one. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#environment WorkersScript#environment}
        :param namespace: Optional dispatch namespace the script belongs to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs/resources/workers_script#namespace WorkersScript#namespace}
        '''
        if __debug__:
