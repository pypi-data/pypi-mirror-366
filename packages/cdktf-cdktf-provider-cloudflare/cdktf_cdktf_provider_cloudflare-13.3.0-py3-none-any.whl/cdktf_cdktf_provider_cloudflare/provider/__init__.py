...
class CloudflareProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs#alias CloudflareProvider#alias}
        :param api_key: The API key for operations. Alternatively, can be configured using the ``CLOUDFLARE_API_KEY`` environment variable. API keys are `now considered legacy by Cloudflare <https://developers.cloudflare.com/fundamentals/api/get-started/keys/#limitations>`_, API tokens should be used instead. Must provide only one of ``api_key``, ``api_token``, ``api_user_service_key``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs#api_key CloudflareProvider#api_key}
        :param api_token: The API Token for operations. Alternatively, can be configured using the ``CLOUDFLARE_API_TOKEN`` environment variable. Must provide only one of ``api_key``, ``api_token``, ``api_user_service_key``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs#api_token CloudflareProvider#api_token}
        :param api_user_service_key: A special Cloudflare API key good for a restricted set of endpoints. Alternatively, can be configured using the ``CLOUDFLARE_API_USER_SERVICE_KEY`` environment variable. Must provide only one of ``api_key``, ``api_token``, ``api_user_service_key``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs#api_user_service_key CloudflareProvider#api_user_service_key}
        :param base_url: Value to override the default HTTP client base URL. Alternatively, can be configured using the ``base_url`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs#base_url CloudflareProvider#base_url}
        :param email: A registered Cloudflare email address. Alternatively, can be configured using the ``CLOUDFLARE_EMAIL`` environment variable. Required when using ``api_key``. Conflicts with ``api_token``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs#email CloudflareProvider#email}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing CloudflareProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.8.2/docs#import import section} in the documentation of this resource for the id to use
