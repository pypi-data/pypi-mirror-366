...
def eval_coverage(model:GAMM | GAMMLSS | GSMM,pred_dat:pd.DataFrame,dist_par:int=0,target:float | list[float]=0.0,use:list[int]=None,alpha:float=0.05,whole_function:bool=False,n_ps:int=10000,seed:int|None=None) -> tuple[bool, float, list[bool]]:
    ...
    :type seed: int |None or None, optional
