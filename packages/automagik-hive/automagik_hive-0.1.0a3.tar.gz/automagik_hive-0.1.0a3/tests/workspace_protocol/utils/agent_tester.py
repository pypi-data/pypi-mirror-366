...
class AgentTester:
    ...
    def _generate_simulated_response(self, agent_name: str, task_prompt: str, 
        ...
        if not agent_config.get("has_workspace_protocol", False):
            ...
            return f"""I'll help you with that task. Here's my analysis...
    ...
    def _determine_task_outcome(self, agent_name: str, task_prompt: str) -> tuple[str, List[str]]:
        ...
        elif "refine" in task_prompt.lower() or "execution-ready" in task_prompt.lower():
        ...
        elif "complete" in task_prompt.lower() or "finished" in task_prompt.lower():
