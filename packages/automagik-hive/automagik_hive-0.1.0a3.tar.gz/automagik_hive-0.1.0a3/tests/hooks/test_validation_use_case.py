...
import pytest
from src.hooks.application.validate_precommit import ValidatePreCommitUseCase, ValidationMetrics
from src.hooks.domain.entities import FileChange, FileOperation, ValidationResult
from src.hooks.domain.value_objects import RootWhitelist, GenieStructure, ValidationConfig
