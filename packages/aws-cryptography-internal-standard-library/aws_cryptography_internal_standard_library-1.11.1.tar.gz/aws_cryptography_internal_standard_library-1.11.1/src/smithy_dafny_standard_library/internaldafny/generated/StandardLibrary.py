...
class default__:
    ...
    def Join(ss, joiner):
        ...
        d_1_result_ = (ss)[(d_0_size_) - (1)]
        d_2_i_: int
        d_2_i_ = (d_0_size_) - (1)
        while (d_2_i_) > (0):
            d_2_i_ = (d_2_i_) - (1)
            d_1_result_ = (((ss)[d_2_i_]) + (joiner)) + (d_1_result_)
        s = d_1_result_
        return s
        return s
        ...
        while True:
            with _dafny.label():
                ...
                if (d_1_i_).is_Some:
                    ...
                    in0_ = _dafny.Seq((s)[StandardLibrary_MemoryMath.default__.Add((d_1_i_).value, 1)::])
                    in1_ = delim
                    s = in0_
                    delim = in1_
    ...
    def SplitOnce(s, delim):
        ...
        return (_dafny.Seq((s)[:(d_0_i_).value:]), _dafny.Seq((s)[StandardLibrary_MemoryMath.default__.Add((d_0_i_).value, 1)::]))
    ...
    def SplitOnce_q(s, delim):
        ...
        if (d_0_valueOrError0_).IsFailure():
            ...
            return Wrappers.Option_Some((_dafny.Seq((s)[:d_1_i_:]), _dafny.Seq((s)[StandardLibrary_MemoryMath.default__.Add(d_1_i_, 1)::])))
    ...
    def Filter(s, f):
        ...
        while (d_1_i_) > (0):
            d_1_i_ = (d_1_i_) - (1)
            if f((s)[d_1_i_]):
                d_0_result_ = (_dafny.Seq([(s)[d_1_i_]])) + (d_0_result_)
        res = d_0_result_
        return res
        return res
