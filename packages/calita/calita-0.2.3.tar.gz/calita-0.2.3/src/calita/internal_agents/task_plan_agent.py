...
class TaskPlanAgent:
    ...
    def task_plan(self, user_request: str, tool_schemas: str)-> List[Dict[str, Any]]:
        ...
        stream = True if "qwq" in model else False #qwen-qwq llm only support stream invoke
        response_text: str = ""
        ...
        print(f"====plan task=======   {response_text}         ========")
...
if __name__ == "__main__":
    ...
    task_plan_agent.task_plan("上周黄金的走势，输出格式{‘周一’: price}", "")