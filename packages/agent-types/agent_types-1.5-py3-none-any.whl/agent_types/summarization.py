...
class SummarizationRequest(Request):
    ...
    constraint_fields: Optional[Union[str, List[str]]] = Field(
        title="格式约束属性名",
        description="工具输出结果中可能带有总结格式的约束信息，`constraint_fields`表示该信息在工具结果中的属性名。",
    ...
    def model_post_init(self, __context: Any) -> None:
        if self.constraint_fields and isinstance(self.constraint_fields, str):
            self.constraint_fields = [self.constraint_fields]
