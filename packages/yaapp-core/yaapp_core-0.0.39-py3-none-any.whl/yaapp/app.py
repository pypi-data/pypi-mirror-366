...
class Yaapp(YaappCore):
    ...
    def _discover_runner_plugins(self):
        ...
        try:
            ...
            # Store discovered runners directly (they are simple modules with help() and run())
            for runner_name, runner_module in discovered_runners.items():
                if runner_module:
                    self._runner_plugins[runner_name] = runner_module
