...
class KVDType(Enum):
    ...
    Attributes:
        ...
        FP8 (str): the kv dtype is specified as 'fp8-E4M3'.
...
class WeightDType(Enum):
    ...
    Attributes:
        ...
        W8fA8f (str): For W8fA8f, the weight data type is specified as 'fp8-E4M3'.
...
class TargetMachine(Enum):
    """
    Enum for specifying target machines for quantization.

    Attributes:
        RNGD (str): Represents the RNGD machine target.
    """

    RNGD = 'RNGD'


class WeightOpEmulDtype(Enum):
    """
    Enum for specifying the emulation data type for weighted operations.

    Attributes:
        FP32 (str): Represents the FP32 data type.
        FP64 (str): Represents the FP64 data type.
    """
