...
class ProgressTracker:
    ...
    def __init__(self, total: int, description: str = "Processing..."):
        ...
        Args:
            ...
            description: A short description of the task being performed.
        """
        self.total = total
    ...
    def update(self, advance: int = 1, status: str = "running") -> Dict[str, Any]:
        """
        Advances the progress and returns a formatted dictionary.
