...
Usage Examples:
    ...
    orbis scanner create -n astronomer --interactive --output-file scanner-bundle.yaml

    # Direct execution mode
    orbis scanner create -n astronomer

    # Check scanner status
    orbis scanner status -n astronomer

    # Retrieve data from completed scanner
    orbis scanner retrieve -n astronomer

    # Clean up resources
    orbis scanner clean -n astronomer
"""
