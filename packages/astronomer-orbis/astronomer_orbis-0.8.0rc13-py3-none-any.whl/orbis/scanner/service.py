...
class ScannerService:
    ...
    def generate_yaml(self, output_file: str | None = None) -> ScannerResult:
        ...
        try:
            ...
            if output_file:
                ...
                print(f"4. After completion, retrieve data: orbis scanner retrieve -n {self.config.namespace}")
    ...
    def create_and_execute(self) -> ScannerResult:
        ...
        try:
            ...
            # Note: create_service_account already creates ClusterRole and ClusterRoleBinding
            ...
            if not job_completed:
                ...
                if init_container_running:
                    ...
                    self.logger.warning(f"To retrieve when ready: orbis scanner retrieve -n {self.config.namespace}")
                    self.logger.warning(f"To clean up later: orbis scanner clean -n {self.config.namespace}")
                else:
