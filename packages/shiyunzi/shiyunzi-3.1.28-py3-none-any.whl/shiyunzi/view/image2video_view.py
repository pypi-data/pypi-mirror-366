...
from shiyunzi.view.image2video_dialog import Image2VideoDialog
...
class TaskItem(QWidget):
    def __init__(self, task, parent=None):
        ...
        layout.addWidget(image2video_label, 2)
...
class Image2VideoView(QWidget):
    ...
    def load_tasks(self):
        ...
        tasks = Task.select().where(Task.type == "image2video")
