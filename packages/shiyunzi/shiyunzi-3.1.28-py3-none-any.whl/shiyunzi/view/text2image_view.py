...
from shiyunzi.view.text2image_dialog import Text2ImageDialog
...
class TaskItem(QWidget):
    def __init__(self, task, parent=None):
        ...
        layout.addWidget(text2image_label, 2)
...
class Text2ImageView(QWidget):
    ...
    def load_tasks(self):
        ...
        tasks = Task.select().where(Task.type == "text2image")
