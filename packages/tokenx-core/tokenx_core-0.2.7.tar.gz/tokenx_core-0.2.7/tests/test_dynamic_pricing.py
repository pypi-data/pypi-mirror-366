...
def test_config_constants():
    ...
    from src.tokenx.yaml_loader import REMOTE_PRICES_URL, CACHE_TTL_HOURS, REMOTE_FALLBACK_URLS
    
    assert REMOTE_PRICES_URL == "https://raw.githubusercontent.com/dvlshah/tokenx/main/src/tokenx/model_prices.yaml"
