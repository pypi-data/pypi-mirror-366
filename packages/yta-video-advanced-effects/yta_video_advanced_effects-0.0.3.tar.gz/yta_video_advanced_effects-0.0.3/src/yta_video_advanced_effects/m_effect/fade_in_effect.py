...
class FadeInEffect(Effect):
    ...
    appear progressively lasting the
    provided 'duration' time or the
    whole  clip duration if None
    'duration' provided.

    The 'color' provided must be a
    valid color string, array, tuple
    or Color instance, or will be set
    as pure black if None provided.
    """
