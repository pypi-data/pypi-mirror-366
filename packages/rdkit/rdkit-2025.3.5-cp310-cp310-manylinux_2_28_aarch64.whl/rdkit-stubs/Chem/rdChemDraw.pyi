...
def MolToChemDrawBlock(mol: Mol, format: CDXFormat = ...) -> str:
    """
        ...
        C++ signature :
            std::string MolToChemDrawBlock(RDKit::ROMol [,RDKit::v2::CDXFormat=rdkit.Chem.rdChemDraw.CDXFormat.CDXML])
    """
def MolsFromChemDrawBlock(block: str, sanitize: bool = True, removeHs: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object MolsFromChemDrawBlock(std::string [,bool=True [,bool=True]])
    """
