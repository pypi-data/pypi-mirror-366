...
def _DeleteFpInfoAttr(mol):
    ...
apDict: dict  # value = {'normal': <function <lambda> at 0xffff7ef67740>, 'hashed': <function <lambda> at 0xffff7ef677e0>, 'bv': <function <lambda> at 0xffff7ef67880>}
cm = None
ttDict: dict  # value = {'normal': <function <lambda> at 0xffff7ef679c0>, 'hashed': <function <lambda> at 0xffff7ef67a60>, 'bv': <function <lambda> at 0xffff7ef67b00>}
