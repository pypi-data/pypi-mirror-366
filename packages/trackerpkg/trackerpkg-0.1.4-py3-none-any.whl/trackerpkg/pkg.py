...
POSTGRESDBNAME = os.environ['DB_NAME']
POSTGRESUSER = os.environ['DB_USER']
POSTGRESPASSWORD = os.environ['DB_PASSWORD']
POSTGRESHOST = os.environ['DB_HOST']
POSTGRESPORT = os.environ['DB_PORT']
