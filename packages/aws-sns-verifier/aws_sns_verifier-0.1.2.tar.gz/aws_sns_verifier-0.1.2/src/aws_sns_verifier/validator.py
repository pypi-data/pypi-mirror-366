...
def validate_sns_signature(
    message: dict, expected_topic_arn: str | None = None, is_mail_message: bool = False
) -> EmailWebhookRequest | SNSSubscriptionConfirmation | EmailWebhookMessage:
    """
    ...
    try:
        ...
        if is_mail_message:
            return EmailWebhookMessage.model_validate(body.Message)
