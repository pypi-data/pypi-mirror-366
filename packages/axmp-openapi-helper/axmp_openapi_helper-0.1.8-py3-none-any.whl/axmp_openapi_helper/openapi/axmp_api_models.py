                    ...
                    if isinstance(item, Schema):
                        if item.ref:
                            ...
                            if isinstance(component_schema, Schema):
                                ...
                                logger.warning(f"Component schema is not a Schema type: {ref_class_name}")
                                model_ = None
                        else:
                            model_ = self._generate_model_from_component_schema(
