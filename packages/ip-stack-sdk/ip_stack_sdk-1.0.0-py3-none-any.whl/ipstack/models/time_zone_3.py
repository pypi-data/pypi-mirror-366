...
class TimeZone3(object):

    """Implementation of the 'time_zone3' model.

    Attributes:
        id (str): The model property of type str.
        current_time (str): The model property of type str.
        gmt_offset (str): The model property of type str.
        code (str): The model property of type str.
        is_daylight_saving (str): The model property of type str.
    ...
    def __init__(self,
        ...
        """Constructor for the TimeZone3 class"""
    ...
    def from_dictionary(cls,
        ...
        is_daylight_saving = dictionary.get("is_daylight_saving") if dictionary.get("is_daylight_saving") else None
    ...
    def from_element(cls, root):
        ...
        gmt_offset = XmlUtilities.value_from_xml_element(root.find('gmt_offset'), str)
        code = XmlUtilities.value_from_xml_element(root.find('code'), str)
        is_daylight_saving = XmlUtilities.value_from_xml_element(root.find('is_daylight_saving'), str)
