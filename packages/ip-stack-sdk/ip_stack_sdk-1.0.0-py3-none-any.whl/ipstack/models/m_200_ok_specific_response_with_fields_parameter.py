...
class M200OKSpecificResponseWithFieldsParameter(object):

    """Implementation of the '200 OK – Specific Response with Fields Parameter' model.
    ...
    def __init__(self,
                 zip=None):
        """Constructor for the M200OKSpecificResponseWithFieldsParameter class"""
