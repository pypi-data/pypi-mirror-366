...
from ipstack.configuration import Configuration
from ipstack.controllers.base_controller import BaseController
from ipstack.configuration import Environment
from ipstack.http.auth.custom_query_authentication import CustomQueryAuthentication
from ipstack.controllers.standard_ip_lookup_controller\
    import StandardIPLookupController
from ipstack.controllers.bulk_ip_lookup_controller\
    import BulkIPLookupController
from ipstack.controllers.requester_ip_lookup_controller\
    import RequesterIPLookupController


class IpstackClient(object):
    @LazyProperty
