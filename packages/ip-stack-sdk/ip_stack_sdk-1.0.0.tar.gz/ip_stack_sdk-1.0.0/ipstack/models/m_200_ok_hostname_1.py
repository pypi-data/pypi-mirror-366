...
from ipstack.models.location_4 import Location4
from ipstack.models.time_zone import TimeZone
from ipstack.utilities.xml_utilities import XmlUtilities


class M200OKHostname1(object):

    """Implementation of the '200 OK – Hostname1' model.

    Attributes:
        ip (str): The model property of type str.
        hostname (str): The model property of type str.
        ...
        location (Location4): The model property of type Location4.
    ...
    def __init__(self,
                 ...
                 currency=None,
                 connection=None):
        """Constructor for the M200OKHostname1 class"""
    ...
    def from_dictionary(cls,
        ...
        location = Location4.from_dictionary(dictionary.get('location')) if dictionary.get('location') else None
    ...
    def from_element(cls, root):
        ...
        hostname = XmlUtilities.value_from_xml_element(root.find('hostname'), str)
        ...
        location = XmlUtilities.value_from_xml_element(root.find('Location4'), Location4)
    ...
    def to_xml_sub_element(self, root):
        ...
        XmlUtilities.add_as_subelement(root, self.hostname, 'hostname')
        ...
        XmlUtilities.add_as_subelement(root, self.location, 'Location4')
