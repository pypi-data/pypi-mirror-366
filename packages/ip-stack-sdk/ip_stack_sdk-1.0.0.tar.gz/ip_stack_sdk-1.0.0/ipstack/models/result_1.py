...
from ipstack.models.connection_3 import Connection3
from ipstack.models.currency_3 import Currency3
from ipstack.models.location_3 import Location3
from ipstack.models.time_zone_7 import TimeZone7
...
class Result1(object):
    ...
    Attributes:
        ...
        zip (int): The model property of type int.
        latitude (str): The model property of type str.
        longitude (str): The model property of type str.
        location (Location3): The model property of type Location3.
        time_zone (TimeZone7): The model property of type TimeZone7.
        currency (Currency3): The model property of type Currency3.
        connection (Connection3): The model property of type Connection3.
    ...
    def from_dictionary(cls,
        ...
        location = Location3.from_dictionary(dictionary.get('location')) if dictionary.get('location') else None
        time_zone = TimeZone7.from_dictionary(dictionary.get('time_zone')) if dictionary.get('time_zone') else None
        currency = Currency3.from_dictionary(dictionary.get('currency')) if dictionary.get('currency') else None
        connection = Connection3.from_dictionary(dictionary.get('connection')) if dictionary.get('connection') else None
    ...
    def from_element(cls, root):
        ...
        zip = XmlUtilities.value_from_xml_element(root.find('zip'), int)
        latitude = XmlUtilities.value_from_xml_element(root.find('latitude'), str)
        longitude = XmlUtilities.value_from_xml_element(root.find('longitude'), str)
        location = XmlUtilities.value_from_xml_element(root.find('location'), Location3)
        time_zone = XmlUtilities.value_from_xml_element(root.find('time_zone'), TimeZone7)
        currency = XmlUtilities.value_from_xml_element(root.find('currency'), Currency3)
        connection = XmlUtilities.value_from_xml_element(root.find('connection'), Connection3)
        index = XmlUtilities.value_from_xml_attribute(root.get('index'), int)
