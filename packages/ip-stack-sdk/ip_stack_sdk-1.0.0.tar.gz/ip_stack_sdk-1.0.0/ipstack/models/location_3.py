...
"""
from ipstack.models.languages import Languages
from ipstack.utilities.xml_utilities import XmlUtilities


class Location3(object):

    """Implementation of the 'location3' model.

    Attributes:
        geoname_id (int): The model property of type int.
        capital (str): The model property of type str.
        languages (Languages): The model property of type Languages.
        ...
        calling_code (int): The model property of type int.
        is_eu (str): The model property of type str.
    ...
    def __init__(self,
                 ...
                 calling_code=None,
                 is_eu=None):
        """Constructor for the Location3 class"""
    ...
    def from_dictionary(cls,
        ...
        languages = Languages.from_dictionary(dictionary.get('languages')) if dictionary.get('languages') else None
        ...
        is_eu = dictionary.get("is_eu") if dictionary.get("is_eu") else None
    ...
    def from_element(cls, root):
        ...
        languages = XmlUtilities.value_from_xml_element(root.find('languages'), Languages)
        ...
        calling_code = XmlUtilities.value_from_xml_element(root.find('calling_code'), int)
        is_eu = XmlUtilities.value_from_xml_element(root.find('is_eu'), str)
    ...
    def to_xml_sub_element(self, root):
        ...
        XmlUtilities.add_as_subelement(root, self.languages, 'languages')
