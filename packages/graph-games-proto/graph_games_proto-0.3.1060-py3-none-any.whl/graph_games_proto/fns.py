    ...
    state = State(
        ...
        decks=[
            Deck(
                ...
                units=[],
                facedown_stack=[
                    Card(idx=0, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=1, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=2, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=3, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=4, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=5, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=6, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=7, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=8, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=9, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=10, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=11, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=12, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=13, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=14, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=15, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=16, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=17, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=18, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=19, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=20, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=21, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=22, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=23, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=24, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=25, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=26, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=27, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=28, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=29, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=30, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=31, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=32, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=33, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=34, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=35, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=36, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=37, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=38, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=39, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=40, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=41, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=42, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=43, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=44, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=45, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=46, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=47, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=48, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=49, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=50, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=51, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=52, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=53, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=54, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=55, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=56, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=57, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=58, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=59, uuid=str(generate_uuid_with_rng(rng)), is_wild=True, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                ],
                faceup_spots=[],
                discard=[],
            ),
            Deck(
                uuid="a473fc84-6900-4f49-a414-7ddf569d334c",
                units=[],
                facedown_stack=[
...
def handle_keep_action(game, action):
    ...
    player = game.players[action.legal_action.player_idx]
    if not player or not player.discard_tray:
        return game

    # Keep the specified cards in the discard tray
    kept_cards = [player.discard_tray[i] for i in action.legal_action.config.keep.tray_idxs if i < len(player.discard_tray)]
