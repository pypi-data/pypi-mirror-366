        ...
        decks=[
            Deck(
                ...
                facedown_stack=[
                    ...
                    Card(idx=50, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=51, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=52, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=53, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=54, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=55, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=56, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=57, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=58, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=59, uuid=str(generate_uuid_with_rng(rng)), is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                ],
                faceup_spots=[],
                discard=[],
            ),
