    ...
    state = State(
        ...
        piles=[
            Pile(
                ...
                num_pieces=num_segment_pieces_per_player,
                pieces=[
                    Piece(uuid="cb9a6ebb-c240-4bbf-a37c-3063c3dea56c", idx=0, pile_idx=player_idx),
                    Piece(uuid="db57c106-9f5a-45ab-8431-bf0892feaa34", idx=1, pile_idx=player_idx),
                    Piece(uuid="ef72dac0-be91-4e7c-a2f8-0e047071d3ce", idx=2, pile_idx=player_idx),
                    Piece(uuid="61016459-cd59-4afa-a44f-4b2be3974bb7", idx=3, pile_idx=player_idx),
                    Piece(uuid="6f38d93d-ef51-4a26-914a-aa2b16ca75f7", idx=4, pile_idx=player_idx),
                    Piece(uuid="40195869-5e6f-41ea-94ec-fbec3014ed88", idx=5, pile_idx=player_idx),
                    Piece(uuid="1eff5f9d-626c-4907-8ef1-2148fda5e6ad", idx=6, pile_idx=player_idx),
                    Piece(uuid="eea9d157-7d93-4b50-8103-5b707debcae4", idx=7, pile_idx=player_idx),
                ],
            ) for player_idx in range(game_config.num_players)
        ],
