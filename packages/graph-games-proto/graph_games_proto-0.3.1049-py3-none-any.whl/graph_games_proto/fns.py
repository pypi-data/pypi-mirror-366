    ...
    state = State(
        ...
        decks=[
            ...
            Deck(
                ...
                units=[],
                facedown_stack=[
                    Card(idx=0, is_wild=False, deck_idx=1, goal_uuid="642f52d9-f11e-4d27-a275-63df2cea90e0"),
                    Card(idx=1, is_wild=False, deck_idx=1, goal_uuid="e5853585-ea33-4ed4-943d-fe680ed9913e"),
                    Card(idx=2, is_wild=False, deck_idx=1, goal_uuid="f3d7d163-e86f-43aa-b7ca-046045bd4614"),
                    Card(idx=3, is_wild=False, deck_idx=1, goal_uuid="76a6797d-306c-4044-9ee7-f59f0a9c75a8"),
                    Card(idx=4, is_wild=False, deck_idx=1, goal_uuid="2917fd0b-94f5-4646-b2a6-888e2942dfb9"),
                    Card(idx=5, is_wild=False, deck_idx=1, goal_uuid="8459fe86-b52f-4548-9fcf-0bb1f0a47d7f"),
                ],
                faceup_spots=[],
                discard=[],
            )
