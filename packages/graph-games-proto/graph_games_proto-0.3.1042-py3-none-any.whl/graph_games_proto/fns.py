...
class Goal(PClass):
    ...
    edge_uuids = field(type=list)  # List[str]
    region_uuids = field(type=list)  # List[str]
    def __todict__(self):
        return {
            "uuid": self.uuid,
            "name": self.name,
...
def get_nodes(board_config):
    return [Node(uuid=node.uuid, pieces=[]) for node in board_config.points] if board_config and board_config.points else []
...
def getinitialstate(game_config):
    ...
    state = State(
        goals = [
            Goal(uuid="2ccb3516-9c08-4ae8-adeb-ee88b076dfa1", node_uuids=["11aaa6f8-ce95-4770-a144-94da5b4e28e2", "ce82cabe-9e71-484a-b80f-788803878230"]),
            Goal(uuid="cbf14ef3-139a-4118-ad64-58d539193a6d", node_uuids=["1400b9bb-5070-447a-aee8-e896c609372f", "57e774ed-d37a-4546-b786-3f1bd606323c"]),
            Goal(uuid="1bcf9d63-5a54-406e-bbd0-312f2e8167ab", node_uuids=["1400b9bb-5070-447a-aee8-e896c609372f", "ce82cabe-9e71-484a-b80f-788803878230"]),
            Goal(uuid="a251bc08-a430-4568-8b2f-01eff01e77c0", node_uuids=["57e774ed-d37a-4546-b786-3f1bd606323c", "11aaa6f8-ce95-4770-a144-94da5b4e28e2"]),
            Goal(uuid="890c163d-557e-4e07-ac36-58db8ae0352e", node_uuids=["57e774ed-d37a-4546-b786-3f1bd606323c", "ce82cabe-9e71-484a-b80f-788803878230"]),
            Goal(uuid="e1293701-cdbe-4b09-b27d-b4b0130f81dd", node_uuids=["11aaa6f8-ce95-4770-a144-94da5b4e28e2", "1400b9bb-5070-447a-aee8-e896c609372f"]),
        ],
        ...
        decks=[
            Deck(
                ...
                units=[],
                facedown_stack=[
                    Card(idx=0, uuid="769a3c9a-31df-45c6-891e-af442a53f812", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=1, uuid="9dd67306-671e-4dbb-9051-534726c6384d", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=2, uuid="30a1207c-88a8-449a-8ba1-25cdee7e6b34", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=3, uuid="aa36cb60-7117-4862-b20a-6adb24463ab6", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=4, uuid="29c278d4-e40e-4b54-9425-e261a4b36b41", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=5, uuid="20776faa-47df-46e1-9f4b-ae928203cbb8", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=6, uuid="2de94a14-fc5b-4ffe-b293-245a26875dbb", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=7, uuid="2cd68857-5ca2-4622-9263-acfec15e62b9", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=8, uuid="30b17571-36e1-4812-bbba-8da0eb416995", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=9, uuid="e45383a2-bdfc-419c-894d-4866bf2c8fe2", is_wild=False, deck_idx=0, resource_uuid="eec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=10, uuid="c22f0c50-f9b9-4e30-817b-9e9d41a5528f", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=11, uuid="9a6721d8-483a-4276-975b-0632036aa8d2", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=12, uuid="348e613c-9a9a-4360-acb8-574c68ffa085", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=13, uuid="15bd3b9c-18b1-405d-a128-8a7c0729ed72", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=14, uuid="cbfc01dd-ca9d-4d04-b6b9-266c8b5b3353", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=15, uuid="03ad6a89-8b0c-4901-a470-6aab08b1f21c", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=16, uuid="05bb2dae-fde1-40f5-9297-d13c0c266d4f", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=17, uuid="9c2f77b0-4443-4372-b4b4-9cea68320332", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=18, uuid="ad886684-b456-4829-a0b0-7e8087dacebb", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=19, uuid="45625d8b-d0f9-4c76-b29e-d4f16d9579b2", is_wild=False, deck_idx=0, resource_uuid="1ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=20, uuid="bbbabcaa-fb7b-4952-85a6-170ea59103dc", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=21, uuid="6d4d6c35-0c78-481d-bd0f-26a3749d3676", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=22, uuid="74fc3f42-d9a7-4b90-b7f8-7b1019d2fb49", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=23, uuid="bd732a37-23c7-498a-bdb4-9216481b49af", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=24, uuid="6745f226-2c3c-43aa-b199-da3c86d8e594", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=25, uuid="2db7515b-3405-4ae0-b13d-7f9d841e0651", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=26, uuid="0a636910-0413-449d-b038-22df28d53e01", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=27, uuid="d45202c5-5397-459c-8fe3-b3b3b172c8e7", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=28, uuid="48bf5952-995d-451a-9bb8-ede5a7c51cae", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=29, uuid="8218a66d-cb74-451d-ba67-6774892c7690", is_wild=False, deck_idx=0, resource_uuid="2ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=30, uuid="76046e99-f4d9-4eb1-951b-d0d4dbc9dd7d", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=31, uuid="f8fb4fcf-1d83-4424-aa8e-780f449b05fa", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=32, uuid="8cbf8336-d399-4ec2-aa6e-521fe1cb19bc", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=33, uuid="a15d4a87-82b6-41ae-aec2-2d3fc21b3b46", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=34, uuid="b7b21c5a-87f1-418c-bd80-824ceabdbdf4", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=35, uuid="47e4e8a0-71f2-4f6d-8614-8019ca5140a0", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=36, uuid="f16ae989-9883-48e8-85ca-58bff6a04f65", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=37, uuid="ff61c3bf-3001-4f3a-9775-7a3dc72418b8", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=38, uuid="b99919e1-7d56-42df-adaa-433ad0068c31", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=39, uuid="f4d1edac-74a8-45fa-84fd-6ffbb6f07427", is_wild=False, deck_idx=0, resource_uuid="3ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=40, uuid="5a8cf08a-2d36-4f44-9bf3-2c476d6c6f86", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=41, uuid="633cb523-ac73-4fca-8a39-ff0193443bdc", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=42, uuid="a660c801-c187-4bf8-a2a7-a4b3e69e139c", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=43, uuid="77d772ed-e9e0-427d-9b5b-cf0af76bd8ea", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=44, uuid="7a282df3-353a-4370-84b6-4d30dab73d2f", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=45, uuid="c945b39f-6a9e-4325-a28d-a8e2bf31450b", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=46, uuid="22f9079c-7e98-4bf9-96a2-7f5795079486", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=47, uuid="2fcc8d78-9375-4c99-8896-90e4d826197f", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=48, uuid="1e3d78d0-1ece-470e-a061-48bb4e93891a", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=49, uuid="014dc6ea-1cbf-4861-ba46-ac277b956c3f", is_wild=False, deck_idx=0, resource_uuid="4ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=50, uuid="2bb395c3-21da-4b31-b34b-9ac57e5ed6cc", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=51, uuid="551895a1-bbee-4b3a-9500-0559c9955325", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=52, uuid="c58cb4ee-0480-432c-bb42-7dde2a79fc64", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=53, uuid="2c946187-b758-42df-8f7e-bf9f44da8cec", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=54, uuid="ed7cf5ce-2897-4a44-8e9a-985a308daeb3", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=55, uuid="15e5f42e-63b2-479f-a332-1ad459d89e4a", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=56, uuid="311483b6-e32b-4a19-b47c-7b9a652b2e33", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=57, uuid="da6b2683-6fa1-41f4-ad5d-fb1fa249caae", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=58, uuid="63d341c3-9407-4518-b44d-c3095d45e5d8", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                    Card(idx=59, uuid="e1ebdc7f-d3f4-4a30-a77a-d282e97dca04", is_wild=False, deck_idx=0, resource_uuid="5ec30571-108a-4372-b048-7313749378c0"),
                ],
                faceup_spots=[],
                discard=[],
            ),
            Deck(
                ...
                units=[],
                facedown_stack=[
                    Card(idx=0, uuid="6c7a7147-7360-474b-892f-9dcc70cd886f", is_wild=False, deck_idx=1, goal_uuid="2ccb3516-9c08-4ae8-adeb-ee88b076dfa1"),
                    Card(idx=1, uuid="c830f140-187f-43cf-a581-6793e8eae51b", is_wild=False, deck_idx=1, goal_uuid="cbf14ef3-139a-4118-ad64-58d539193a6d"),
                    Card(idx=2, uuid="dc0c2cc0-8f41-4bcd-b565-6dc4f6a29742", is_wild=False, deck_idx=1, goal_uuid="1bcf9d63-5a54-406e-bbd0-312f2e8167ab"),
                    Card(idx=3, uuid="b06608e0-7fa6-4ba4-9d16-f20c6f1e964c", is_wild=False, deck_idx=1, goal_uuid="a251bc08-a430-4568-8b2f-01eff01e77c0"),
                    Card(idx=4, uuid="9fa62a2c-f3c7-44cc-981f-8c87a22055a9", is_wild=False, deck_idx=1, goal_uuid="890c163d-557e-4e07-ac36-58db8ae0352e"),
                    Card(idx=5, uuid="da2fc210-b770-4caa-855a-0f06fa5a501f", is_wild=False, deck_idx=1, goal_uuid="e1293701-cdbe-4b09-b27d-b4b0130f81dd"),
                ],
                faceup_spots=[],
                discard=[],
            )
...
INIT_HOOK_6 = """def handler(game):
    return append_to_legal_actions_for_each_player(
        ...
        LegalActionConfig(
            ...
            title="Select your routes to keep",
