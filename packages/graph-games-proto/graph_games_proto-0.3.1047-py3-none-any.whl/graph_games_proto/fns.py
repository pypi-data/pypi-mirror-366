    ...
    state = State(
        ...
        decks=[
            ...
            Deck(
                ...
                units=[],
                facedown_stack=[
                    Card(idx=0, uuid="6c7a7147-7360-474b-892f-9dcc70cd886f", is_wild=False, deck_idx=1, goal_uuid="642f52d9-f11e-4d27-a275-63df2cea90e0"),
                    Card(idx=1, uuid="c830f140-187f-43cf-a581-6793e8eae51b", is_wild=False, deck_idx=1, goal_uuid="e5853585-ea33-4ed4-943d-fe680ed9913e"),
                    Card(idx=2, uuid="dc0c2cc0-8f41-4bcd-b565-6dc4f6a29742", is_wild=False, deck_idx=1, goal_uuid="f3d7d163-e86f-43aa-b7ca-046045bd4614"),
                    Card(idx=3, uuid="b06608e0-7fa6-4ba4-9d16-f20c6f1e964c", is_wild=False, deck_idx=1, goal_uuid="76a6797d-306c-4044-9ee7-f59f0a9c75a8"),
                    Card(idx=4, uuid="9fa62a2c-f3c7-44cc-981f-8c87a22055a9", is_wild=False, deck_idx=1, goal_uuid="2917fd0b-94f5-4646-b2a6-888e2942dfb9"),
                    Card(idx=5, uuid="da2fc210-b770-4caa-855a-0f06fa5a501f", is_wild=False, deck_idx=1, goal_uuid="8459fe86-b52f-4548-9fcf-0bb1f0a47d7f"),
                ],
                faceup_spots=[],
                discard=[],
            )
