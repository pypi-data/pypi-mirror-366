...
from conans.model.build_info import DEFAULT_INCLUDE, DEFAULT_LIB, DEFAULT_BIN
...
class ConanFile(object):
    ...
    def __init__(self, output, runner, display_name="", user=None, channel=None):
        ...
        self.cpp.package.includedirs = [DEFAULT_INCLUDE]
        self.cpp.package.libdirs = [DEFAULT_LIB]
        self.cpp.package.bindirs = [DEFAULT_BIN]
